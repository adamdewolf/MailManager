...
namespace Game.Serialization
{
  ...
  public class RequiredComponentSystem : GameSystemBase
  {
    ...
    private EntityQuery m_OdometerQuery;
    ...
    protected override void OnCreate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.m_OdometerQuery = this.GetEntityQuery(new EntityQueryDesc()
      {
        Any = new ComponentType[3]
        {
          ComponentType.ReadOnly<Game.Vehicles.PublicTransport>(),
        ...
        None = new ComponentType[1]
        {
          ComponentType.ReadOnly<Odometer>()
        }
      });
      // ISSUE: reference to a compiler-generated field
    ...
    protected override void OnUpdate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      if (!this.m_OdometerQuery.IsEmptyIgnoreFilter)
      {
        entityManager = this.EntityManager;
        // ISSUE: reference to a compiler-generated field
        entityManager.AddComponent<Odometer>(this.m_OdometerQuery);
      }
      // ISSUE: reference to a compiler-generated field
      ...
      if (!(context.version < Game.Version.cacheRouteColors) || this.m_RouteColorQuery.IsEmptyIgnoreFilter)
        return;
      // ISSUE: reference to a compiler-generated field
      NativeArray<Entity> entityArray1 = this.m_RouteColorQuery.ToEntityArray((AllocatorManager.AllocatorHandle) Allocator.TempJob);
      for (int index = 0; index < entityArray1.Length; ++index)
      {
        CurrentRoute component15;
        Game.Routes.Color component16;
        if (this.EntityManager.TryGetComponent<CurrentRoute>(entityArray1[index], out component15) && this.EntityManager.TryGetComponent<Game.Routes.Color>(component15.m_Route, out component16))
        {
          entityManager = this.EntityManager;
          entityManager.AddComponentData<Game.Routes.Color>(entityArray1[index], component16);
        }
      }
