...
namespace Game.Tools
{
  ...
  public class UpgradeToolSystem : ObjectToolBaseSystem
  {
    ...
    private UIInputAction.State m_Rebuild;
    ...
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
      ...
      // ISSUE: reference to a compiler-generated method
      // ISSUE: reference to a compiler-generated method
      return this.applyAction.action.WasPressedThisFrame() ? this.Apply(inputDeps) : this.Update(inputDeps);
    }
    ...
    private JobHandle UpdateDefinitions(JobHandle inputDeps)
    {
      ...
      if (this.m_UpgradingObject != Entity.Null)
      {
        ...
        // ISSUE: reference to a compiler-generated method
        // ISSUE: reference to a compiler-generated method
        job0 = JobHandle.CombineDependencies(job0, this.CreateDefinitions(entity, Entity.Null, Entity.Null, this.m_UpgradingObject, Entity.Null, laneContainer, this.m_CityConfigurationSystem.defaultTheme, this.m_ControlPoints, new NativeReference<ObjectToolBaseSystem.AttachmentData>(), this.m_ToolSystem.actionMode.IsEditor(), this.m_CityConfigurationSystem.leftHandTraffic, false, false, this.brushSize, math.radians(this.brushAngle), this.brushStrength, UnityEngine.Time.deltaTime, this.m_RandomSeed, this.GetActualSnap(), AgeMask.Sapling, inputDeps));
      }
      return job0;
    }
