...
namespace Game.Tools
{
  ...
  public class RouteToolSystem : ToolBaseSystem
  {
    ...
    private UIInputAction.State m_AddOrModifyWaypoint;
    private UIInputAction.State m_RemoveWaypoint;
    private UIInputAction.State m_UndoWaypoint;
    ...
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
      ...
      if ((UnityEngine.Object) this.prefab != (UnityEngine.Object) null)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        if (this.m_State != RouteToolSystem.State.Default && !this.applyAction.action.enabled)
        {
          // ISSUE: reference to a compiler-generated field
          this.m_State = RouteToolSystem.State.Default;
        }
        ...
        {
          // ISSUE: reference to a compiler-generated field
          if (this.m_State != RouteToolSystem.State.Remove && this.secondaryApplyAction.action.WasPressedThisFrame())
          {
            // ISSUE: reference to a compiler-generated method
            return this.Cancel(inputDeps, this.secondaryApplyAction.action.WasReleasedThisFrame());
          }
          // ISSUE: reference to a compiler-generated field
          if (this.m_State == RouteToolSystem.State.Remove && (forceCancel || this.secondaryApplyAction.action.WasReleasedThisFrame()))
          {
            // ISSUE: reference to a compiler-generated method
            return this.Cancel(inputDeps);
          }
          // ISSUE: reference to a compiler-generated field
          if (this.m_State != RouteToolSystem.State.Modify && this.applyAction.action.WasPressedThisFrame())
          {
            // ISSUE: reference to a compiler-generated method
          ...
          // ISSUE: reference to a compiler-generated method
          // ISSUE: reference to a compiler-generated method
          return this.m_State == RouteToolSystem.State.Modify && (forceApply || this.applyAction.action.WasReleasedThisFrame()) ? this.Apply(inputDeps) : this.Update(inputDeps);
        }
      }
      else
      {
      ...
      // ISSUE: reference to a compiler-generated field
      if (this.m_State == RouteToolSystem.State.Modify && this.applyAction.action.WasReleasedThisFrame())
      {
        // ISSUE: reference to a compiler-generated field
        if ((this.m_ToolRaycastSystem.raycastFlags & (RaycastFlags.DebugDisable | RaycastFlags.UIDisable)) == (RaycastFlags) 0)
        {
      ...
      {
        // ISSUE: reference to a compiler-generated field
        if (this.m_State == RouteToolSystem.State.Remove && this.secondaryApplyAction.action.WasReleasedThisFrame())
        {
          // ISSUE: reference to a compiler-generated field
          if ((this.m_ToolRaycastSystem.raycastFlags & (RaycastFlags.DebugDisable | RaycastFlags.UIDisable)) == (RaycastFlags) 0)
          {
