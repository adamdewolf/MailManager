...
namespace Game.Tools
{
  ...
  public class DefaultToolSystem : ToolBaseSystem
  {
    ...
    private UIInputAction.State m_DefaultToolApply;
    ...
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
      ...
      if ((this.m_ToolRaycastSystem.raycastFlags & (RaycastFlags.DebugDisable | RaycastFlags.UIDisable)) == (RaycastFlags) 0)
      {
        ...
        // ISSUE: reference to a compiler-generated method
        // ISSUE: reference to a compiler-generated method
        JobHandle jobHandle = this.m_State != DefaultToolSystem.State.Default || !this.applyAction.action.WasPressedThisFrame() ? (this.m_State == DefaultToolSystem.State.Default || !this.applyAction.action.WasReleasedThisFrame() ? (!this.cancelAction.action.WasPressedThisFrame() ? this.Update(inputDeps) : this.Cancel(inputDeps)) : this.Apply(inputDeps)) : this.Apply(inputDeps, this.applyAction.action.WasReleasedThisFrame(), this.cancelAction.action.WasPressedThisFrame());
        // ISSUE: reference to a compiler-generated method
        this.UpdateActions();
        return jobHandle;
      }
      ...
      else if (this.applyAction.action.WasReleasedThisFrame())
      {
        // ISSUE: reference to a compiler-generated field
        this.m_LastRaycastEntity = Entity.Null;
        // ISSUE: reference to a compiler-generated method
    ...
    private JobHandle Update(JobHandle inputDeps)
    {
      ...
      switch (state)
      {
        case DefaultToolSystem.State.Default:
          ...
          // ISSUE: reference to a compiler-generated method
          // ISSUE: reference to a compiler-generated field
          if (this.GetRaycastResult(out entity, out RaycastHit _, out forceUpdate) && entity == this.m_LastRaycastEntity && !forceUpdate)
          {
            this.applyMode = ApplyMode.None;
            return inputDeps;
          }
          ...
          this.applyMode = ApplyMode.Clear;
          // ISSUE: reference to a compiler-generated method
          return this.UpdateDefinitions(inputDeps, entity, new float3(), false);
        case DefaultToolSystem.State.MouseDownPrepare:
          RaycastHit hit1;
          // ISSUE: reference to a compiler-generated method
          if (this.GetRaycastResult(out Entity _, out hit1))
          {
            // ISSUE: reference to a compiler-generated field
            this.m_MouseDownPosition = hit1.m_HitPosition;
            // ISSUE: reference to a compiler-generated method
        ...
        case DefaultToolSystem.State.MouseDown:
          ...
          // ISSUE: reference to a compiler-generated method
          // ISSUE: reference to a compiler-generated field
          if (this.GetRaycastResult(out Entity _, out hit2) && (double) math.distance(hit2.m_HitPosition, this.m_MouseDownPosition) > 1.0)
          {
            // ISSUE: reference to a compiler-generated method
            this.StartDragging(hit2);
          }
          this.applyMode = ApplyMode.None;
          return inputDeps;
        case DefaultToolSystem.State.Dragging:
          RaycastHit hit3;
          // ISSUE: reference to a compiler-generated method
          if (this.GetRaycastResult(out Entity _, out hit3))
          {
            // ISSUE: reference to a compiler-generated field
            if (!this.m_DragQuery.IsEmptyIgnoreFilter)
            {
              ...
              native2.m_Position = hit3.m_HitPosition;
            ...
            else
            {
              ...
              if (this.EntityManager.Exists(this.m_LastRaycastEntity))
              {
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated method
                return this.UpdateDefinitions(inputDeps, this.m_LastRaycastEntity, hit3.m_HitPosition, true);
              }
            }
          }
          this.applyMode = ApplyMode.None;
    ...
    private JobHandle SelectTempEntity(JobHandle inputDeps, bool toggleSelected)
    {
      ...
      jobHandle.Complete();
      // ISSUE: reference to a compiler-generated field
      if (this.m_ToolSystem.selected != nativeReference.Value)
      {
        // ISSUE: reference to a compiler-generated field
      ...
      public void Execute()
      {
        ...
        for (int index1 = 0; index1 < this.m_Chunks.Length; ++index1)
        {
          ...
          for (int index2 = 0; index2 < nativeArray2.Length; ++index2)
          {
            Temp componentData;
            // ISSUE: reference to a compiler-generated field
            if (nativeArray1.Length == 0 || !this.m_TempData.TryGetComponent(nativeArray1[index2].m_Owner, out componentData) || (componentData.m_Flags & TempFlags.Select) == (TempFlags) 0)
            {
              Temp temp = nativeArray2[index2];
              // ISSUE: reference to a compiler-generated field
              if (this.m_PrefabData.HasComponent(temp.m_Original) && (temp.m_Flags & TempFlags.Select) != (TempFlags) 0)
        ...
        if (this.m_IconData.HasComponent(entity) && !this.m_OwnerData.HasComponent(entity) && this.m_TargetData.HasComponent(entity))
        {
          ...
          // ISSUE: reference to a compiler-generated field
          if (this.m_PrefabData.HasComponent(target.m_Target))
          {
            // ISSUE: reference to a compiler-generated field
            if (this.m_TempData.HasComponent(target.m_Target))
            {
              ...
              // ISSUE: reference to a compiler-generated field
              entity = !this.m_PrefabData.HasComponent(temp.m_Original) ? Entity.Null : temp.m_Original;
            }
            else
