...
namespace Game.Tools
{
  ...
  public class NetToolSystem : ToolBaseSystem
  {
    ...
    private UIInputAction.State m_DowngradeNetEdge;
    private UIInputAction.State m_PlaceNetControlPoint;
    private UIInputAction.State m_PlaceNetEdge;
    private UIInputAction.State m_PlaceNetNode;
    private UIInputAction.State m_ReplaceNetEdge;
    private UIInputAction.State m_UndoNetControlPoint;
    private UIInputAction.State m_UpgradeNetEdge;
    ...
    private NativeValue<Entity> m_StartEntity;
    private NativeValue<Entity> m_LastSnappedEntity;
    private NativeValue<NetToolSystem.AppliedUpgrade> m_AppliedUpgrade;
    ...
    protected override void OnCreate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.m_StartEntity = new NativeValue<Entity>(Allocator.Persistent);
      // ISSUE: reference to a compiler-generated field
      this.m_LastSnappedEntity = new NativeValue<Entity>(Allocator.Persistent);
      // ISSUE: reference to a compiler-generated field
      this.m_AppliedUpgrade = new NativeValue<NetToolSystem.AppliedUpgrade>(Allocator.Persistent);
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated method
    ...
    protected override void OnStartRunning()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.m_StartEntity.Clear();
      // ISSUE: reference to a compiler-generated field
      this.m_LastSnappedEntity.Clear();
      // ISSUE: reference to a compiler-generated field
      this.m_AppliedUpgrade.Clear();
      // ISSUE: reference to a compiler-generated field
    ...
    {
      this.secondaryApplyAction.enabled = this.applyAction.enabled && this.actualMode == NetToolSystem.Mode.Replace;
      // ISSUE: reference to a compiler-generated field
      this.cancelAction.enabled = this.applyAction.enabled && this.actualMode != NetToolSystem.Mode.Replace && this.m_ControlPoints.Length > 1;
      // ISSUE: variable of a compiler-generated type
    ...
    {
      this.applyAction.action.enabled = !enabled;
      // ISSUE: reference to a compiler-generated method
      this.UpdateActions();
    }
    ...
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
      ...
      if ((UnityEngine.Object) this.m_Prefab != (UnityEngine.Object) null)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        if (this.m_State != NetToolSystem.State.Default && !this.applyAction.action.enabled)
        {
          // ISSUE: reference to a compiler-generated field
          this.m_State = NetToolSystem.State.Default;
        }
        ...
        {
          // ISSUE: reference to a compiler-generated field
          if (this.m_State != NetToolSystem.State.Cancelling && (this.secondaryApplyAction.action.WasPressedThisFrame() || this.cancelAction.action.WasPressedThisFrame()))
          {
            // ISSUE: reference to a compiler-generated method
            return this.Cancel(inputDeps, this.secondaryApplyAction.action.WasReleasedThisFrame() || this.cancelAction.action.WasReleasedThisFrame());
          }
          // ISSUE: reference to a compiler-generated field
          if (this.m_State == NetToolSystem.State.Cancelling && (forceCancel || this.secondaryApplyAction.action.WasReleasedThisFrame() || this.cancelAction.action.WasReleasedThisFrame()))
          {
            // ISSUE: reference to a compiler-generated method
            return this.Cancel(inputDeps);
          }
          // ISSUE: reference to a compiler-generated field
          if (this.m_State != NetToolSystem.State.Applying && this.applyAction.action.WasPressedThisFrame())
          {
            // ISSUE: reference to a compiler-generated method
          ...
          // ISSUE: reference to a compiler-generated method
          // ISSUE: reference to a compiler-generated method
          return this.m_State == NetToolSystem.State.Applying && this.applyAction.action.WasReleasedThisFrame() ? this.Apply(inputDeps) : this.Update(inputDeps, false);
        }
      }
      else
      {
      ...
      // ISSUE: reference to a compiler-generated field
      if (this.m_State == NetToolSystem.State.Applying && this.applyAction.action.WasReleasedThisFrame())
      {
        // ISSUE: reference to a compiler-generated field
        this.m_State = NetToolSystem.State.Default;
      }
      ...
      {
        // ISSUE: reference to a compiler-generated field
        if (this.m_State == NetToolSystem.State.Cancelling && (this.secondaryApplyAction.action.WasReleasedThisFrame() || this.cancelAction.action.WasReleasedThisFrame()))
        {
          // ISSUE: reference to a compiler-generated field
          this.m_State = NetToolSystem.State.Default;
        }
    ...
    private void SetAppliedUpgrade(bool removing)
    {
      ...
      // ISSUE: object of a compiler-generated type is created
      // ISSUE: variable of a compiler-generated type
      NetToolSystem.AppliedUpgrade appliedUpgrade = new NetToolSystem.AppliedUpgrade();
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      ...
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      appliedUpgrade.m_Flags = !removing ? this.m_UpgradeStates[this.m_UpgradeStates.Length - 1].m_AddFlags : this.m_UpgradeStates[this.m_UpgradeStates.Length - 1].m_RemoveFlags;
      if (originalEntity1 == originalEntity2)
      {
        // ISSUE: reference to a compiler-generated field
        appliedUpgrade.m_Entity = originalEntity1;
        // ISSUE: reference to a compiler-generated field
        this.m_AppliedUpgrade.value = appliedUpgrade;
      }
      else
      {
    ...
    private struct SnapJob : IJob
    {
      ...
      public NativeValue<NetToolSystem.AppliedUpgrade> m_AppliedUpgrade;
      ...
      public void Execute()
      {
        ...
        if (this.m_Mode == NetToolSystem.Mode.Replace)
        {
          ...
          // ISSUE: reference to a compiler-generated method
          this.CreatePath(controlPoint1, controlPoint2, path, prefabNetData, placeableNetData);
          // ISSUE: reference to a compiler-generated method
          this.AddControlPoints(controlPoint1, controlPoint2, path, netGeometryData, prefabRoadData, placeableNetData);
        }
        else
        {
          // ISSUE: reference to a compiler-generated field
        ...
        ref ControlPoint controlPoint)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        if (this.m_LastSnappedEntity.value == Entity.Null && snapTargetControlPoint.m_OriginalEntity != Entity.Null && snapTargetControlPoint.m_OriginalEntity != controlPoint.m_OriginalEntity)
        {
          // ISSUE: reference to a compiler-generated field
        ...
        PlaceableNetData placeableNetData)
      {
        ...
        if (startPoint.m_OriginalEntity == endPoint.m_OriginalEntity)
        {
          ...
          if (this.m_EdgeData.HasComponent(endPoint.m_OriginalEntity))
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            NetData netData = this.m_PrefabNetData[this.m_PrefabRefData[endPoint.m_OriginalEntity].m_Prefab];
          ...
          else
          {
            ...
            {
              // ISSUE: reference to a compiler-generated field
              DynamicBuffer<ConnectedEdge> connectedEdge = this.m_ConnectedEdges[endPoint.m_OriginalEntity];
              for (int index = 0; index < connectedEdge.Length; ++index)
              {
                // ISSUE: reference to a compiler-generated field
                Game.Net.Edge edge = this.m_EdgeData[connectedEdge[index].m_Edge];
                if (edge.m_Start == endPoint.m_OriginalEntity || edge.m_End == endPoint.m_OriginalEntity)
                {
                  flag1 = false;
                  break;
                }
        ...
        else
        {
          ...
          {
            // ISSUE: reference to a compiler-generated field
            Game.Net.Edge edge = this.m_EdgeData[endPoint.m_OriginalEntity];
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            NetData netData = this.m_PrefabNetData[this.m_PrefabRefData[endPoint.m_OriginalEntity].m_Prefab];
            int num = (prefabNetData.m_RequiredLayers & netData.m_RequiredLayers) > Layer.None ? 1 : 0;
          ...
          while (nativeMinHeap.Length != 0)
          {
            ...
            if (nativeParallelHashMap.TryAdd(pathItem4.m_Node, pathItem4.m_Edge))
            {
              ...
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              DynamicBuffer<ConnectedEdge> connectedEdge = this.m_ConnectedEdges[pathItem4.m_Node];
              ...
              if (pathItem4.m_Edge != Entity.Null)
              {
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                prefabRef1 = this.m_PrefabRefData[pathItem4.m_Edge];
              }
              for (int index = 0; index < connectedEdge.Length; ++index)
              {
                Entity edge1 = connectedEdge[index].m_Edge;
                // ISSUE: reference to a compiler-generated field
                if (!(edge1 == pathItem4.m_Edge))
                {
                  // ISSUE: reference to a compiler-generated field
                  Game.Net.Edge edge2 = this.m_EdgeData[edge1];
                  Entity key2;
                  // ISSUE: reference to a compiler-generated field
                  if (edge2.m_Start == pathItem4.m_Node)
                  {
                    key2 = edge2.m_End;
                  }
                  else
                  {
                    // ISSUE: reference to a compiler-generated field
                    if (edge2.m_End == pathItem4.m_Node)
                      key2 = edge2.m_Start;
                    else
                      continue;
                  }
                  if (!nativeParallelHashMap.ContainsKey(key2) || !(edge1 != startPoint.m_OriginalEntity))
                  {
                    ...
                    // ISSUE: reference to a compiler-generated field
                    NetData netData = this.m_PrefabNetData[prefabRef2.m_Prefab];
                    ...
                    if (num1 != 0 || flag)
                    {
                      ...
                      // ISSUE: reference to a compiler-generated field
                      float num2 = pathItem4.m_Cost + curve.m_Length + math.select(0.0f, 9.9f, prefabRef2.m_Prefab != prefabRef1.m_Prefab) + math.select(0.0f, 10f, connectedEdge.Length > 2);
          ...
          {
            // ISSUE: reference to a compiler-generated field
            Game.Net.Edge edge = this.m_EdgeData[entity1];
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            NetData netData = this.m_PrefabNetData[this.m_PrefabRefData[entity1].m_Prefab];
            bool flag3 = edge.m_End == key1;
            bool flag4 = (prefabNetData.m_RequiredLayers & netData.m_RequiredLayers) > Layer.None;
            entity2 = flag3 ? edge.m_Start : edge.m_End;
            // ISSUE: variable of a compiler-generated type
      ...
      private bool IsNearEnd(Entity edge, Curve curve, float3 position, bool invert)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        if (this.m_EdgeGeometryData.TryGetComponent(edge, out componentData))
        {
        ...
        PlaceableNetData placeableNetData)
      {
        ...
        if (path.Length != 0)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          if (this.m_EdgeData.HasComponent(pathEdge.m_Entity))
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            NetData netData = this.m_PrefabNetData[this.m_PrefabRefData[pathEdge.m_Entity].m_Prefab];
            ...
            else
            {
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              Composition composition = this.m_CompositionData[pathEdge.m_Entity];
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              Curve curve = this.m_CurveData[pathEdge.m_Entity];
              // ISSUE: reference to a compiler-generated field
              ...
              float a = math.dot(endPoint.m_HitPosition.xz - float3_1.xz, MathUtils.Right(float3_2.xz));
              // ISSUE: reference to a compiler-generated field
        ...
        for (int index1 = 0; index1 < path.Length; ++index1)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          if (this.m_EdgeData.HasComponent(pathEdge1.m_Entity))
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            Game.Net.Edge edge = this.m_EdgeData[pathEdge1.m_Entity];
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            Curve curve = this.m_CurveData[pathEdge1.m_Entity];
            // ISSUE: reference to a compiler-generated field
            ...
            if (pathEdge1.m_Upgrade)
            {
              ...
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              if (this.m_UpgradedData.HasComponent(pathEdge1.m_Entity))
              {
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                upgradeState2.m_OldFlags = this.m_UpgradedData[pathEdge1.m_Entity].m_Flags;
              }
              Composition componentData1;
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              if (this.m_CompositionData.TryGetComponent(pathEdge1.m_Entity, out componentData1))
              {
                NetCompositionData componentData2;
                // ISSUE: reference to a compiler-generated field
                if (this.m_PrefabCompositionData.TryGetComponent(componentData1.m_StartNode, out componentData2))
                {
                  if ((componentData2.m_Flags.m_General & CompositionFlags.General.Crosswalk) != (CompositionFlags.General) 0)
                  {
                    if ((componentData2.m_Flags.m_General & CompositionFlags.General.Invert) != (CompositionFlags.General) 0)
                    {
                      // ISSUE: reference to a compiler-generated field
                  ...
                  else if ((componentData2.m_Flags.m_General & CompositionFlags.General.Invert) != (CompositionFlags.General) 0)
                  {
                    // ISSUE: reference to a compiler-generated field
                ...
                NetCompositionData componentData3;
                // ISSUE: reference to a compiler-generated field
                if (this.m_PrefabCompositionData.TryGetComponent(componentData1.m_EndNode, out componentData3))
                {
                  if ((componentData3.m_Flags.m_General & CompositionFlags.General.Crosswalk) != (CompositionFlags.General) 0)
                  {
                    if ((componentData3.m_Flags.m_General & CompositionFlags.General.Invert) != (CompositionFlags.General) 0)
                    {
                      // ISSUE: reference to a compiler-generated field
                      upgradeState2.m_OldFlags.m_Left |= CompositionFlags.Side.AddCrosswalk;
                    }
                  ...
                  else if ((componentData3.m_Flags.m_General & CompositionFlags.General.Invert) != (CompositionFlags.General) 0)
                  {
                    // ISSUE: reference to a compiler-generated field
                    upgradeState2.m_OldFlags.m_Left |= CompositionFlags.Side.RemoveCrosswalk;
                  }
              ...
              if ((side3 | side4) != (CompositionFlags.Side) 0)
              {
                ...
                else
                {
                  if (index1 == 0)
                  {
                    ...
                    // ISSUE: reference to a compiler-generated field
                    // ISSUE: reference to a compiler-generated method
                    bool y = this.IsNearEnd(pathEdge1.m_Entity, curve, startPoint.m_HitPosition, pathEdge1.m_Invert);
                    bool2 |= new bool2(!y, y);
                    if (index1 + 1 < path.Length)
                    {
                      // ISSUE: variable of a compiler-generated type
                      NetToolSystem.PathEdge pathEdge2 = path[index1 + 1];
                      Game.Net.Edge componentData4;
                      // ISSUE: reference to a compiler-generated field
                      // ISSUE: reference to a compiler-generated field
                      if (this.m_EdgeData.TryGetComponent(pathEdge2.m_Entity, out componentData4))
                        bool2 |= new bool2(edge.m_Start == componentData4.m_Start | edge.m_Start == componentData4.m_End, edge.m_End == componentData4.m_Start | edge.m_End == componentData4.m_End);
                    }
                  }
                  if (index1 == path.Length - 1)
                  {
                    ...
                    // ISSUE: reference to a compiler-generated field
                    // ISSUE: reference to a compiler-generated method
                    bool y = this.IsNearEnd(pathEdge1.m_Entity, curve, endPoint.m_HitPosition, pathEdge1.m_Invert);
                    bool2 |= new bool2(!y, y);
                    if (index1 - 1 >= 0)
                    {
                      // ISSUE: variable of a compiler-generated type
                      NetToolSystem.PathEdge pathEdge3 = path[index1 - 1];
                      Game.Net.Edge componentData5;
                      // ISSUE: reference to a compiler-generated field
                      // ISSUE: reference to a compiler-generated field
                      if (this.m_EdgeData.TryGetComponent(pathEdge3.m_Entity, out componentData5))
                        bool2 |= new bool2(edge.m_Start == componentData5.m_Start | edge.m_Start == componentData5.m_End, edge.m_End == componentData5.m_Start | edge.m_End == componentData5.m_End);
                    }
                  }
                }
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                if (pathEdge1.m_Invert != this.m_LeftHandTraffic)
                  bool2 = bool2.yx;
                if (bool2.x)
                {
              ...
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              NetData netData = this.m_PrefabNetData[this.m_PrefabRefData[pathEdge1.m_Entity].m_Prefab];
              ...
              // ISSUE: reference to a compiler-generated field
              this.m_UpgradeStates.Add(in upgradeState2);
            }
            else
            {
              // ISSUE: reference to a compiler-generated field
              ref NativeList<NetToolSystem.UpgradeState> local1 = ref this.m_UpgradeStates;
              // ISSUE: object of a compiler-generated type is created
              upgradeState1 = new NetToolSystem.UpgradeState();
              ...
              if ((prefabGeometryData.m_Flags & Game.Net.GeometryFlags.StrictNodes) == (Game.Net.GeometryFlags) 0)
              {
                ...
                if ((this.m_Snap & Snap.ExistingGeometry) != Snap.None)
                {
                  // ISSUE: reference to a compiler-generated field
                  // ISSUE: reference to a compiler-generated field
                  Composition composition = this.m_CompositionData[pathEdge1.m_Entity];
                  // ISSUE: reference to a compiler-generated field
                  NetCompositionData netCompositionData = this.m_PrefabCompositionData[composition.m_Edge];
                  RoadComposition roadComposition = new RoadComposition();
                  // ISSUE: reference to a compiler-generated field
                  if (this.m_RoadCompositionData.HasComponent(composition.m_Edge))
                  {
                    // ISSUE: reference to a compiler-generated field
                    roadComposition = this.m_RoadCompositionData[composition.m_Edge];
                  }
                  float num3 = math.abs(netCompositionData.m_Width - prefabGeometryData.m_DefaultWidth);
                  // ISSUE: reference to a compiler-generated field
                  if ((this.m_Snap & Snap.CellLength) != Snap.None && (roadComposition.m_Flags & prefabRoadData.m_Flags & Game.Prefabs.RoadFlags.EnableZoning) != (Game.Prefabs.RoadFlags) 0)
                  {
            ...
            {
              float3 float3_3 = MathUtils.StartTangent(curve.m_Bezier);
              float3 float3_4 = MathUtils.EndTangent(curve.m_Bezier);
              float3_3 = MathUtils.Normalize(float3_3, float3_3.xz);
              float3_4 = MathUtils.Normalize(float3_4, float3_4.xz);
              controlPoint1.m_Position.xz += MathUtils.Right(float3_3.xz) * x2;
              controlPoint2.m_Position.xz += MathUtils.Right(float3_4.xz) * x2;
            }
            // ISSUE: reference to a compiler-generated field
            this.m_ControlPoints.Add(in controlPoint1);
            // ISSUE: reference to a compiler-generated field
          ...
          else
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            if (this.m_NodeData.HasComponent(pathEdge1.m_Entity))
            {
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              Game.Net.Node node = this.m_NodeData[pathEdge1.m_Entity];
              // ISSUE: reference to a compiler-generated field
              if (pathEdge1.m_Upgrade)
              {
                // ISSUE: object of a compiler-generated type is created
                ...
                if (this.m_UpgradedData.HasComponent(pathEdge1.m_Entity))
                {
                  ...
                  // ISSUE: reference to a compiler-generated field
                  // ISSUE: reference to a compiler-generated field
                  upgradeState3.m_OldFlags = this.m_UpgradedData[pathEdge1.m_Entity].m_Flags;
                }
                DynamicBuffer<ConnectedEdge> bufferData;
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                if (this.m_ConnectedEdges.TryGetBuffer(pathEdge1.m_Entity, out bufferData))
                {
                  CompositionFlags compositionFlags = new CompositionFlags();
                  for (int index2 = 0; index2 < bufferData.Length; ++index2)
                  {
                    Entity edge1 = bufferData[index2].m_Edge;
                    // ISSUE: reference to a compiler-generated field
                    Game.Net.Edge edge2 = this.m_EdgeData[edge1];
                    // ISSUE: reference to a compiler-generated field
                    if (edge2.m_Start == pathEdge1.m_Entity)
                    {
                      Composition componentData6;
                      NetCompositionData componentData7;
                      // ISSUE: reference to a compiler-generated field
                      // ISSUE: reference to a compiler-generated field
                      if (this.m_CompositionData.TryGetComponent(edge1, out componentData6) && this.m_PrefabCompositionData.TryGetComponent(componentData6.m_StartNode, out componentData7))
                        compositionFlags |= componentData7.m_Flags;
                    }
                    else
                    {
                      ...
                      // ISSUE: reference to a compiler-generated field
                      // ISSUE: reference to a compiler-generated field
                      if (edge2.m_End == pathEdge1.m_Entity && this.m_CompositionData.TryGetComponent(edge1, out componentData8) && this.m_PrefabCompositionData.TryGetComponent(componentData8.m_EndNode, out componentData9))
                        compositionFlags |= componentData9.m_Flags;
                    }
                  }
                ...
                // ISSUE: reference to a compiler-generated field
                this.m_UpgradeStates.Add(in upgradeState3);
              }
              else
              {
                // ISSUE: reference to a compiler-generated field
                ref NativeList<NetToolSystem.UpgradeState> local3 = ref this.m_UpgradeStates;
                // ISSUE: object of a compiler-generated type is created
                upgradeState1 = new NetToolSystem.UpgradeState();
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: variable of a compiler-generated type
        NetToolSystem.AppliedUpgrade appliedUpgrade = this.m_AppliedUpgrade.value;
        // ISSUE: reference to a compiler-generated field
        if (!(appliedUpgrade.m_Entity != Entity.Null))
          return;
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        if (this.m_UpgradeStates.Length != 1 || this.m_UpgradeStates[0].m_AddFlags != appliedUpgrade.m_Flags)
        {
          // ISSUE: reference to a compiler-generated field
          this.m_AppliedUpgrade.Clear();
        }
        else
        {
          // ISSUE: reference to a compiler-generated field
          // ISSUE: variable of a compiler-generated type
          NetToolSystem.UpgradeState upgradeState = this.m_UpgradeStates[0] with
          {
            m_SkipFlags = true
          };
          // ISSUE: reference to a compiler-generated field
          this.m_UpgradeStates[0] = upgradeState;
        }
      }
        ...
        IUnsafeQuadTreeIterator<Entity, QuadTreeBoundsXZ>
      {
        ...
        private void SnapToNode(Entity entity)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          if (!this.m_PrefabNetData.HasComponent(prefabRef.m_Prefab) || (this.m_PrefabNetData[prefabRef.m_Prefab].m_ConnectLayers & this.m_NetData.m_ConnectLayers) == Layer.None)
            return;
          // ISSUE: reference to a compiler-generated field
        ...
        IUnsafeQuadTreeIterator<Entity, QuadTreeBoundsXZ>
      {
        ...
        public bool HandleGeometry(ControlPoint controlPoint, PrefabRef prefabRef)
        {
          ...
          if (!this.m_PrefabNetData.HasComponent(prefabRef.m_Prefab))
            return false;
          // ISSUE: reference to a compiler-generated field
          NetData netData = this.m_PrefabNetData[prefabRef.m_Prefab];
          ...
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          if (flag && (netData.m_ConnectLayers & this.m_NetData.m_ConnectLayers) == Layer.None || (this.m_NetData.m_ConnectLayers & ~netData.m_RequiredLayers & Layer.LaneEditor) != Layer.None || !MathUtils.Intersect(this.m_HeightRange, y - controlPoint.m_HitPosition.y))
            return snapAdded;
          // ISSUE: reference to a compiler-generated field
      ...
      public void Execute()
      {
        ...
        for (int index1 = 0; index1 < this.m_Chunks.Length; ++index1)
        {
          ...
          for (int index2 = 0; index2 < nativeArray2.Length; ++index2)
          {
            ...
            Entity replace = nativeArray1[index2];
            ...
            else if ((temp.m_Flags & (TempFlags.Replace | TempFlags.Combine)) != (TempFlags) 0 && temp.m_Original != Entity.Null)
            {
              // ISSUE: reference to a compiler-generated method
              this.FixControlPoints(temp.m_Original, replace);
            }
            if ((temp.m_Flags & TempFlags.IsLast) != (TempFlags) 0)
              entity = (temp.m_Flags & (TempFlags.Create | TempFlags.Replace)) == (TempFlags) 0 ? temp.m_Original : replace;
          }
        }
        // ISSUE: reference to a compiler-generated field
        if (!(entity != Entity.Null) || this.m_Mode == NetToolSystem.Mode.Replace)
          return;
        // ISSUE: reference to a compiler-generated field
    ...
    private struct CreateDefinitionsJob : IJob
    {
        ...
        bool isEnd)
      {
        ...
        Entity entity = this.m_CommandBuffer.CreateEntity();
        CreationDefinition component1 = new CreationDefinition();
        component1.m_Original = point.m_OriginalEntity;
        // ISSUE: reference to a compiler-generated field
        component1.m_Prefab = this.m_PrefabRefData[point.m_OriginalEntity].m_Prefab;
        ...
        bool isEnd)
      {
        ...
        Entity entity = this.m_CommandBuffer.CreateEntity();
        CreationDefinition component1 = new CreationDefinition();
        component1.m_Original = edge;
        // ISSUE: reference to a compiler-generated field
        component1.m_Prefab = this.m_PrefabRefData[edge].m_Prefab;
        component1.m_Flags |= CreationFlags.Align;
        // ISSUE: reference to a compiler-generated field
        if (!upgradeState.m_SkipFlags)
        {
