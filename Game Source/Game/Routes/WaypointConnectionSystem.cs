    ...
    private struct FindWaypointConnectionsJob : IJobParallelForDefer
    {
        ...
        out bool intersectLot)
      {
        ...
        else
        {
          ...
          {
            // ISSUE: reference to a compiler-generated field
            float num4 = math.max(0.0f, iterator.m_MaxDistance);
            // ISSUE: reference to a compiler-generated field
            iterator.m_Bounds = new Bounds3(position - num4, position + num4);
          }
          // ISSUE: reference to a compiler-generated field
          ...
          if (shouldIntersectLot != 0 && math.any(iterator.m_CheckLot))
          {
            ...
            else
            {
              ...
              if (!iterator.m_IntersectLot)
              {
                ...
                {
                  // ISSUE: reference to a compiler-generated field
                  x = math.min(x, MathUtils.Distance(iterator.m_LotQuad.ab, position.xz, out t));
                }
                // ISSUE: reference to a compiler-generated field
                if (iterator.m_CheckLot.y)
                {
                  // ISSUE: reference to a compiler-generated field
                  x = math.min(x, MathUtils.Distance(iterator.m_LotQuad.bc, position.xz, out t));
                }
                // ISSUE: reference to a compiler-generated field
                if (iterator.m_CheckLot.z)
                {
                  // ISSUE: reference to a compiler-generated field
                  x = math.min(x, MathUtils.Distance(iterator.m_LotQuad.cd, position.xz, out t));
                }
                // ISSUE: reference to a compiler-generated field
                if (iterator.m_CheckLot.w)
                {
                  // ISSUE: reference to a compiler-generated field
                  x = math.min(x, MathUtils.Distance(iterator.m_LotQuad.da, position.xz, out t));
                }
                // ISSUE: reference to a compiler-generated field
                if ((double) iterator.m_MaxDistance > (double) x)
                {
                  // ISSUE: object of a compiler-generated type is created
                  iterator = new WaypointConnectionSystem.FindWaypointConnectionsJob.LaneIterator();
                }
        ...
        IUnsafeQuadTreeIterator<AreaSearchItem, QuadTreeBoundsXZ>
      {
          ...
          ref int crossedSide)
        {
          ...
          if ((double) MathUtils.DistanceSquared(edgeGeometry.m_Bounds.xz, this.m_Position.xz) >= (double) maxDistance * (double) maxDistance)
            return;
          // ISSUE: reference to a compiler-generated method
          this.CheckDistance(edgeGeometry.m_Start.m_Left, -1, ref maxDistance, ref crossedSide);
          // ISSUE: reference to a compiler-generated method
          this.CheckDistance(edgeGeometry.m_Start.m_Right, 1, ref maxDistance, ref crossedSide);
          // ISSUE: reference to a compiler-generated method
          this.CheckDistance(edgeGeometry.m_End.m_Left, -1, ref maxDistance, ref crossedSide);
          // ISSUE: reference to a compiler-generated method
          this.CheckDistance(edgeGeometry.m_End.m_Right, 1, ref maxDistance, ref crossedSide);
        }
          ...
          ref int crossedSide)
        {
          ...
          {
            // ISSUE: reference to a compiler-generated method
            this.CheckDistance(nodeGeometry.m_Left.m_Left, -1, ref maxDistance, ref crossedSide);
            // ISSUE: reference to a compiler-generated method
            this.CheckDistance(nodeGeometry.m_Left.m_Right, 1, ref maxDistance, ref crossedSide);
            // ISSUE: reference to a compiler-generated method
            this.CheckDistance(nodeGeometry.m_Right.m_Left, -2, ref maxDistance, ref crossedSide);
            // ISSUE: reference to a compiler-generated method
            this.CheckDistance(nodeGeometry.m_Right.m_Right, 2, ref maxDistance, ref crossedSide);
          }
          else
          {
            // ISSUE: reference to a compiler-generated method
            this.CheckDistance(nodeGeometry.m_Left.m_Left, -1, ref maxDistance, ref crossedSide);
            // ISSUE: reference to a compiler-generated method
            this.CheckDistance(nodeGeometry.m_Right.m_Right, 1, ref maxDistance, ref crossedSide);
          }
        }
          ...
          ref int crossedSide)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          float2 y = this.m_Position.xz - MathUtils.Position(curve.xz, t);
        ...
        public void Iterate(QuadTreeBoundsXZ bounds, Entity netEntity)
        {
          ...
          if (this.m_ConnectionType == RouteConnectionType.Pedestrian)
          {
            ...
            {
              // ISSUE: reference to a compiler-generated method
              this.CheckDistance(componentData1, ref maxDistance, ref crossedSide);
              flag1 = true;
            }
            else
            {
              ...
              if (this.m_ConnectedEdges.TryGetBuffer(netEntity, out bufferData2))
              {
                for (int index = 0; index < bufferData2.Length; ++index)
                {
                  ...
                  if (edge.m_Start == netEntity)
                  {
                    ...
                    {
                      // ISSUE: reference to a compiler-generated method
                      this.CheckDistance(componentData2.m_Geometry, ref maxDistance, ref crossedSide);
                    }
                  }
                  else
                  {
                    ...
                    {
                      // ISSUE: reference to a compiler-generated method
                      this.CheckDistance(componentData3.m_Geometry, ref maxDistance, ref crossedSide);
                    }
                  }
          ...
          for (int index = 0; index < bufferData1.Length; ++index)
          {
            ...
            {
              // ISSUE: reference to a compiler-generated field
              if (!MathUtils.Intersect(MathUtils.Expand(MathUtils.Bounds(curve.m_Bezier), (float3) num4).xz, this.m_Bounds.xz))
                continue;
            }
            else if (entity1 != Entity.Null && !MathUtils.Intersect(MathUtils.Expand(MathUtils.Bounds(curve.m_Bezier), (float3) num4).xz, bounds3.xz))
              continue;
            bool flag3 = (netLaneData.m_Flags & LaneFlags.OnWater) != 0;
            float t2;
            // ISSUE: reference to a compiler-generated field
            float4 float4_2 = (float4) MathUtils.Distance(curve.m_Bezier.xz, this.m_Position.xz, out t2);
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            float2 float2 = new float2(this.m_Position.y - MathUtils.Position(curve.m_Bezier.y, t2), this.m_Elevation - num3);
            // ISSUE: reference to a compiler-generated field
            float2 = math.select(float2, (float2) 0.0f, ((!this.m_OnGround ? 0 : (!flag2 ? 1 : 0)) | (flag3 ? 1 : 0)) != 0);
            float num5 = math.max(0.0f, num4 - float4_2.x) * 0.1f / math.max(0.01f, num4);
            float4_2.x = math.max(0.0f, float4_2.x - num4) - num5;
            float4_2.y = math.cmin(math.abs(float2));
            float4_2.z = math.length(math.max((float2) 0.0f, float4_2.xy));
            float4_2.w = float4_2.z + math.min(0.0f, float4_2.x);
            if ((double) float4_2.w < (double) float4_1.w)
            {
              entity1 = subLane;
              float4_1 = float4_2;
              t1 = t2;
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              bounds3 = new Bounds3(this.m_Position - float4_2.z, this.m_Position + float4_2.z);
            }
          }
          if (!(entity1 != Entity.Null))
            return;
          float4_1.x = math.min(maxDistance, float4_1.x);
          float4_1.z = math.length(math.max((float2) 0.0f, float4_1.xy));
          float4_1.w = float4_1.z + math.min(0.0f, float4_1.x);
          float4 float4_3 = float4_1;
          bool flag4 = false;
          // ISSUE: reference to a compiler-generated field
          if (math.any(this.m_CheckLot) && (double) float4_3.x < 10.0)
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            Line3.Segment segment = new Line3.Segment(this.m_Position, MathUtils.Position(this.m_CurveData[entity1].m_Bezier, t1));
            float num6 = 1f;
            float2 t3;
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            if (this.m_CheckLot.x && MathUtils.Intersect(this.m_LotQuad.ab, segment.xz, out t3))
            {
              flag4 = true;
              num6 = math.min(num6, t3.y);
            }
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            if (this.m_CheckLot.y && MathUtils.Intersect(this.m_LotQuad.bc, segment.xz, out t3))
            {
              flag4 = true;
              num6 = math.min(num6, t3.y);
            }
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            if (this.m_CheckLot.z && MathUtils.Intersect(this.m_LotQuad.cd, segment.xz, out t3))
            {
              flag4 = true;
              num6 = math.min(num6, t3.y);
            }
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            if (this.m_CheckLot.w && MathUtils.Intersect(this.m_LotQuad.da, segment.xz, out t3))
            {
              flag4 = true;
              num6 = math.min(num6, t3.y);
            }
            ...
            {
              // ISSUE: reference to a compiler-generated field
              float num7 = math.distance(this.m_Position.xz, MathUtils.Position(segment.xz, num6));
              if ((double) num7 < (double) float4_3.x)
              {
                float4_3.x = num7 + (float) (((double) float4_3.x - (double) num7) * 0.0099999997764825821);
          ...
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated method
          if ((double) float4_3.w >= (double) this.m_CmpDistance || this.DirectlyConnected(netEntity, this.m_IgnoreOwner) || this.m_IgnoreConnected != Entity.Null && netEntity != this.m_IgnoreConnected && this.DirectlyConnected(netEntity, this.m_IgnoreConnected))
            return;
          ...
          // ISSUE: reference to a compiler-generated field
          this.m_ResultCurvePos = t1;
          // ISSUE: reference to a compiler-generated field
          this.m_IntersectLot = flag4;
          // ISSUE: reference to a compiler-generated field
          if (math.any(this.m_CheckLot))
            return;
          // ISSUE: reference to a compiler-generated field
