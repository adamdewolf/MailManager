    ...
    private struct UpdateSubObjectsJob : IJobParallelForDefer
    {
        ...
        int depth)
      {
        ...
        if ((elevation.m_Flags & ElevationFlags.OnGround) != (ElevationFlags) 0)
        {
          bool flag = true;
          if (component1)
            flag = (componentData1.m_Flags & GeometryFlags.DeleteOverridden) == GeometryFlags.None && (componentData1.m_Flags & (GeometryFlags.Overridable | GeometryFlags.Marker)) != 0;
          if (flag)
          {
            bool angledSample;
            // ISSUE: reference to a compiler-generated field
        ...
        if (oldSubObject != Entity.Null)
        {
          ...
          if (isTemp)
          {
            ...
            if (this.m_TempData.HasComponent(oldSubObject))
            {
              ...
              // ISSUE: reference to a compiler-generated field
              if (component2.m_Original != Entity.Null && this.m_TreeData.HasComponent(component2.m_Original))
              {
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                this.m_CommandBuffer.SetComponent<Tree>(jobIndex, oldSubObject, this.m_TreeData[component2.m_Original]);
              }
            }
            // ISSUE: reference to a compiler-generated field
            ...
            if (this.m_PrefabNetObjectData.HasComponent(prefab))
            {
              ...
              // ISSUE: reference to a compiler-generated field
              this.m_AttachedData.TryGetComponent(oldSubObject, out componentData3);
              componentData3.m_OldParent = componentData3.m_Parent;
              componentData3.m_Parent = Entity.Null;
              // ISSUE: reference to a compiler-generated field
              this.m_CommandBuffer.SetComponent<Attached>(jobIndex, oldSubObject, componentData3);
            }
            // ISSUE: reference to a compiler-generated field
          ...
          {
            // ISSUE: reference to a compiler-generated field
            if (this.m_PseudoRandomSeedData.TryGetComponent(component2.m_Original, out componentData4))
            {
              // ISSUE: reference to a compiler-generated field
              this.m_CommandBuffer.SetComponent<PseudoRandomSeed>(jobIndex, oldSubObject, componentData4);
            }
            else
            {
              // ISSUE: reference to a compiler-generated field
              if (!this.m_PseudoRandomSeedData.TryGetComponent(oldSubObject, out componentData4))
              {
                componentData4 = pseudoRandomSeed;
                // ISSUE: reference to a compiler-generated field
                this.m_CommandBuffer.AddComponent<PseudoRandomSeed>(jobIndex, oldSubObject, componentData4);
              }
            }
          }
          if ((flags & SubObjectFlags.OnGround) == (SubObjectFlags) 0)
          ...
          {
            Destroyed componentData5;
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            if (this.m_InterpolatedTransformData.HasComponent(oldSubObject) && (!this.m_PrefabBuildingExtensionData.HasComponent(prefab) || !this.m_DestroyedData.TryGetComponent(oldSubObject, out componentData5) || (double) componentData5.m_Cleared >= 0.0))
            {
              // ISSUE: reference to a compiler-generated field
          ...
          UnderConstruction componentData6 = new UnderConstruction();
          if (component2.m_Original != Entity.Null)
          {
            // ISSUE: reference to a compiler-generated field
            underConstruction = this.m_UnderConstructionData.TryGetComponent(component2.m_Original, out componentData6);
          }
          if (underConstruction)
          {
            ...
            {
              // ISSUE: reference to a compiler-generated field
              this.m_CommandBuffer.AddComponent<UnderConstruction>(jobIndex, oldSubObject, componentData6);
              updated = true;
            }
          }
          else
          ...
          Destroyed componentData7 = new Destroyed();
          if (component2.m_Original != Entity.Null && (ownerTemp.m_Flags & TempFlags.Upgrade) == (TempFlags) 0)
          {
            // ISSUE: reference to a compiler-generated field
            isDestroyed = this.m_DestroyedData.TryGetComponent(component2.m_Original, out componentData7);
          }
          if (isDestroyed)
          {
            // ISSUE: reference to a compiler-generated field
            ...
            {
              // ISSUE: reference to a compiler-generated field
              this.m_CommandBuffer.AddComponent<Destroyed>(jobIndex, oldSubObject, componentData7);
              updated = true;
            }
          }
          else
          ...
          if (this.m_PrefabStreetLightData.HasComponent(prefab))
          {
            ...
            // ISSUE: reference to a compiler-generated field
            if (this.m_StreetLightData.TryGetComponent(oldSubObject, out componentData8))
            {
              streetLight = componentData8;
              flag = true;
            }
            Building componentData9;
            // ISSUE: reference to a compiler-generated field
            if (this.m_BuildingData.TryGetComponent(topOwner, out componentData9))
            {
              // ISSUE: reference to a compiler-generated method
            ...
            {
              Watercraft componentData10;
              // ISSUE: reference to a compiler-generated field
              if (this.m_WatercraftData.TryGetComponent(topOwner, out componentData10))
              {
                // ISSUE: reference to a compiler-generated method
          ...
          StackData componentData11;
          // ISSUE: reference to a compiler-generated field
          if (this.m_PrefabStackData.TryGetComponent(prefab, out componentData11))
          {
            Stack componentData12;
            // ISSUE: reference to a compiler-generated field
            if (this.m_StackData.TryGetComponent(component2.m_Original, out componentData12))
            {
              // ISSUE: reference to a compiler-generated field
              this.m_CommandBuffer.AddComponent<Stack>(jobIndex, oldSubObject, componentData12);
            }
            else
            {
              // ISSUE: reference to a compiler-generated field
              ...
              {
                if (componentData11.m_Direction == StackDirection.Up)
                {
                  componentData12.m_Range.min = componentData11.m_FirstBounds.min - elevation.m_Elevation;
                  componentData12.m_Range.max = componentData11.m_LastBounds.max;
                }
                else
                {
                  componentData12.m_Range.min = componentData11.m_FirstBounds.min;
                  componentData12.m_Range.max = componentData11.m_FirstBounds.max + MathUtils.Size(componentData11.m_MiddleBounds) * 2f + MathUtils.Size(componentData11.m_LastBounds);
                }
                // ISSUE: reference to a compiler-generated field
                this.m_CommandBuffer.AddComponent<Stack>(jobIndex, oldSubObject, componentData12);
              }
        ...
        else
        {
          ...
          if (isTemp)
          {
            ...
            {
              // ISSUE: reference to a compiler-generated field
              if (this.m_TreeData.HasComponent(component4.m_Original))
              {
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                this.m_CommandBuffer.SetComponent<Tree>(jobIndex, entity, this.m_TreeData[component4.m_Original]);
              }
              // ISSUE: reference to a compiler-generated field
          ...
          PseudoRandomSeed componentData13 = new PseudoRandomSeed();
          if (component1)
          {
            // ISSUE: reference to a compiler-generated field
            if (!this.m_PseudoRandomSeedData.TryGetComponent(component4.m_Original, out componentData13))
              componentData13 = pseudoRandomSeed;
            // ISSUE: reference to a compiler-generated field
            this.m_CommandBuffer.SetComponent<PseudoRandomSeed>(jobIndex, entity, componentData13);
          }
          if ((flags & SubObjectFlags.OnGround) == (SubObjectFlags) 0)
          {
            // ISSUE: reference to a compiler-generated field
          ...
          UnderConstruction componentData14 = new UnderConstruction();
          if (component4.m_Original != Entity.Null)
          {
            // ISSUE: reference to a compiler-generated field
            underConstruction = this.m_UnderConstructionData.TryGetComponent(component4.m_Original, out componentData14);
          }
          if (underConstruction)
          {
            // ISSUE: reference to a compiler-generated field
            this.m_CommandBuffer.AddComponent<UnderConstruction>(jobIndex, entity, componentData14);
          }
          Destroyed componentData15 = new Destroyed();
          if (component4.m_Original != Entity.Null && (ownerTemp.m_Flags & TempFlags.Upgrade) == (TempFlags) 0)
          {
            // ISSUE: reference to a compiler-generated field
            isDestroyed = this.m_DestroyedData.TryGetComponent(component4.m_Original, out componentData15);
          }
          if (isDestroyed)
          {
            // ISSUE: reference to a compiler-generated field
            this.m_CommandBuffer.AddComponent<Destroyed>(jobIndex, entity, componentData15);
          }
          if (isOverridden)
          {
            // ISSUE: reference to a compiler-generated field
          ...
          {
            StreetLight streetLight = new StreetLight();
            StreetLight componentData16;
            // ISSUE: reference to a compiler-generated field
            if (this.m_StreetLightData.TryGetComponent(component4.m_Original, out componentData16))
              streetLight = componentData16;
            Building componentData17;
            // ISSUE: reference to a compiler-generated field
            if (this.m_BuildingData.TryGetComponent(topOwner, out componentData17))
            {
              // ISSUE: reference to a compiler-generated method
              StreetLightSystem.UpdateStreetLightState(ref streetLight, componentData17);
            }
            else
            {
              Watercraft componentData18;
              // ISSUE: reference to a compiler-generated field
              if (this.m_WatercraftData.TryGetComponent(topOwner, out componentData18))
              {
                // ISSUE: reference to a compiler-generated method
                StreetLightSystem.UpdateStreetLightState(ref streetLight, componentData18);
              }
            }
            // ISSUE: reference to a compiler-generated field
            this.m_CommandBuffer.SetComponent<StreetLight>(jobIndex, entity, streetLight);
          }
          StackData componentData19;
          // ISSUE: reference to a compiler-generated field
          if (this.m_PrefabStackData.TryGetComponent(prefab, out componentData19))
          {
            Stack componentData20;
            // ISSUE: reference to a compiler-generated field
            if (this.m_StackData.TryGetComponent(component4.m_Original, out componentData20))
            {
              // ISSUE: reference to a compiler-generated field
              this.m_CommandBuffer.SetComponent<Stack>(jobIndex, entity, componentData20);
            }
            else
            {
              if (componentData19.m_Direction == StackDirection.Up)
              {
                componentData20.m_Range.min = componentData19.m_FirstBounds.min - elevation.m_Elevation;
                componentData20.m_Range.max = componentData19.m_LastBounds.max;
              }
              else
              {
                componentData20.m_Range.min = componentData19.m_FirstBounds.min;
                componentData20.m_Range.max = componentData19.m_FirstBounds.max + MathUtils.Size(componentData19.m_MiddleBounds) * 2f + MathUtils.Size(componentData19.m_LastBounds);
              }
              // ISSUE: reference to a compiler-generated field
              this.m_CommandBuffer.SetComponent<Stack>(jobIndex, entity, componentData20);
            }
