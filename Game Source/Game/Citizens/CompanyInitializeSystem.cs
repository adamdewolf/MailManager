  ...
  public class CompanyInitializeSystem : GameSystemBase
  {
    ...
    protected override void OnUpdate()
    {
      ...
      CompanyInitializeSystem.InitializeCompanyJob jobData = new CompanyInitializeSystem.InitializeCompanyJob()
      {
        ...
        m_EconomyParameters = this.__query_1030701295_0.GetSingleton<EconomyParameterData>()
      };
      // ISSUE: reference to a compiler-generated field
      this.Dependency = jobData.ScheduleParallel<CompanyInitializeSystem.InitializeCompanyJob>(this.m_CreatedGroup, this.Dependency);
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated method
    ...
    {
      // ISSUE: reference to a compiler-generated field
      this.__query_1030701295_0 = state.GetEntityQuery(new EntityQueryDesc()
      {
