    ...
    private struct UpdateHealthcareJob : IJobChunk
    {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index = 0; index < chunk.Count; ++index)
        {
          ...
          {
            HospitalData result = new HospitalData();
            // ISSUE: reference to a compiler-generated field
            if (this.m_HospitalDatas.HasComponent(prefabRef.m_Prefab))
            {
              // ISSUE: reference to a compiler-generated field
              result = this.m_HospitalDatas[prefabRef.m_Prefab];
            }
            if (bufferAccessor2.Length != 0)
            {
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              UpgradeUtils.CombineStats<HospitalData>(ref result, bufferAccessor2[index], ref this.m_Prefabs, ref this.m_HospitalDatas);
            }
            num1 += dynamicBuffer.Length;
            num2 += result.m_PatientCapacity;
          }
        }
        // ISSUE: reference to a compiler-generated field
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index = 0; index < chunk.Count; ++index)
        {
          ...
          if ((double) efficiency != 0.0)
          {
            ...
            {
              // ISSUE: reference to a compiler-generated field
              result = this.m_DeathcareFacilities[prefab];
            }
            if (bufferAccessor2.Length != 0)
            {
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              UpgradeUtils.CombineStats<DeathcareFacilityData>(ref result, bufferAccessor2[index], ref this.m_Prefabs, ref this.m_DeathcareFacilities);
            }
            if (result.m_LongTermStorage)
            {
              Game.Buildings.DeathcareFacility deathcareFacility = nativeArray1[index];
              num2 += (float) deathcareFacility.m_LongTermStoredCount;
              num3 += (float) result.m_StorageCapacity;
            }
            num1 += efficiency * result.m_ProcessingRate;
          }
        }
        // ISSUE: reference to a compiler-generated field
