...
label_25:
      ...
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated method
      this.m_InfoUISystem.AddDeveloperInfo((ISubsectionSource) new InfoList((Func<Entity, Entity, bool>) ((entity, prefab) => (this.EntityManager.HasComponent<Building>(entity) || this.EntityManager.HasComponent<Household>(entity)) && this.EntityManager.HasComponent<OwnedVehicle>(entity)), (Action<Entity, Entity, InfoList>) ((entity, prefab, info) =>
      {
      ...
      this.m_InfoUISystem.AddDeveloperInfo((ISubsectionSource) new InfoList((Func<Entity, Entity, bool>) ((entity, prefab) => this.EntityManager.HasComponent<CompanyData>(entity) && this.EntityManager.HasComponent<ServiceAvailable>(entity) && this.EntityManager.HasComponent<Game.Economy.Resources>(entity)), (Action<Entity, Entity, InfoList>) ((entity, prefab, info) =>
      {
        ...
        if (this.EntityManager.HasComponent<Game.Companies.ProcessingCompany>(entity) && this.EntityManager.TryGetComponent<IndustrialProcessData>(prefab, out component44))
        {
          ...
          if (this.EntityManager.TryGetComponent<PropertyRenter>(entity, out component45) && component45.m_Property != InfoList.Item.kNullEntity && this.EntityManager.TryGetComponent<LodgingProvider>(entity, out component46) && resource == Resource.Lodging)
          {
            ...
            entityManager = this.EntityManager;
            // ISSUE: reference to a compiler-generated method
            int roomCount = LodgingProviderSystem.GetRoomCount(entityManager.GetComponentData<Game.Prefabs.BuildingData>(prefab5).m_LotSize, (int) componentData31.m_Level);
      ...
      {
        Game.Vehicles.DeliveryTruck componentData32 = this.EntityManager.GetComponentData<Game.Vehicles.DeliveryTruck>(entity);
        DeliveryTruckData componentData33 = this.EntityManager.GetComponentData<DeliveryTruckData>(prefab);
        ...
        {
          resource = componentData32.m_Resource;
          if ((componentData32.m_State & DeliveryTruckFlags.Loaded) != (DeliveryTruckFlags) 0)
            num11 = componentData32.m_Amount;
          num12 = componentData33.m_CargoCapacity;
        }
        bool flag1 = (componentData32.m_State & DeliveryTruckFlags.StorageTransfer) > (DeliveryTruckFlags) 0;
        bool flag2 = (componentData32.m_State & DeliveryTruckFlags.Buying) > (DeliveryTruckFlags) 0;
        bool flag3 = (componentData32.m_State & DeliveryTruckFlags.Returning) > (DeliveryTruckFlags) 0;
        bool flag4 = (componentData32.m_State & DeliveryTruckFlags.Delivering) > (DeliveryTruckFlags) 0;
        info.label = "Delivery Truck";
        if ((componentData32.m_State & DeliveryTruckFlags.DummyTraffic) != (DeliveryTruckFlags) 0)
          info.Add(new InfoList.Item("Dummy Traffic"));
      ...
      this.m_InfoUISystem.AddDeveloperInfo((ISubsectionSource) new InfoList((Func<Entity, Entity, bool>) ((entity, prefab) => this.EntityManager.HasComponent<Vehicle>(entity) && this.EntityManager.HasComponent<Game.Vehicles.Ambulance>(entity) && this.EntityManager.HasComponent<AmbulanceData>(prefab)), (Action<Entity, Entity, InfoList>) ((entity, prefab, info) =>
      {
        ...
        Entity target = this.EntityManager.GetComponentData<Game.Common.Target>(entity).m_Target;
        ...
        else if ((componentData.m_State & AmbulanceFlags.Transporting) != (AmbulanceFlags) 0)
        {
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated method
          info.Add(new InfoList.Item("Transporting to: " + this.m_NameSystem.GetDebugName(target), target));
        }
        else
        {
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated method
          info.Add(new InfoList.Item("Picking up from: " + this.m_NameSystem.GetDebugName(target), target));
        }
      })));
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated method
      ...
      {
        Game.Vehicles.GarbageTruck componentData34 = this.EntityManager.GetComponentData<Game.Vehicles.GarbageTruck>(entity);
        GarbageTruckData componentData35 = this.EntityManager.GetComponentData<GarbageTruckData>(prefab);
        info.label = "Garbage Truck";
        info.Add(new InfoList.Item("Capacity: " + (object) componentData34.m_Garbage + "/" + (object) componentData35.m_GarbageCapacity));
        if ((componentData34.m_State & GarbageTruckFlags.Unloading) != (GarbageTruckFlags) 0)
        {
          info.Add(new InfoList.Item("Unloading"));
        }
        else
        {
          if ((componentData34.m_State & GarbageTruckFlags.Returning) == (GarbageTruckFlags) 0)
            return;
          info.Add(new InfoList.Item("Returning"));
        }
      })));
      ...
      this.m_InfoUISystem.AddDeveloperInfo((ISubsectionSource) new InfoList((Func<Entity, Entity, bool>) ((entity, prefab) => this.EntityManager.HasComponent<Vehicle>(entity) && this.EntityManager.HasComponent<Game.Vehicles.PublicTransport>(entity) && this.EntityManager.HasComponent<PublicTransportVehicleData>(prefab)), (Action<Entity, Entity, InfoList>) ((entity, prefab, info) =>
      {
        ...
        if ((componentData.m_State & PublicTransportFlags.DummyTraffic) != (PublicTransportFlags) 0)
          info.Add(new InfoList.Item("Dummy Traffic"));
        CurrentRoute component72;
        if (this.EntityManager.TryGetComponent<CurrentRoute>(entity, out component72))
        {
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated method
          info.Add(new InfoList.Item("Line: " + this.m_NameSystem.GetDebugName(component72.m_Route), component72.m_Route));
        }
        ...
        PublicTransportVehicleData component73;
        if (this.EntityManager.TryGetComponent<PublicTransportVehicleData>(prefab, out component73))
        {
          ...
          {
            Odometer component74;
            if ((double) component73.m_MaintenanceRange > 0.10000000149011612 && this.EntityManager.TryGetComponent<Odometer>(entity, out component74))
            {
              int num13 = Mathf.RoundToInt(component73.m_MaintenanceRange * (1f / 1000f));
              int num14 = math.max(0, Mathf.RoundToInt((float) (((double) component73.m_MaintenanceRange - (double) component74.m_Distance) * (1.0 / 1000.0))));
      ...
      {
        Game.Vehicles.CargoTransport componentData36 = this.EntityManager.GetComponentData<Game.Vehicles.CargoTransport>(entity);
        CargoTransportVehicleData componentData37 = this.EntityManager.GetComponentData<CargoTransportVehicleData>(prefab);
        info.label = "Cargo Transport";
        if ((componentData36.m_State & CargoTransportFlags.DummyTraffic) != (CargoTransportFlags) 0)
          info.Add(new InfoList.Item("Dummy Traffic"));
        CurrentRoute component75;
        if (this.EntityManager.TryGetComponent<CurrentRoute>(entity, out component75))
        {
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated method
          info.Add(new InfoList.Item("Route: " + this.m_NameSystem.GetDebugName(component75.m_Route), component75.m_Route));
        }
        if ((componentData36.m_State & CargoTransportFlags.Returning) != (CargoTransportFlags) 0)
          info.Add(new InfoList.Item("Returning"));
        else if ((componentData36.m_State & CargoTransportFlags.Boarding) != (CargoTransportFlags) 0)
        {
          info.Add(new InfoList.Item("Loading"));
          // ISSUE: reference to a compiler-generated field
          if (this.m_SimulationSystem.frameIndex < componentData36.m_DepartureFrame)
          {
            // ISSUE: reference to a compiler-generated field
            int num = Mathf.CeilToInt((float) (componentData36.m_DepartureFrame - this.m_SimulationSystem.frameIndex) / 60f);
            info.Add(new InfoList.Item("Departure: " + (object) num + "s"));
          }
        }
        else if ((componentData36.m_State & CargoTransportFlags.EnRoute) != (CargoTransportFlags) 0)
          info.Add(new InfoList.Item("En route"));
        CargoTransportVehicleData component76;
        if (this.EntityManager.TryGetComponent<CargoTransportVehicleData>(prefab, out component76))
        {
          if ((componentData36.m_State & CargoTransportFlags.RequiresMaintenance) != (CargoTransportFlags) 0)
          {
            info.Add(new InfoList.Item("Maintenance scheduled"));
          }
          else
          {
            Odometer component77;
            if ((double) component76.m_MaintenanceRange > 0.10000000149011612 && this.EntityManager.TryGetComponent<Odometer>(entity, out component77))
            {
              int num15 = Mathf.RoundToInt(component76.m_MaintenanceRange * (1f / 1000f));
              int num16 = math.max(0, Mathf.RoundToInt((float) (((double) component76.m_MaintenanceRange - (double) component77.m_Distance) * (1.0 / 1000.0))));
        ...
        if (this.EntityManager.TryGetBuffer<LayoutElement>(entity, true, out buffer56))
        {
          for (int index = 0; index < buffer56.Length; ++index)
          {
            ...
            PrefabRef component78;
            CargoTransportVehicleData component79;
            if (this.EntityManager.TryGetComponent<PrefabRef>(vehicle, out component78) && this.EntityManager.TryGetComponent<CargoTransportVehicleData>(component78.m_Prefab, out component79))
              num17 += component79.m_CargoCapacity;
          }
        }
        else
        {
          ...
          num17 += componentData37.m_CargoCapacity;
        }
      ...
      {
        Game.Vehicles.MaintenanceVehicle componentData38 = this.EntityManager.GetComponentData<Game.Vehicles.MaintenanceVehicle>(entity);
        MaintenanceVehicleData componentData39 = this.EntityManager.GetComponentData<MaintenanceVehicleData>(prefab);
        componentData39.m_MaintenanceCapacity = Mathf.CeilToInt((float) componentData39.m_MaintenanceCapacity * componentData38.m_Efficiency);
        info.label = "Maintenance Vehicle";
        info.Add(new InfoList.Item("Work shift: " + string.Format("{0}%", (object) Mathf.CeilToInt(math.select((float) componentData38.m_Maintained / (float) componentData39.m_MaintenanceCapacity, 0.0f, componentData39.m_MaintenanceCapacity == 0) * 100f))));
        if ((componentData38.m_State & MaintenanceVehicleFlags.ClearingDebris) != (MaintenanceVehicleFlags) 0)
        {
          info.Add(new InfoList.Item("Clearing debris"));
        }
        else
        {
          if ((componentData38.m_State & MaintenanceVehicleFlags.Returning) == (MaintenanceVehicleFlags) 0)
            return;
          info.Add(new InfoList.Item("Returning"));
        }
      })));
      ...
      {
        Game.Vehicles.PostVan componentData40 = this.EntityManager.GetComponentData<Game.Vehicles.PostVan>(entity);
        PostVanData componentData41 = this.EntityManager.GetComponentData<PostVanData>(prefab);
        info.label = "Post Van";
        info.Add(new InfoList.Item("Mail to deliver: " + (object) componentData40.m_DeliveringMail + "/" + (object) componentData41.m_MailCapacity));
        info.Add(new InfoList.Item("Collected mail: " + (object) componentData40.m_CollectedMail + "/" + (object) componentData41.m_MailCapacity));
        if ((componentData40.m_State & PostVanFlags.Returning) == (PostVanFlags) 0)
          return;
        info.Add(new InfoList.Item("Returning"));
      })));
      // ISSUE: reference to a compiler-generated field
      ...
      {
        Game.Vehicles.FireEngine componentData42 = this.EntityManager.GetComponentData<Game.Vehicles.FireEngine>(entity);
        EntityManager entityManager = this.EntityManager;
        FireEngineData componentData43 = entityManager.GetComponentData<FireEngineData>(prefab);
        entityManager = this.EntityManager;
        DynamicBuffer<ServiceDispatch> buffer59 = entityManager.GetBuffer<ServiceDispatch>(entity, true);
        info.label = "Fire Engine";
        int num19 = Mathf.CeilToInt(componentData42.m_ExtinguishingAmount);
        int num20 = Mathf.CeilToInt(componentData43.m_ExtinguishingCapacity);
        if (num20 > 0)
          info.Add(new InfoList.Item("Load: " + (object) num19 + "/" + (object) num20));
        if ((componentData42.m_State & FireEngineFlags.Extinguishing) != (FireEngineFlags) 0)
          info.Add(new InfoList.Item("Extinguishing"));
        else if ((componentData42.m_State & FireEngineFlags.Rescueing) != (FireEngineFlags) 0)
          info.Add(new InfoList.Item("Searching for survivors"));
        else if ((componentData42.m_State & FireEngineFlags.Returning) != (FireEngineFlags) 0)
        {
          info.Add(new InfoList.Item("Returning"));
        }
        else
        {
          FireRescueRequest component80;
          if (componentData42.m_RequestCount <= 0 || buffer59.Length <= 0 || !this.EntityManager.TryGetComponent<FireRescueRequest>(buffer59[0].m_Request, out component80))
            return;
          OnFire component81;
          if (this.EntityManager.TryGetComponent<OnFire>(component80.m_Target, out component81) && component81.m_Event != InfoList.Item.kNullEntity)
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated method
            info.Add(new InfoList.Item("Dispatched" + this.m_NameSystem.GetDebugName(component81.m_Event), component81.m_Event));
          }
          else
          {
            Destroyed component82;
            if (this.EntityManager.TryGetComponent<Destroyed>(component80.m_Target, out component82) && component82.m_Event != InfoList.Item.kNullEntity)
            {
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated method
              info.Add(new InfoList.Item("Dispatched" + this.m_NameSystem.GetDebugName(component82.m_Event), component82.m_Event));
            }
            else
            {
              if (!(component80.m_Target != InfoList.Item.kNullEntity))
                return;
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated method
              info.Add(new InfoList.Item("Dispatched" + this.m_NameSystem.GetDebugName(component80.m_Target), component80.m_Target));
            }
          }
        }
      })));
      ...
      {
        Game.Vehicles.PoliceCar componentData44 = this.EntityManager.GetComponentData<Game.Vehicles.PoliceCar>(entity);
        PoliceCarData componentData45 = this.EntityManager.GetComponentData<PoliceCarData>(prefab);
        DynamicBuffer<ServiceDispatch> buffer60 = this.EntityManager.GetBuffer<ServiceDispatch>(entity, true);
        info.label = "Police Car";
        if (componentData45.m_ShiftDuration > 0U)
        {
          uint num = math.min(componentData44.m_ShiftTime, componentData45.m_ShiftDuration);
          info.Add(new InfoList.Item("Work shift: " + (object) num + "/" + (object) componentData45.m_ShiftDuration));
        }
        ...
        if (this.EntityManager.TryGetBuffer<Passenger>(entity, true, out buffer61))
        {
          for (int index = 0; index < buffer61.Length; ++index)
          {
            ...
            Game.Creatures.Resident component83;
            if (this.EntityManager.TryGetComponent<Game.Creatures.Resident>(entity5, out component83))
              entity5 = component83.m_Citizen;
        ...
        if ((componentData44.m_State & PoliceCarFlags.Returning) != (PoliceCarFlags) 0)
          info.Add(new InfoList.Item("Returning"));
        else if ((componentData44.m_State & PoliceCarFlags.AccidentTarget) != (PoliceCarFlags) 0)
        {
          if ((componentData44.m_State & PoliceCarFlags.AtTarget) != (PoliceCarFlags) 0)
          {
            PoliceEmergencyRequest component84;
            AccidentSite component85;
            if (componentData44.m_RequestCount <= 0 || buffer60.Length <= 0 || !this.EntityManager.TryGetComponent<PoliceEmergencyRequest>(buffer60[0].m_Request, out component84) || !this.EntityManager.TryGetComponent<AccidentSite>(component84.m_Site, out component85))
              return;
            if ((component85.m_Flags & AccidentSiteFlags.TrafficAccident) != (AccidentSiteFlags) 0)
            {
              info.Add(new InfoList.Item("Securing accident site"));
            }
            else
            {
              if ((component85.m_Flags & AccidentSiteFlags.CrimeScene) == (AccidentSiteFlags) 0)
                return;
          ...
          else
          {
            ...
            if (componentData44.m_RequestCount <= 0 || buffer60.Length <= 0 || !this.EntityManager.TryGetComponent<PoliceEmergencyRequest>(buffer60[0].m_Request, out component86))
              return;
            AccidentSite component87;
            if (this.EntityManager.TryGetComponent<AccidentSite>(component86.m_Site, out component87) && component87.m_Event != InfoList.Item.kNullEntity)
            {
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated method
              info.Add(new InfoList.Item("Dispatched" + this.m_NameSystem.GetDebugName(component87.m_Event), component87.m_Event));
            }
            else
            {
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated method
              info.Add(new InfoList.Item("Dispatched" + this.m_NameSystem.GetDebugName(component86.m_Site), component86.m_Site));
            }
          }
        }
        else
      ...
      this.m_InfoUISystem.AddDeveloperInfo((ISubsectionSource) new InfoList((Func<Entity, Entity, bool>) ((entity, prefab) => this.EntityManager.HasComponent<HouseholdMember>(entity) && this.EntityManager.HasComponent<Citizen>(entity)), (Action<Entity, Entity, InfoList>) ((entity, prefab, info) =>
      {
        ...
        if (!flag)
        {
          ...
          CurrentBuilding component88;
          if (this.EntityManager.TryGetComponent<CurrentBuilding>(entity, out component88))
            entity6 = component88.m_CurrentBuilding;
          ...
          if (this.EntityManager.HasComponent<Game.Economy.Resources>(household))
          {
            ...
            PropertyRenter component89;
            if (this.EntityManager.TryGetComponent<PropertyRenter>(household, out component89))
            {
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              this.__TypeHandle.__Game_Buildings_Renter_RO_BufferLookup.Update(ref this.CheckedStateRef);
              ...
              int householdSpendableMoney = EconomyUtils.GetHouseholdSpendableMoney(householdData, this.EntityManager.GetBuffer<Game.Economy.Resources>(household, true), ref renterRoBufferLookup, ref roComponentLookup46, ref roComponentLookup47, component89);
              info.Add(new InfoList.Item("Household spendable Money: " + householdSpendableMoney.ToString()));
            }
          }
        }
        CarKeeper component90;
        if (this.EntityManager.IsComponentEnabled<CarKeeper>(entity) && this.EntityManager.TryGetComponent<CarKeeper>(entity, out component90))
        {
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated method
          info.Add(new InfoList.Item("Car: " + this.m_NameSystem.GetDebugName(component90.m_Car), component90.m_Car));
        }
        if (!flag)
        {
          ...
          {
            info.Add(new InfoList.Item("Property: " + component91.m_Property.ToString(), component91.m_Property));
            info.Add(new InfoList.Item("Rent: " + component91.m_Rent.ToString()));
          }
          else if (!tourist)
        ...
        Criminal component92;
        bool component93 = this.EntityManager.TryGetComponent<Criminal>(entity, out component92);
        TravelPurpose component94;
        if (this.EntityManager.TryGetComponent<TravelPurpose>(entity, out component94))
        {
          Entity kNullEntity = InfoList.Item.kNullEntity;
          // ISSUE: reference to a compiler-generated method
          string purposeText = this.GetPurposeText(component94, tourist, component92, ref kNullEntity);
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated method
        ...
        HealthProblem component95;
        if (this.EntityManager.TryGetComponent<HealthProblem>(entity, out component95))
        {
          if ((component95.m_Flags & HealthProblemFlags.Sick) != HealthProblemFlags.None)
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated method
            info.Add(new InfoList.Item("Sick " + this.m_NameSystem.GetDebugName(component95.m_Event), component95.m_Event));
          }
          else if ((component95.m_Flags & HealthProblemFlags.Injured) != HealthProblemFlags.None)
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated method
            info.Add(new InfoList.Item("Injured " + this.m_NameSystem.GetDebugName(component95.m_Event), component95.m_Event));
          }
          else if ((component95.m_Flags & HealthProblemFlags.Dead) != HealthProblemFlags.None)
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated method
            info.Add(new InfoList.Item("Dead " + this.m_NameSystem.GetDebugName(component95.m_Event), component95.m_Event));
          }
          else if ((component95.m_Flags & HealthProblemFlags.Trapped) != HealthProblemFlags.None)
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated method
            info.Add(new InfoList.Item("Trapped " + this.m_NameSystem.GetDebugName(component95.m_Event), component95.m_Event));
          }
          else if ((component95.m_Flags & HealthProblemFlags.InDanger) != HealthProblemFlags.None)
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated method
            info.Add(new InfoList.Item("In danger " + this.m_NameSystem.GetDebugName(component95.m_Event), component95.m_Event));
          }
        }
        if (component93)
        {
          string text = "Criminal";
          if ((component92.m_Flags & CriminalFlags.Robber) != (CriminalFlags) 0)
            text += " Robber ";
          if ((component92.m_Flags & CriminalFlags.Prisoner) != (CriminalFlags) 0)
            text = text + "Jail Time: " + ((uint) ((int) component92.m_JailTime * 16 * 16) / 262144U).ToString();
        ...
        if (!tourist)
        {
          ...
          Citizen component96;
          if (this.EntityManager.TryGetComponent<Citizen>(entity, out component96))
          {
            CitizenAge age = component96.GetAge();
            Worker component97;
            if (this.EntityManager.TryGetComponent<Worker>(entity, out component97))
            {
              Entity workplace = component97.m_Workplace;
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated method
              info.Add(new InfoList.Item("Works at: " + this.m_NameSystem.GetDebugName(workplace), workplace));
              // ISSUE: reference to a compiler-generated method
              float2 timeToWork1 = WorkerSystem.GetTimeToWork(componentData, component97, ref singleton, false);
              // ISSUE: reference to a compiler-generated method
              // ISSUE: reference to a compiler-generated method
              info.Add(new InfoList.Item("Work Shift: " + (this.GetTimeString(timeToWork1.x) + " to " + this.GetTimeString(timeToWork1.y))));
              // ISSUE: reference to a compiler-generated method
              float2 timeToWork2 = WorkerSystem.GetTimeToWork(componentData, component97, ref singleton, true);
              // ISSUE: reference to a compiler-generated method
              // ISSUE: reference to a compiler-generated method
            ...
            {
              Game.Citizens.Student component98;
              if (this.EntityManager.TryGetComponent<Game.Citizens.Student>(entity, out component98))
              {
                Entity school = component98.m_School;
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated method
                info.Add(new InfoList.Item("Studies at: " + this.m_NameSystem.GetDebugName(school), school));
                // ISSUE: reference to a compiler-generated method
                float2 timeToStudy = StudentSystem.GetTimeToStudy(componentData, component98, ref singleton);
                // ISSUE: reference to a compiler-generated method
                // ISSUE: reference to a compiler-generated method
        ...
        AttendingMeeting component99;
        CoordinatedMeeting component100;
        if (this.EntityManager.TryGetComponent<AttendingMeeting>(entity, out component99) && this.EntityManager.TryGetComponent<CoordinatedMeeting>(component99.m_Meeting, out component100))
        {
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated method
          InfoList.Item obj = component100.m_Target != InfoList.Item.kNullEntity ? new InfoList.Item("Meeting at: " + this.m_NameSystem.GetDebugName(component100.m_Target), component100.m_Target) : new InfoList.Item("Planning a meeting");
          info.Add(obj);
        }
        AttendingEvent component101;
        if (!this.EntityManager.TryGetComponent<AttendingEvent>(household, out component101) || !this.EntityManager.HasComponent<Game.Events.CalendarEvent>(component101.m_Event))
          return;
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated method
        info.Add(new InfoList.Item("Participating in " + this.m_NameSystem.GetDebugName(component101.m_Event)));
      })));
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated method
      ...
      this.m_InfoUISystem.AddDeveloperInfo((ISubsectionSource) new InfoList((Func<Entity, Entity, bool>) ((entity, prefab) =>
      {
        CurrentTransport component102;
        if (this.EntityManager.TryGetComponent<CurrentTransport>(entity, out component102))
          entity = component102.m_CurrentTransport;
        return this.EntityManager.HasComponent<Creature>(entity);
      }), (Action<Entity, Entity, InfoList>) ((entity, prefab, info) =>
      {
        info.label = "Creature";
        Citizen component103;
        CurrentTransport component104;
        if (!this.EntityManager.TryGetComponent<Citizen>(entity, out component103) || !this.EntityManager.TryGetComponent<CurrentTransport>(entity, out component104))
          return;
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated method
        info.Add(new InfoList.Item("Entity: " + this.m_NameSystem.GetDebugName(component104.m_CurrentTransport)));
        bool tourist = (component103.m_State & CitizenFlags.Tourist) != 0;
        Criminal component105;
        this.EntityManager.TryGetComponent<Criminal>(entity, out component105);
        Divert component106;
        if (this.EntityManager.TryGetComponent<Divert>(component104.m_CurrentTransport, out component106) && component106.m_Purpose != Game.Citizens.Purpose.None)
        {
          Entity kNullEntity = InfoList.Item.kNullEntity;
          // ISSUE: reference to a compiler-generated method
          string purposeText = this.GetPurposeText(new TravelPurpose()
          {
            m_Purpose = component106.m_Purpose,
            m_Resource = component106.m_Resource
          }, tourist, component105, ref kNullEntity);
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated method
          info.Add(new InfoList.Item(purposeText + " " + this.m_NameSystem.GetDebugName(kNullEntity), kNullEntity));
        }
        RideNeeder component107;
        if (this.EntityManager.TryGetComponent<RideNeeder>(component104.m_CurrentTransport, out component107))
        {
          Dispatched component108;
          DynamicBuffer<ServiceDispatch> buffer62;
          if (this.EntityManager.TryGetComponent<Dispatched>(component107.m_RideRequest, out component108) && this.EntityManager.TryGetBuffer<ServiceDispatch>(component108.m_Handler, true, out buffer62) && buffer62.Length > 0 && buffer62[0].m_Request == component107.m_RideRequest)
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated method
            info.Add(new InfoList.Item("Waiting for ride: " + this.m_NameSystem.GetDebugName(component108.m_Handler), component108.m_Handler));
          }
          else
            info.Add(new InfoList.Item("Taking a taxi"));
        }
        HumanCurrentLane component109;
        if (!this.EntityManager.TryGetComponent<HumanCurrentLane>(component104.m_CurrentTransport, out component109))
          return;
        Creature componentData = this.EntityManager.GetComponentData<Creature>(component104.m_CurrentTransport);
        if ((component109.m_Flags & CreatureLaneFlags.EndReached) != (CreatureLaneFlags) 0)
        {
          if ((component109.m_Flags & CreatureLaneFlags.Transport) == (CreatureLaneFlags) 0)
            return;
          PathOwner component110;
          DynamicBuffer<PathElement> buffer63;
          if (this.EntityManager.TryGetComponent<PathOwner>(component104.m_CurrentTransport, out component110) && this.EntityManager.TryGetBuffer<PathElement>(component104.m_CurrentTransport, true, out buffer63) && buffer63.Length > component110.m_ElementIndex)
          {
            Entity entity7 = buffer63[component110.m_ElementIndex].m_Target;
            Owner component111;
            if (this.EntityManager.TryGetComponent<Owner>(entity7, out component111))
              entity7 = component111.m_Owner;
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated method
        ...
        else
        {
          ...
          if (componentData.m_QueueEntity != Entity.Null)
          {
            ...
            Owner component112;
            if (this.EntityManager.HasComponent<Waypoint>(entity8) && this.EntityManager.TryGetComponent<Owner>(entity8, out component112))
              entity8 = component112.m_Owner;
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated method
      ...
      this.m_InfoUISystem.AddDeveloperInfo((ISubsectionSource) new InfoList((Func<Entity, Entity, bool>) ((entity, prefab) =>
      {
        CurrentTransport component113;
        if (this.EntityManager.TryGetComponent<CurrentTransport>(entity, out component113))
          entity = component113.m_CurrentTransport;
        return this.EntityManager.HasComponent<GroupCreature>(entity);
      }), (Action<Entity, Entity, InfoList>) ((entity, prefab, info) =>
      {
        CurrentTransport component114;
        if (this.EntityManager.TryGetComponent<CurrentTransport>(entity, out component114))
          entity = component114.m_CurrentTransport;
      ...
      {
        Tree componentData46 = this.EntityManager.GetComponentData<Tree>(entity);
        Plant componentData47 = this.EntityManager.GetComponentData<Plant>(entity);
        Damaged component117;
        this.EntityManager.TryGetComponent<Damaged>(entity, out component117);
        int num = 0;
        TreeData component118;
        if (this.EntityManager.TryGetComponent<TreeData>(prefab, out component118))
          num = Mathf.RoundToInt(ObjectUtils.CalculateWoodAmount(componentData46, componentData47, component117, component118));
        info.label = string.Format("Wood: {0}", (object) num);
        info.value = num;
        info.max = Mathf.RoundToInt(component118.m_WoodAmount);
      })));
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated method
      ...
      {
        Game.Routes.MailBox componentData48 = this.EntityManager.GetComponentData<Game.Routes.MailBox>(entity);
        MailBoxData componentData49 = this.EntityManager.GetComponentData<MailBoxData>(prefab);
        info.label = "Stored Mail in Mailbox";
        info.value = componentData48.m_MailAmount;
        info.max = componentData49.m_MailCapacity;
      })));
      BoardingVehicle component119;
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated method
      this.m_InfoUISystem.AddDeveloperInfo((ISubsectionSource) new GenericInfo((Func<Entity, Entity, bool>) ((entity, prefab) => this.EntityManager.TryGetComponent<BoardingVehicle>(entity, out component119) && component119.m_Vehicle != InfoList.Item.kNullEntity), (Action<Entity, Entity, GenericInfo>) ((entity, prefab, info) =>
      {
      ...
      {
        WaitingPassengers component120;
        this.EntityManager.TryGetComponent<WaitingPassengers>(entity, out component120);
        ...
        if (this.EntityManager.TryGetBuffer<ConnectedRoute>(entity, true, out buffer65))
        {
          ...
          {
            WaitingPassengers component121;
            if (this.EntityManager.TryGetComponent<WaitingPassengers>(buffer65[index].m_Waypoint, out component121))
            {
              component120.m_Count += component121.m_Count;
              num21 += (int) component121.m_AverageWaitingTime;
            }
          }
          int num22 = num21 / math.max(1, buffer65.Length);
          int num23 = num22 - num22 % 5;
          component120.m_AverageWaitingTime = (ushort) num23;
        }
        info.label = "Waiting passengers";
        info.Add(new InfoList.Item("Passenger count: " + (object) component120.m_Count));
        info.Add(new InfoList.Item("Waiting time: " + (component120.m_AverageWaitingTime.ToString() + "s")));
      })));
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated method
      this.m_InfoUISystem.AddDeveloperInfo((ISubsectionSource) new CapacityInfo((Func<Entity, Entity, bool>) ((entity, prefab) =>
      {
        CurrentTransport component122;
        if (this.EntityManager.TryGetComponent<CurrentTransport>(entity, out component122))
          entity = component122.m_CurrentTransport;
        return this.EntityManager.HasComponent<Moving>(entity);
      }), (Action<Entity, Entity, CapacityInfo>) ((entity, prefab, info) =>
      {
        CurrentTransport component123;
        if (this.EntityManager.TryGetComponent<CurrentTransport>(entity, out component123))
        {
          entity = component123.m_CurrentTransport;
          prefab = this.EntityManager.GetComponentData<PrefabRef>(entity).m_Prefab;
        }
        ...
        CarData component124;
        if (this.EntityManager.TryGetComponent<CarData>(prefab, out component124))
        {
          num25 = Mathf.RoundToInt(component124.m_MaxSpeed * 3.6f);
        }
        else
        {
          WatercraftData component125;
          if (this.EntityManager.TryGetComponent<WatercraftData>(prefab, out component125))
          {
            num25 = Mathf.RoundToInt(component125.m_MaxSpeed * 3.6f);
          }
          else
          {
            AirplaneData component126;
            if (this.EntityManager.TryGetComponent<AirplaneData>(prefab, out component126))
            {
              num25 = Mathf.RoundToInt(component126.m_FlyingSpeed.y * 3.6f);
            }
            else
            {
              HelicopterData component127;
              if (this.EntityManager.TryGetComponent<HelicopterData>(prefab, out component127))
              {
                num25 = Mathf.RoundToInt(component127.m_FlyingMaxSpeed * 3.6f);
              }
              else
              {
                TrainData component128;
                if (this.EntityManager.TryGetComponent<TrainData>(prefab, out component128))
                {
                  num25 = Mathf.RoundToInt(component128.m_MaxSpeed * 3.6f);
                }
                else
                {
                  HumanData component129;
                  if (this.EntityManager.TryGetComponent<HumanData>(prefab, out component129))
                  {
                    num25 = Mathf.RoundToInt(component129.m_RunSpeed * 3.6f);
                  }
                  else
                  {
                    AnimalData component130;
                    if (this.EntityManager.TryGetComponent<AnimalData>(prefab, out component130))
                      num25 = Mathf.RoundToInt(component130.m_MoveSpeed * 3.6f);
                  }
                }
              }
            }
      ...
      this.m_InfoUISystem.AddDeveloperInfo((ISubsectionSource) new InfoList((Func<Entity, Entity, bool>) ((entity, prefab) => this.EntityManager.HasComponent<Icon>(entity)), (Action<Entity, Entity, InfoList>) ((entity, prefab, info) =>
      {
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated method
        info.Add(this.EntityManager.TryGetComponent<Owner>(entity, out component131) ? new InfoList.Item(prefab6.m_Description + this.m_NameSystem.GetDebugName(component131.m_Owner), component131.m_Owner) : new InfoList.Item(prefab6.m_Description));
        Game.Common.Target component132;
        if (!this.EntityManager.TryGetComponent<Game.Common.Target>(entity, out component132))
          return;
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated method
        info.Add(new InfoList.Item(prefab6.m_TargetDescription + this.m_NameSystem.GetDebugName(component132.m_Target), component132.m_Target));
      })));
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated method
...
label_25:
    ...
    {
      return (this.EntityManager.HasComponent<Building>(entity) || this.EntityManager.HasComponent<Household>(entity)) && this.EntityManager.HasComponent<OwnedVehicle>(entity);
    }
      ...
      for (int index1 = 0; index1 < subLanes.Length; ++index1)
      {
        ...
        if (this.EntityManager.TryGetComponent<Game.Net.ParkingLane>(subLane, out component1))
        {
          if ((component1.m_Flags & ParkingLaneFlags.VirtualLane) == (ParkingLaneFlags) 0)
          {
            ...
            {
              int num = (int) math.floor((componentData1.m_Length + 0.01f) / componentData2.m_SlotInterval);
              slotCapacity += num;
            }
            else
    ...
    private void UpdateServiceCompanyInfo(Entity entity, Entity prefab, InfoList info)
    {
      ...
      if (this.EntityManager.HasComponent<Game.Companies.ProcessingCompany>(entity) && this.EntityManager.TryGetComponent<IndustrialProcessData>(prefab, out component1))
      {
        ...
        if (this.EntityManager.TryGetComponent<PropertyRenter>(entity, out component2) && component2.m_Property != InfoList.Item.kNullEntity && this.EntityManager.TryGetComponent<LodgingProvider>(entity, out component3) && resource == Resource.Lodging)
        {
          ...
          entityManager = this.EntityManager;
          // ISSUE: reference to a compiler-generated method
          int roomCount = LodgingProviderSystem.GetRoomCount(entityManager.GetComponentData<Game.Prefabs.BuildingData>(prefab1).m_LotSize, (int) componentData3.m_Level);
