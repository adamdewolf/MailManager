...
namespace Game.UI.InGame
{
  ...
  public class FireVehicleSection : VehicleSection
  {
    ...
    protected override void OnProcess()
    {
      ...
      DynamicBuffer<ServiceDispatch> buffer = this.EntityManager.GetBuffer<ServiceDispatch>(this.selectedEntity, true);
      ...
      if (this.stateKey == VehicleStateLocaleKey.Dispatched)
      {
        ...
        if (!this.EntityManager.TryGetComponent<FireRescueRequest>(buffer[0].m_Request, out component1))
          return;
        OnFire component2;
