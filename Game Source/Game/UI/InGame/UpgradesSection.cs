...
namespace Game.UI.InGame
{
  ...
  public class UpgradesSection : InfoSectionBase
  {
    ...
    private Game.UI.LegacyBindings.UIInitializeSystem m_UIInitializeSystem;
    ...
    protected override void OnCreate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.m_UIInitializeSystem = this.World.GetOrCreateSystemManaged<Game.UI.LegacyBindings.UIInitializeSystem>();
      // ISSUE: reference to a compiler-generated field
