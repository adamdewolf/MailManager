...
namespace Game.UI.InGame
{
  ...
  public class PoliceVehicleSection : VehicleSection
  {
    ...
    protected override void OnProcess()
    {
      ...
      DynamicBuffer<ServiceDispatch> buffer1 = this.EntityManager.GetBuffer<ServiceDispatch>(this.selectedEntity, true);
      ...
      if ((componentData1.m_State & PoliceCarFlags.AccidentTarget) != (PoliceCarFlags) 0 && (componentData1.m_State & PoliceCarFlags.AtTarget) == (PoliceCarFlags) 0)
      {
        ...
        if (componentData1.m_RequestCount <= 0 || buffer1.Length <= 0 || !this.EntityManager.TryGetComponent<PoliceEmergencyRequest>(buffer1[0].m_Request, out component1))
          return;
