...
namespace Game.UI
{
  public class UISystemBootstrapper : MonoBehaviour, IUIViewComponent
  {
    ...
    private void Awake()
    {
      ...
      LogManager.GetLogger("UI").Info((object) "Bootstrapping cohtmlUISystem");
      ...
      this.m_UIManager.CreateUISystem(settings).AddHostLocation("gameui", Application.streamingAssetsPath + "/~UI~/GameUI");
