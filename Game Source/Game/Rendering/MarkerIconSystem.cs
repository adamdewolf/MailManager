  ...
  public class MarkerIconSystem : GameSystemBase, IDefaultSerializable, ISerializable
  {
    ...
    protected override void OnUpdate()
    {
      ...
      if ((Object) this.m_CameraUpdateSystem.orbitCameraController != (Object) null)
      {
        ...
        if (followedEntity == selected || this.EntityManager.TryGetComponent<CurrentTransport>(followedEntity, out component) && component.m_CurrentTransport == selected)
      ...
      if (followedEntity != Entity.Null && !SelectedInfoUISystem.TryGetPosition(followedEntity, this.EntityManager, out location1, out position2, out bounds1, out rotation))
        location1 = Entity.Null;
      // ISSUE: reference to a compiler-generated method
      if (selected != Entity.Null && (!SelectedInfoUISystem.TryGetPosition(selected, this.EntityManager, out location2, out position1, out bounds2, out rotation) || location1 == location2))
