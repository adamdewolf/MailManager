    ...
    private struct UpdateLanesJob : IJobChunk
    {
      ...
      private void UpdateLanes(ArchetypeChunk chunk, int chunkIndex)
      {
        ...
        for (int index1 = 0; index1 < nativeArray1.Length; ++index1)
        {
          ...
          {
            Entity subLane = lanes[index2].m_SubLane;
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            if (!this.m_MasterLaneData.HasComponent(subLane) && !this.m_SecondaryLaneData.HasComponent(subLane))
            {
              // ISSUE: reference to a compiler-generated field
              ...
              // ISSUE: reference to a compiler-generated field
              if ((netLaneData.m_Flags & LaneFlags.Secondary) == (LaneFlags) 0 && this.m_PrefabSecondaryLanes.TryGetBuffer(prefabRef.m_Prefab, out bufferData) && bufferData.Length != 0)
              {
                float2 float2_1 = math.normalizesafe(MathUtils.StartTangent(curve.m_Bezier).xz);
                float2 float2_2 = math.normalizesafe(MathUtils.EndTangent(curve.m_Bezier).xz);
                ...
                // ISSUE: reference to a compiler-generated field
                if (this.m_NodeLaneData.TryGetComponent(subLane, out componentData1))
                ...
                // ISSUE: reference to a compiler-generated field
                if (this.m_EdgeLaneData.TryGetComponent(subLane, out componentData2))
                {
                  ...
                  if (math.any(x1))
                  {
                    ...
                    {
                      // ISSUE: reference to a compiler-generated field
                      carLaneFlags = this.m_CarLaneData[subLane].m_Flags;
                    }
                    for (int index4 = 0; index4 < bufferData.Length; ++index4)
                    {
                      ...
                      if ((secondaryNetLane.m_Flags & SecondaryNetLaneFlags.Crossing) != (SecondaryNetLaneFlags) 0)
                      {
                        ...
                        if (math.any(x2) && this.CheckRequirements(ref laneBuffer, secondaryNetLane.m_Lane))
                        {
                          ...
                          // ISSUE: reference to a compiler-generated field
                          if (this.m_PrefabSecondaryLaneData.HasComponent(secondaryNetLane.m_Lane))
                          {
                            // ISSUE: reference to a compiler-generated field
                            SecondaryLaneData secondaryLaneData = this.m_PrefabSecondaryLaneData[secondaryNetLane.m_Lane];
                            float3_1 = secondaryLaneData.m_PositionOffset;
                            if ((secondaryLaneData.m_Flags & SecondaryLaneDataFlags.FitToParkingSpaces) != (SecondaryLaneDataFlags) 0)
                            {
                              ...
                              bool2 skipStartEnd;
                              // ISSUE: reference to a compiler-generated method
                              this.FitToParkingLane(subLane, curve, prefabRef, out curveBounds, out slotCount, out skipStartEnd);
                              ...
                              {
                                float t = math.lerp(curveBounds.min, curveBounds.max, (float) x3 * num);
                                float2 xz = MathUtils.Tangent(curve.m_Bezier, t).xz;
                                float2 float2_3 = MathUtils.Right(xz);
                                if (MathUtils.TryNormalize(ref float2_3, netLaneData.m_Width * 0.5f))
                                {
                                  float3 float3_2 = MathUtils.Position(curve.m_Bezier, t);
                                  // ISSUE: reference to a compiler-generated method
                                  this.AddCrossingLane(laneBuffer, secondaryNetLane.m_Lane, float3_2 - new float3(float2_3.x, 0.0f, float2_3.y), float3_2 + new float3(float2_3.x, 0.0f, float2_3.y), math.normalizesafe(xz), isOptional);
                                }
                              }
                              continue;
                            }
          ...
          // ISSUE: reference to a compiler-generated field
          for (int index5 = 0; index5 < laneBuffer.m_LaneCorners.Length; ++index5)
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: variable of a compiler-generated type
            SecondaryLaneSystem.LaneCorner laneCorner1 = laneBuffer.m_LaneCorners[index5];
            // ISSUE: object of a compiler-generated type is created
            // ISSUE: variable of a compiler-generated type
            SecondaryLaneSystem.LaneCorner laneCorner2 = new SecondaryLaneSystem.LaneCorner();
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            float num1 = math.distance(laneCorner1.m_StartPosition.xz, laneCorner1.m_EndPosition.xz) * 0.5f;
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            ...
            // ISSUE: reference to a compiler-generated field
            line1.a.xz -= laneCorner1.m_Tangents.xy * num1;
            // ISSUE: reference to a compiler-generated field
            line1.b.xz += laneCorner1.m_Tangents.xy * num1;
            // ISSUE: reference to a compiler-generated field
            line2.a.xz -= laneCorner1.m_Tangents.zw * num1;
            // ISSUE: reference to a compiler-generated field
            line2.b.xz += laneCorner1.m_Tangents.zw * num1;
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            float2 float2_4 = math.select(laneCorner1.m_Width, laneCorner1.m_Width.yx, laneCorner1.m_Inverted);
            // ISSUE: reference to a compiler-generated field
            for (int index6 = 0; index6 < laneBuffer.m_LaneCorners.Length; ++index6)
            {
              // ISSUE: reference to a compiler-generated field
              // ISSUE: variable of a compiler-generated type
              SecondaryLaneSystem.LaneCorner laneCorner3 = laneBuffer.m_LaneCorners[index6];
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              if (((laneCorner1.m_Flags ^ laneCorner3.m_Flags) & (LaneFlags.Utility | LaneFlags.Underground)) == (LaneFlags) 0)
              {
                ...
                if ((laneCorner1.m_Flags & LaneFlags.Utility) == (LaneFlags) 0)
                {
                  ...
                  // ISSUE: reference to a compiler-generated field
                  // ISSUE: reference to a compiler-generated field
                  float2 float2_5 = math.select(laneCorner3.m_Width.yx, laneCorner3.m_Width, laneCorner3.m_Inverted);
                  float2 float2_6 = (float2_4 + float2_5) * 0.25f;
                  float2 float2_7 = float2_6 * float2_6;
                  float t;
                  // ISSUE: reference to a compiler-generated field
                  // ISSUE: reference to a compiler-generated field
                  if ((flag4 ? 0.0 : (double) MathUtils.DistanceSquared(line1, laneCorner3.m_EndPosition, out t)) > (double) float2_7.x || (flag5 ? 0.0 : (double) MathUtils.DistanceSquared(line2, laneCorner3.m_StartPosition, out t)) > (double) float2_7.y)
                    continue;
                }
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                if (!(laneCorner1.m_Lane == laneCorner3.m_Lane))
                {
                  // ISSUE: reference to a compiler-generated field
                  // ISSUE: reference to a compiler-generated field
                  int num3 = (double) math.distancesq(laneCorner1.m_Tangents, laneCorner3.m_Tangents.zwxy) < 0.0099999997764825821 ? 1 : 0;
                  // ISSUE: reference to a compiler-generated field
                  // ISSUE: reference to a compiler-generated field
                  ...
                  if ((num3 | num4) != 0)
                  {
                    ...
                    // ISSUE: reference to a compiler-generated field
                    // ISSUE: reference to a compiler-generated field
                    float num5 = math.max(math.distancesq(laneCorner1.m_StartPosition, laneCorner3.m_EndPosition), math.distancesq(laneCorner1.m_EndPosition, laneCorner3.m_StartPosition));
            ...
            if (!(laneCorner2.m_Lane != Entity.Null) || laneCorner1.m_Duplicates || laneCorner1.m_Lane.Index <= laneCorner2.m_Lane.Index)
            {
              ...
              if (flag2 | flag3)
              {
                int num6 = 0;
                int num7 = 0;
                int num8 = num6 + math.select(0, 1, (secondaryNetLaneFlags9 & SecondaryNetLaneFlags.RequireSafe) != 0) + math.select(0, 2, (secondaryNetLaneFlags9 & SecondaryNetLaneFlags.RequireContinue) != 0);
                int num9 = num7 + math.select(0, 1, (secondaryNetLaneFlags11 & SecondaryNetLaneFlags.RequireSafe) != 0) + math.select(0, 2, (secondaryNetLaneFlags11 & SecondaryNetLaneFlags.RequireContinue) != 0);
                if (num8 != 0 || num9 != 0)
                {
                  // ISSUE: reference to a compiler-generated field
                  flag7 = num8 > num9 ^ laneCorner1.m_Inverted;
                }
                else
                  continue;
              }
              ...
              for (int index7 = 0; index7 < prefabSecondaryLane.Length; ++index7)
              {
                SecondaryNetLane secondaryNetLane1 = prefabSecondaryLane[index7];
                ...
                if (!((secondaryNetLane1.m_Flags & secondaryNetLaneFlags9) != 0 | !math.any(x)) && this.CheckRequirements(ref laneBuffer, secondaryNetLane1.m_Lane))
                {
                  ...
                  if (laneCorner2.m_Lane != Entity.Null)
                  {
                    ...
                    if (laneCorner1.m_Lane.Index <= laneCorner2.m_Lane.Index || (secondaryNetLane1.m_Flags & SecondaryNetLaneFlags.DuplicateSides) != (SecondaryNetLaneFlags) 0)
                    {
                      ...
                      {
                        SecondaryNetLane secondaryNetLane2 = dynamicBuffer[index8];
...
label_102:
                  ...
                  if ((secondaryNetLane1.m_Flags & SecondaryNetLaneFlags.DuplicateSides) != (SecondaryNetLaneFlags) 0)
                  {
                    ...
                    // ISSUE: reference to a compiler-generated field
                    // ISSUE: reference to a compiler-generated method
                    this.CreateSecondaryLane(chunkIndex, ref laneIndex, owner, Entity.Null, laneCorner1.m_Lane, secondaryNetLane1.m_Lane, laneBuffer, (float2) 0.0f, laneCorner1.m_Width, MathUtils.Left(forward1), MathUtils.Left(forward2), isNode, false, !laneCorner1.m_Inverted, false, false, false, isTemp, ownerTemp);
                    break;
                  }
                  // ISSUE: reference to a compiler-generated field
                  if (laneCorner1.m_Inverted ^ flag9)
                  {
                    ...
                    // ISSUE: reference to a compiler-generated field
                    // ISSUE: reference to a compiler-generated method
                    this.CreateSecondaryLane(chunkIndex, ref laneIndex, owner, laneCorner2.m_Lane, laneCorner1.m_Lane, secondaryNetLane1.m_Lane, laneBuffer, laneCorner2.m_Width, laneCorner1.m_Width, MathUtils.Left(forward1), MathUtils.Left(forward2), isNode, flag1 ^ flag9, flag9, flag3, flag2, flag7 ^ flag9, isTemp, ownerTemp);
                    break;
                  }
                  // ISSUE: reference to a compiler-generated field
                  // ISSUE: reference to a compiler-generated field
                  ...
                  // ISSUE: reference to a compiler-generated field
                  // ISSUE: reference to a compiler-generated method
                  this.CreateSecondaryLane(chunkIndex, ref laneIndex, owner, laneCorner1.m_Lane, laneCorner2.m_Lane, secondaryNetLane1.m_Lane, laneBuffer, laneCorner1.m_Width, laneCorner2.m_Width, MathUtils.Left(forward1), MathUtils.Left(forward2), isNode, flag9, flag1 ^ flag9, flag2, flag3, flag7 ^ flag9, isTemp, ownerTemp);
                  break;
                }
              }
            }
          ...
          // ISSUE: reference to a compiler-generated field
          for (int index9 = 0; index9 < laneBuffer.m_CrossingLanes.Length; ++index9)
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: variable of a compiler-generated type
            SecondaryLaneSystem.CrossingLane crossingLane = laneBuffer.m_CrossingLanes[index9];
            // ISSUE: reference to a compiler-generated field
        ...
        out bool2 skipStartEnd)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        if (!this.m_ParkingLaneData.HasComponent(lane))
          return;
        // ISSUE: reference to a compiler-generated field
        ParkingLane parkingLane = this.m_ParkingLaneData[lane];
        ...
        {
          slotCount = (int) math.floor((curve.m_Length + 0.01f) / parkingLaneData.m_SlotInterval);
          float y = (float) slotCount * parkingLaneData.m_SlotInterval / curve.m_Length;
          switch (parkingLane.m_Flags & (ParkingLaneFlags.StartingLane | ParkingLaneFlags.EndingLane))
          {
            case ParkingLaneFlags.StartingLane:
              curveBounds.min = math.max(0.0f, 1f - y);
              break;
            case ParkingLaneFlags.EndingLane:
              curveBounds.max = math.min(1f, y);
              skipStartEnd.x = true;
              break;
            default:
              curveBounds.min = math.max(0.0f, (float) (0.5 - (double) y * 0.5));
              curveBounds.max = math.min(1f, (float) (0.5 + (double) y * 0.5));
              break;
          }
        }
        else
        {
          skipStartEnd.x = (parkingLane.m_Flags & ParkingLaneFlags.StartingLane) == (ParkingLaneFlags) 0;
          skipStartEnd.y = (parkingLane.m_Flags & ParkingLaneFlags.EndingLane) == (ParkingLaneFlags) 0;
        }
      }
        ...
        Temp ownerTemp)
      {
        ...
        if (leftLane != Entity.Null && rightLane != Entity.Null)
        {
          ...
          if ((secondaryLaneData.m_Flags & SecondaryLaneDataFlags.FitToParkingSpaces) != (SecondaryLaneDataFlags) 0)
          {
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated method
            this.FitToParkingLane(leftLane, curve2, this.m_PrefabRefData[leftLane], out curveBounds1, out slotCount2, out skipStartEnd2);
            Bounds1 curveBounds2;
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated method
            this.FitToParkingLane(rightLane, curve3, this.m_PrefabRefData[rightLane], out curveBounds2, out slotCount2, out skipStartEnd2);
            curve2.m_Bezier = MathUtils.Cut(curve2.m_Bezier, curveBounds1);
            curve3.m_Bezier = MathUtils.Cut(curve3.m_Bezier, curveBounds2);
            curve2.m_Length *= curveBounds1.max - curveBounds1.min;
            curve3.m_Length *= curveBounds2.max - curveBounds2.min;
          }
          if (invertLeft)
          {
        ...
        else if (leftLane != Entity.Null)
        {
          ...
          if ((secondaryLaneData.m_Flags & SecondaryLaneDataFlags.FitToParkingSpaces) != (SecondaryLaneDataFlags) 0)
          {
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated method
            this.FitToParkingLane(leftLane, curve2, this.m_PrefabRefData[leftLane], out curveBounds, out slotCount1, out skipStartEnd1);
            curve2.m_Bezier = MathUtils.Cut(curve2.m_Bezier, curveBounds);
            curve2.m_Length *= curveBounds.max - curveBounds.min;
          }
          if (invertLeft)
          {
            curve2.m_Bezier = MathUtils.Invert(curve2.m_Bezier);
        ...
        else if (rightLane != Entity.Null)
        {
          ...
          if ((secondaryLaneData.m_Flags & SecondaryLaneDataFlags.FitToParkingSpaces) != (SecondaryLaneDataFlags) 0)
          {
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated method
            this.FitToParkingLane(rightLane, curve3, this.m_PrefabRefData[rightLane], out curveBounds, out slotCount1, out skipStartEnd1);
            curve3.m_Bezier = MathUtils.Cut(curve3.m_Bezier, curveBounds);
            curve3.m_Length *= curveBounds.max - curveBounds.min;
          }
          if (invertRight)
          {
            curve3.m_Bezier = MathUtils.Invert(curve3.m_Bezier);
