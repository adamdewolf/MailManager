...
namespace Game.Net
{
  ...
  public class SearchSystem : GameSystemBase, IPreDeserialize
  {
    ...
    protected override void OnCreate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.m_AllLanesQuery = this.GetEntityQuery(ComponentType.ReadOnly<LaneGeometry>(), ComponentType.Exclude<Temp>());
      // ISSUE: reference to a compiler-generated field
        ...
        else
        {
          ...
          if (this.m_Loaded || chunk.Has<Created>(ref this.m_CreatedType))
          {
            ...
            if (nativeArray2.Length != 0)
            {
              ...
              // ISSUE: reference to a compiler-generated field
              bool flag = chunk.Has<Marker>(ref this.m_MarkerType);
          ...
          if (this.m_Loaded || chunk.Has<Created>(ref this.m_CreatedType))
          {
            ...
            for (int index = 0; index < nativeArray1.Length; ++index)
            {
              ...
              else
              {
                ...
                // ISSUE: reference to a compiler-generated field
                this.m_SearchTree.Add(entity, new QuadTreeBoundsXZ(bounds3, BoundsMask.Debug, lodLimit));
              }
            }
          }
          else
          {
            ...
            for (int index = 0; index < nativeArray6.Length; ++index)
            {
              ...
              else
              {
                ...
                int lodLimit = RenderingUtils.CalculateLodLimit(RenderingUtils.GetRenderingSize(new float2(1f)));
                // ISSUE: reference to a compiler-generated field
                this.m_SearchTree.Update(entity, new QuadTreeBoundsXZ(bounds6, BoundsMask.Debug, lodLimit));
              }
            }
          }
        }
