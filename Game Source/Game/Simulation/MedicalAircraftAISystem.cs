    ...
    private struct MedicalAircraftTickJob : IJobChunk
    {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index = 0; index < nativeArray1.Length; ++index)
        {
          ...
          // ISSUE: reference to a compiler-generated method
          this.Tick(unfilteredChunkIndex, entity, owner, prefabRef, pathInformation, navigationLanes, passengers, serviceDispatches, ref random, ref ambulance, ref aircraft, ref currentLane, ref pathOwner, ref target);
        ...
        ref Target target)
      {
        ...
        else
        {
          if (VehicleUtils.PathEndReached(currentLane))
          {
            ...
            {
              // ISSUE: reference to a compiler-generated method
              if (this.LoadPatients(jobIndex, entity, passengers, serviceDispatches, ref random, ref ambulance, ref target))
              {
                if ((ambulance.m_State & AmbulanceFlags.Transporting) != (AmbulanceFlags) 0)
                {
                  // ISSUE: reference to a compiler-generated method
          ...
          // ISSUE: reference to a compiler-generated method
          this.FindPathIfNeeded(entity, prefabRef, ref ambulance, ref aircraft, ref currentLane, ref pathOwner, ref target);
        }
      }
