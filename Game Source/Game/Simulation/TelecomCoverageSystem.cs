    ...
    public struct TelecomCoverageJob : IJob
    {
        ...
        DynamicBuffer<CityModifier> cityModifiers)
      {
        ...
        for (int index = 0; index < nativeArray1.Length; ++index)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          TelecomFacilityData result = this.m_PrefabTelecomFacilityData[nativeArray3[index].m_Prefab];
          if (bufferAccessor2.Length != 0)
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            UpgradeUtils.CombineStats<TelecomFacilityData>(ref result, bufferAccessor2[index], ref this.m_PrefabRefData, ref this.m_PrefabTelecomFacilityData);
          }
          // ISSUE: reference to a compiler-generated method
          float efficiencyFactor = this.GetEfficiencyFactor(nativeArray2, nativeArray4, bufferAccessor1, index);
          CityUtils.ApplyModifier(ref result.m_NetworkCapacity, cityModifiers, CityModifierType.TelecomCapacity);
          result.m_Range *= math.sqrt(efficiencyFactor);
          result.m_NetworkCapacity *= efficiencyFactor;
          if ((double) result.m_Range >= 1.0 && (double) result.m_NetworkCapacity >= 1.0)
          {
            int2 min = math.max(CellMapSystem<TelecomCoverage>.GetCell(transform.m_Position - result.m_Range, CellMapSystem<TelecomCoverage>.kMapSize, 128), (int2) 0);
            int2 max = math.min(CellMapSystem<TelecomCoverage>.GetCell(transform.m_Position + result.m_Range, CellMapSystem<TelecomCoverage>.kMapSize, 128) + 1, (int2) 128);
            int2 int2 = max - min;
            if (!math.any(int2 <= 0))
            {
              ...
              float capacity = result.m_NetworkCapacity / math.max(1f, networkUsers);
              // ISSUE: reference to a compiler-generated method
              this.AddNetworkCapacity(facilityData, subArray, min, max, capacity);
              status.m_Capacity += result.m_NetworkCapacity;
        ...
        DynamicBuffer<CityModifier> cityModifiers)
      {
        ...
        for (int index = 0; index < nativeArray1.Length; ++index)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          TelecomFacilityData result = this.m_PrefabTelecomFacilityData[prefabRef.m_Prefab];
          if (bufferAccessor2.Length != 0)
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
          ...
          if ((double) result.m_Range >= 1.0 && (double) result.m_NetworkCapacity >= 1.0)
          {
            ...
            int2 min = math.max(CellMapSystem<TelecomCoverage>.GetCell(position - result.m_Range, CellMapSystem<TelecomCoverage>.kMapSize, 128), (int2) 0);
            int2 max = math.min(CellMapSystem<TelecomCoverage>.GetCell(position + result.m_Range, CellMapSystem<TelecomCoverage>.kMapSize, 128) + 1, (int2) 128);
            int2 int2_1 = max - min;
            if (!math.any(int2_1 <= 0))
            {
              ...
              if (result.m_PenetrateTerrain)
              {
                // ISSUE: reference to a compiler-generated method
                this.CalculateSignalStrength(subArray, min, max, result.m_Range, position);
              }
              else
              {
                // ISSUE: reference to a compiler-generated method
                ...
                // ISSUE: reference to a compiler-generated method
                this.CalculateCellSignalStrength(obstructSlopes, subArray, cell, min, max, result.m_Range, position);
                int2 int2_2 = cell;
                int2 int2_3 = cell + 1;
                while (math.any(int2_2 > min | int2_3 < max))
                {
                  if (int2_2.y > min.y)
                  {
                    ...
                    {
                      // ISSUE: reference to a compiler-generated method
                      this.CalculateCellSignalStrength(obstructSlopes, subArray, new int2(x, int2_2.y), min, max, result.m_Range, position);
                    }
                  ...
                  if (int2_3.y < max.y)
                  {
                    ...
                    {
                      // ISSUE: reference to a compiler-generated method
                      this.CalculateCellSignalStrength(obstructSlopes, subArray, new int2(x, int2_3.y), min, max, result.m_Range, position);
                    }
                    for (int x = cell.x - 1; x >= int2_2.x; --x)
                    {
                      // ISSUE: reference to a compiler-generated method
                  ...
                  if (int2_2.x > min.x)
                  {
                    ...
                    {
                      // ISSUE: reference to a compiler-generated method
                      this.CalculateCellSignalStrength(obstructSlopes, subArray, new int2(int2_2.x, y), min, max, result.m_Range, position);
                    }
                  ...
                  if (int2_3.x < max.x)
                  {
                    ...
                    {
                      // ISSUE: reference to a compiler-generated method
                      this.CalculateCellSignalStrength(obstructSlopes, subArray, new int2(int2_3.x, y), min, max, result.m_Range, position);
                    }
                    for (int y = cell.y - 1; y >= int2_2.y; --y)
                    {
                      // ISSUE: reference to a compiler-generated method
