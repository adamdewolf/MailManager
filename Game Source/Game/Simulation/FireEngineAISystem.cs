    ...
    private struct FireEngineTickJob : IJobChunk
    {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index = 0; index < nativeArray1.Length; ++index)
        {
          ...
          // ISSUE: reference to a compiler-generated method
          this.Tick(unfilteredChunkIndex, entity, owner, transform, prefabRef, pathInformation, navigationLanes, serviceDispatches, isStopped, ref fireEngine, ref car, ref currentLane, ref pathOwner, ref target);
        ...
        ref Target target)
      {
        ...
        {
          // ISSUE: reference to a compiler-generated method
          this.ResetPath(jobIndex, vehicleEntity, pathInformation, serviceDispatches, ref fireEngine, ref car, ref currentLane);
        }
        // ISSUE: reference to a compiler-generated field
        FireEngineData prefabFireEngineData = this.m_PrefabFireEngineData[prefabRef.m_Prefab];
        // ISSUE: reference to a compiler-generated field
        ...
        // ISSUE: reference to a compiler-generated method
        this.FindPathIfNeeded(vehicleEntity, prefabRef, isStopped, ref fireEngine, ref currentLane, ref pathOwner, ref target);
      }
