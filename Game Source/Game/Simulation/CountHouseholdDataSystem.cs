...
namespace Game.Simulation
{
  ...
  public class CountHouseholdDataSystem : GameSystemBase, IDefaultSerializable, ISerializable
  {
    ...
    [DebugWatchDeps]
    private JobHandle m_HouseholdNeedReadDependencies;
    ...
    public void AddHouseholdResourceNeedReader(JobHandle reader)
    {
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      this.m_HouseholdNeedReadDependencies = JobHandle.CombineDependencies(this.m_HouseholdNeedReadDependencies, reader);
    }
    ...
    protected override void OnUpdate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.Dependency = jobData2.Schedule<CountHouseholdDataSystem.ResultJob>(JobHandle.CombineDependencies(this.Dependency, this.m_HouseholdNeedReadDependencies));
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
    ...
    public struct HouseholdData : IAccumulable<CountHouseholdDataSystem.HouseholdData>, ISerializable
    {
      ...
      public int Population() => this.m_MovedInCitizenCount - this.m_HomelessCitizenCount;
        ...
        in v128 chunkEnabledMask)
      {
        ...
        else
        {
          ...
          for (int index1 = 0; index1 < nativeArray1.Length; ++index1)
          {
            ...
            DynamicBuffer<HouseholdCitizen> dynamicBuffer1;
            if ((nativeArray1[index1].m_Flags & HouseholdFlags.MovedIn) == HouseholdFlags.None && propertyEntity == Entity.Null && chunk.Has<PropertySeeker>())
            {
              ...
              // ISSUE: reference to a compiler-generated field
              ref int local = ref householdData.m_MovingInCitizenCount;
              int num = local;
              dynamicBuffer1 = bufferAccessor[index1];
              int length = dynamicBuffer1.Length;
              local = num + length;
              flag3 = false;
              flag4 = false;
            }
            ...
            {
              // ISSUE: reference to a compiler-generated field
              ref int local = ref householdData.m_TouristCitizenCount;
              int num = local;
              dynamicBuffer1 = bufferAccessor[index1];
              int length = dynamicBuffer1.Length;
              local = num + length;
            ...
            if (flag4)
            {
              ...
              DynamicBuffer<HouseholdCitizen> dynamicBuffer2 = bufferAccessor[index1];
              for (int index2 = 0; index2 < dynamicBuffer2.Length; ++index2)
              {
                // ISSUE: reference to a compiler-generated field
                if (CitizenUtils.IsDead(dynamicBuffer2[index2].m_Citizen, ref this.m_HealthProblems))
                {
                  // ISSUE: reference to a compiler-generated field
                ...
                {
                  // ISSUE: reference to a compiler-generated field
                  Citizen citizen = this.m_Citizens[dynamicBuffer2[index2].m_Citizen];
                  ...
                  // ISSUE: reference to a compiler-generated field
                  if (this.m_Students.HasComponent(dynamicBuffer2[index2].m_Citizen))
                  {
                    // ISSUE: reference to a compiler-generated field
                  ...
                  bool flag7 = false;
                  // ISSUE: reference to a compiler-generated field
                  if (this.m_Workers.HasComponent(dynamicBuffer2[index2].m_Citizen))
                  {
                    flag6 = true;
                    // ISSUE: reference to a compiler-generated field
                    // ISSUE: reference to a compiler-generated field
                    flag7 = this.m_OutsideConnections.HasComponent(this.m_Workers[dynamicBuffer2[index2].m_Citizen].m_Workplace);
                    if (!flag7)
                    {
                      // ISSUE: reference to a compiler-generated field
                  ...
                  // ISSUE: reference to a compiler-generated field
                  // ISSUE: reference to a compiler-generated field
                  if (CitizenUtils.IsWorkableCitizen(dynamicBuffer2[index2].m_Citizen, ref this.m_Citizens, ref this.m_Students, ref this.m_HealthProblems))
                  {
                    // ISSUE: reference to a compiler-generated field
                    ++householdData.m_WorkableCitizenCount;
                    // ISSUE: reference to a compiler-generated field
                    if (!flag6 | flag7 || (int) this.m_Workers[dynamicBuffer2[index2].m_Citizen].m_Level < educationLevel)
                    {
                      switch (educationLevel)
                      {
                        case 0:
