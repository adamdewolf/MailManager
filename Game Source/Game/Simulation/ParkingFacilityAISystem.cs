    ...
    private struct ParkingFacilityTickJob : IJobChunk
    {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index = 0; index < nativeArray3.Length; ++index)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          ParkingFacilityData result = this.m_PrefabParkingFacilityData[prefabRef.m_Prefab];
          if (bufferAccessor2.Length != 0)
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            UpgradeUtils.CombineStats<ParkingFacilityData>(ref result, bufferAccessor2[index], ref this.m_PrefabRefData, ref this.m_PrefabParkingFacilityData);
          }
          float efficiency = BuildingUtils.GetEfficiency(bufferAccessor1, index);
          // ISSUE: reference to a compiler-generated method
          this.Tick(unfilteredChunkIndex, entity, ref parkingFacility, result, efficiency);
