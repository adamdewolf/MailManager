    ...
    private struct FireAircraftTickJob : IJobChunk
    {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index = 0; index < nativeArray1.Length; ++index)
        {
          ...
          PrefabRef prefabRefData = nativeArray3[index];
          ...
          // ISSUE: reference to a compiler-generated method
          this.Tick(unfilteredChunkIndex, entity, owner, prefabRefData, pathInformation, navigationLanes, serviceDispatches, ref fireEngine, ref aircraft, ref currentLane, ref pathOwner, ref target);
        ...
        ref Target target)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        FireEngineData prefabFireEngineData = this.m_PrefabFireEngineData[prefabRefData.m_Prefab];
        // ISSUE: reference to a compiler-generated field
        ...
        else if (VehicleUtils.PathEndReached(currentLane))
        {
          ...
          {
            // ISSUE: reference to a compiler-generated method
            this.CheckServiceDispatches(vehicleEntity, serviceDispatches, prefabFireEngineData, ref fireEngine, ref pathOwner);
            // ISSUE: reference to a compiler-generated method
        ...
        if ((double) prefabFireEngineData.m_ExtinguishingCapacity != 0.0 && fireEngine.m_RequestCount <= 1)
        {
        ...
        {
          // ISSUE: reference to a compiler-generated method
          this.TryAddRequests(vehicleEntity, prefabFireEngineData, serviceDispatches, ref fireEngine, ref target);
        }
        // ISSUE: reference to a compiler-generated method
        this.FindPathIfNeeded(vehicleEntity, prefabRefData, ref fireEngine, ref currentLane, ref pathOwner, ref target);
      }
        ...
        ref Target target)
      {
        ...
        setupQueueTarget.m_RoadTypes = RoadTypes.Helicopter;
        ...
        // ISSUE: reference to a compiler-generated field
        VehicleUtils.SetupPathfind(ref currentLaneData, ref pathOwnerData, this.m_PathfindQueue, setupQueueItem);
      }
