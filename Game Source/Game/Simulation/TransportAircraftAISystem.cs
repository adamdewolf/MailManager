    ...
    private struct TransportAircraftTickJob : IJobChunk
    {
        ...
        bool forcedStop)
      {
        ...
        if (!forcedStop)
        {
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          if (flag && (this.m_SimulationFrameIndex < cargoTransport.m_DepartureFrame || this.m_SimulationFrameIndex < publicTransport.m_DepartureFrame))
            return false;
        ...
        ref Target target)
      {
        ...
        Connected connected;
        // ISSUE: reference to a compiler-generated method
        if (this.IsValidBoarding(vehicleEntity, ref target, out connected))
        {
          // ISSUE: reference to a compiler-generated field
          this.m_BoardingData.EndBoarding(vehicleEntity, currentRoute.m_Route, connected.m_Connected, target.m_Target, Entity.Null, Entity.Null);
          return true;
        }
        cargoTransport.m_State &= ~(CargoTransportFlags.Boarding | CargoTransportFlags.Refueling);
        publicTransport.m_State &= ~(PublicTransportFlags.Boarding | PublicTransportFlags.Refueling);
