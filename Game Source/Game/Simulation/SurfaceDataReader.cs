...
namespace Game.Simulation
{
  ...
  internal class SurfaceDataReader
  {
    ...
    private static void CopyWaterValues(
      ...
      int readbackIndex)
    {
      SurfaceDataReader.CopyWaterValues_0000577A\u0024BurstDirectCall.Invoke(ref asyncReadback, ref cpu, ref cpuTemp, ref readers, ref texSize, ref pendingReadback, readbackDistribution, readbackIndex);
    }
    ...
    public delegate void CopyWaterValues_0000577A\u0024PostfixBurstDelegate(
      ref AsyncGPUReadbackRequest asyncReadback,
      ref NativeArray<SurfaceWater> cpu,
      ref NativeArray<float4> cpuTemp,
      ref JobHandle readers,
    ...
    internal static class CopyWaterValues_0000577A\u0024BurstDirectCall
    {
      ...
      {
        if (SurfaceDataReader.CopyWaterValues_0000577A\u0024BurstDirectCall.Pointer == IntPtr.Zero)
        {
          // ISSUE: method reference
          // ISSUE: type reference
          SurfaceDataReader.CopyWaterValues_0000577A\u0024BurstDirectCall.Pointer = (IntPtr) BurstCompiler.GetILPPMethodFunctionPointer2(SurfaceDataReader.CopyWaterValues_0000577A\u0024BurstDirectCall.DeferredCompilation, __methodref (SurfaceDataReader.CopyWaterValues\u0024BurstManaged), __typeref (SurfaceDataReader.CopyWaterValues_0000577A\u0024PostfixBurstDelegate));
        }
        obj0 = SurfaceDataReader.CopyWaterValues_0000577A\u0024BurstDirectCall.Pointer;
      }

      private static IntPtr GetFunctionPointer()
      {
        IntPtr zero = IntPtr.Zero;
        SurfaceDataReader.CopyWaterValues_0000577A\u0024BurstDirectCall.GetFunctionPointerDiscard(ref zero);
        return zero;
      }
      ...
      {
        // ISSUE: method reference
        SurfaceDataReader.CopyWaterValues_0000577A\u0024BurstDirectCall.DeferredCompilation = BurstCompiler.CompileILPPMethod2(__methodref (SurfaceDataReader.CopyWaterValues));
      }
      ...
      static CopyWaterValues_0000577A\u0024BurstDirectCall()
      {
        SurfaceDataReader.CopyWaterValues_0000577A\u0024BurstDirectCall.Constructor();
      }
        ...
        int readbackIndex)
      {
        ...
        {
          IntPtr functionPointer = SurfaceDataReader.CopyWaterValues_0000577A\u0024BurstDirectCall.GetFunctionPointer();
