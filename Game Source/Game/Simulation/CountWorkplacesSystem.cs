...
namespace Game.Simulation
{
  ...
  public class CountWorkplacesSystem : GameSystemBase, IDefaultSerializable, ISerializable
  {
    ...
    [DebugWatchValue]
    private NativeArray<int> DebugWatchFreeWorkplaces()
    {
      NativeArray<int> array = new NativeArray<int>(5, Allocator.Temp);
      // ISSUE: reference to a compiler-generated field
      this.m_LastFreeWorkplaces.ToArray(array);
      return array;
    }

    [DebugWatchValue]
    private NativeArray<int> DebugWatchTotalWorkplaces()
    {
      NativeArray<int> array = new NativeArray<int>(5, Allocator.Temp);
      // ISSUE: reference to a compiler-generated field
      this.m_LastTotalWorkplaces.ToArray(array);
      return array;
    }
