    ...
    private struct PostVanTickJob : IJobChunk
    {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index = 0; index < nativeArray1.Length; ++index)
        {
          ...
          // ISSUE: reference to a compiler-generated method
          this.Tick(unfilteredChunkIndex, entity, owner, prefabRef, pathInformation, navigationLanes, serviceDispatches, ref postVan, ref car, ref currentLane, ref pathOwner, ref target);
        ...
        ref Target target)
      {
        ...
        {
          // ISSUE: reference to a compiler-generated method
          this.ResetPath(jobIndex, vehicleEntity, pathInformation, serviceDispatches, prefabPostVanData, ref postVan, ref car, ref currentLane);
        }
        // ISSUE: reference to a compiler-generated field
