  ...
  public class MaintenanceVehicleDispatchSystem : GameSystemBase
  {
    ...
    private struct MaintenanceVehicleDispatchJob : IJobChunk
    {
      ...
      private bool ValidateReversed(Entity entity, Entity source)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        if (!this.m_MaintenanceVehicleData.TryGetComponent(source, out componentData2) || (componentData2.m_State & (MaintenanceVehicleFlags.EstimatedFull | MaintenanceVehicleFlags.Disabled)) != (MaintenanceVehicleFlags) 0 || componentData2.m_RequestCount > 1)
          return false;
      ...
      private void DispatchVehicle(int jobIndex, Entity entity, PathInformation pathInformation)
      {
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        MaintenanceVehicleDispatchSystem.VehicleDispatch vehicleDispatch = new MaintenanceVehicleDispatchSystem.VehicleDispatch(entity, pathInformation.m_Origin);
        // ISSUE: reference to a compiler-generated field
        this.m_VehicleDispatches.Enqueue(vehicleDispatch);
        // ISSUE: reference to a compiler-generated field
