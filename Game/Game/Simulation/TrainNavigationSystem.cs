        ...
        for (int index = 0; index < 10000; ++index)
        {
          ...
          if (index >= navigationLanes.Length)
          {
            ...
            if (this.m_TrackLaneData.HasComponent(elem.m_Lane))
            {
              ...
              else if ((pathElement.m_Flags & PathElementFlags.Return) != (PathElementFlags) 0)
                elem.m_Flags |= TrainLaneFlags.Return;
              else if ((trackLane.m_Flags & (TrackLaneFlags.Twoway | TrackLaneFlags.Switch | TrackLaneFlags.DiamondCrossing | TrackLaneFlags.CrossingTraffic)) != (TrackLaneFlags) 0 && (trackLane.m_Flags & TrackLaneFlags.MergingTraffic) == (TrackLaneFlags) 0 || (pathElement.m_Flags & PathElementFlags.Reverse) != (PathElementFlags) 0)
            ...
            else
            {
              ...
              {
                // ISSUE: reference to a compiler-generated field
                if (this.m_PrefabRefData.HasComponent(elem.m_Lane))
                {
                  if (pathOwner.m_ElementIndex >= pathElements.Length)
                  {
          ...
          else
          {
            ...
            // ISSUE: reference to a compiler-generated field
            if (!this.m_LaneData.HasComponent(elem.m_Lane))
            {
              ++invalidPath;
              break;
            }
          }
          if ((elem.m_Flags & (TrainLaneFlags.EndOfPath | TrainLaneFlags.Return)) != (TrainLaneFlags) 0 || (elem.m_Flags & (TrainLaneFlags.Reserved | TrainLaneFlags.KeepClear | TrainLaneFlags.Connection)) == (TrainLaneFlags) 0)
            break;
        }
      }
        ...
        else
        {
          ...
          if (num2 == 0)
          {
            for (int index = 0; index < navigationLanes.Length; ++index)
            {
              ...
              {
                while ((navigationLane.m_Flags & TrainLaneFlags.BlockReserve) == (TrainLaneFlags) 0 && ++index < navigationLanes.Length)
...
label_48:
          ...
          while (true)
          {
            ...
            if (!flag4 || !this.MoveTarget(pivot1, ref navigation.m_Front, num7, curve.m_Bezier, ref currentLane.m_Front.m_CurvePosition))
            {
              if (navigationLanes.Length != 0)
              {
                ...
                // ISSUE: reference to a compiler-generated field
                if ((navigationLane.m_Flags & (TrainLaneFlags.Reserved | TrainLaneFlags.Connection)) != (TrainLaneFlags) 0 && this.m_PrefabRefData.HasComponent(navigationLane.m_Lane))
                {
          ...
          if (flag2 && (double) navigation.m_Speed < 0.10000000149011612 && (double) num1 < 0.10000000149011612)
          {
            ...
            {
              TrainNavigationLane navigationLane = navigationLanes[navigationLanes.Length - 1];
              currentLane.m_Front.m_LaneFlags |= navigationLane.m_Flags & (TrainLaneFlags.EndOfPath | TrainLaneFlags.Return);
              navigationLanes.Clear();
              goto label_72;
            }
            else
...
label_72:
          ...
          // ISSUE: reference to a compiler-generated method
          this.UpdateFollowerBogie(ref currentLane.m_Rear, ref currentLane.m_RearCache, ref navigation.m_Rear, ref tempCache, ref currentLane.m_FrontCache, currentLane.m_Front, position, followDistance1);
          if (layout.Length == 1)
          {
          ...
          for (int index = 1; index < layout.Length; ++index)
          {
            ...
            // ISSUE: reference to a compiler-generated method
            this.UpdateFollowerBogie(ref currentLaneData.m_Front, ref currentLaneData.m_FrontCache, ref trainNavigation.m_Front, ref tempCache, ref trainCurrentLane1.m_RearCache, trainCurrentLane1.m_Rear, position, followDistance2);
            ...
            // ISSUE: reference to a compiler-generated method
            this.UpdateFollowerBogie(ref currentLaneData.m_Rear, ref currentLaneData.m_RearCache, ref trainNavigation.m_Rear, ref tempCache, ref currentLaneData.m_FrontCache, currentLaneData.m_Front, position, followDistance1);
            if (index == 1)
            {
