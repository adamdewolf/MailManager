    ...
    private struct PostFacilityTickJob : IJobChunk
    {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index = 0; index < nativeArray1.Length; ++index)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          PostFacilityData result = this.m_PrefabPostFacilityData[prefabRef.m_Prefab];
          MailBoxData prefabMailBoxData = new MailBoxData();
          if (bufferAccessor2.Length != 0)
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            UpgradeUtils.CombineStats<PostFacilityData>(ref result, bufferAccessor2[index], ref this.m_PrefabRefData, ref this.m_PrefabPostFacilityData);
          }
          ...
          // ISSUE: reference to a compiler-generated method
          this.Tick(unfilteredChunkIndex, entity, ref postFacility, ref mailBox, result, prefabMailBoxData, ownedVehicles, guestVehicles, dispatches, resources, efficiency, immediateEfficiency);
        ...
        float immediateEfficiency)
      {
              ...
              if ((componentData2.m_State & DeliveryTruckFlags.DummyTraffic) == (DeliveryTruckFlags) 0)
              {
                ...
                if (this.m_LayoutElements.TryGetBuffer(vehicle1, out bufferData) && bufferData.Length != 0)
                {
                  for (int index2 = 0; index2 < bufferData.Length; ++index2)
                  {
                    ...
                    // ISSUE: reference to a compiler-generated field
                    if (this.m_DeliveryTruckData.TryGetComponent(vehicle2, out componentData3))
                    {
                      if ((componentData2.m_State & DeliveryTruckFlags.Buying) != (DeliveryTruckFlags) 0)
                      {
                      ...
                      ReturnLoad componentData4;
                      // ISSUE: reference to a compiler-generated field
                      if (this.m_ReturnLoadData.TryGetComponent(vehicle2, out componentData4))
                      {
                ...
                else
                {
                  if ((componentData2.m_State & DeliveryTruckFlags.Buying) != (DeliveryTruckFlags) 0)
                  {
                    if ((componentData2.m_Resource & Resource.UnsortedMail) != Resource.NoResource)
                      num1 += componentData2.m_Amount;
                    else if ((componentData2.m_Resource & Resource.LocalMail) != Resource.NoResource)
                      num2 += componentData2.m_Amount;
                  }
                  ReturnLoad componentData5;
                  // ISSUE: reference to a compiler-generated field
                  if (this.m_ReturnLoadData.TryGetComponent(vehicle1, out componentData5))
                  {
        ...
        for (int index3 = 0; index3 < guestVehicles.Length; ++index3)
        {
          ...
          {
            Game.Vehicles.DeliveryTruck componentData6;
            // ISSUE: reference to a compiler-generated field
            if (this.m_DeliveryTruckData.TryGetComponent(vehicle3, out componentData6) && (componentData6.m_State & DeliveryTruckFlags.DummyTraffic) == (DeliveryTruckFlags) 0)
            {
              DynamicBuffer<LayoutElement> bufferData;
              // ISSUE: reference to a compiler-generated field
              if (this.m_LayoutElements.TryGetBuffer(vehicle3, out bufferData) && bufferData.Length != 0)
              {
                for (int index4 = 0; index4 < bufferData.Length; ++index4)
                {
                  ...
                  // ISSUE: reference to a compiler-generated field
                  if (this.m_DeliveryTruckData.TryGetComponent(vehicle4, out componentData7))
                  {
                    if ((componentData6.m_State & DeliveryTruckFlags.Buying) != (DeliveryTruckFlags) 0)
                    {
                    ...
                    ReturnLoad componentData8;
                    // ISSUE: reference to a compiler-generated field
                    if (this.m_ReturnLoadData.TryGetComponent(vehicle4, out componentData8))
                    {
              ...
              else
              {
                if ((componentData6.m_State & DeliveryTruckFlags.Buying) != (DeliveryTruckFlags) 0)
                {
                  if ((componentData6.m_Resource & Resource.UnsortedMail) != Resource.NoResource)
                    ...
                    num4 += componentData6.m_Amount;
                  else if ((componentData6.m_Resource & Resource.OutgoingMail) != Resource.NoResource)
                    num5 += componentData6.m_Amount;
                }
                else if ((componentData6.m_Resource & Resource.UnsortedMail) != Resource.NoResource)
                  num1 += componentData6.m_Amount;
                else if ((componentData6.m_Resource & Resource.LocalMail) != Resource.NoResource)
                  num2 += componentData6.m_Amount;
                ReturnLoad componentData9;
                // ISSUE: reference to a compiler-generated field
                if (this.m_ReturnLoadData.TryGetComponent(vehicle3, out componentData9))
                {
        ...
        if (prefabPostFacilityData.m_SortingRate != 0)
        {
          ...
          for (int index = 0; index < dispatches.Length; ++index)
          {
            ...
            {
              // ISSUE: reference to a compiler-generated method
              this.TrySpawnPostVan(jobIndex, ref random, entity, request, resources, ref postFacility, ref vehicleCapacity1, ref localMail, ref freeSpace);
        ...
        if ((postFacility.m_Flags & (PostFacilityFlags.CanDeliverMailWithVan | PostFacilityFlags.CanCollectMailWithVan)) == (PostFacilityFlags) 0)
          return;
        // ISSUE: reference to a compiler-generated method
        this.RequestTargetIfNeeded(jobIndex, entity, ref postFacility, vehicleCapacity1);
      }
        ...
        ref int freeSpace)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        if (!this.m_PrefabRefData.HasComponent(postVanRequest.m_Target) || localMail <= 0 && (postVanRequest.m_Flags & PostVanRequestFlags.Deliver) != (PostVanRequestFlags) 0)
          return false;
        // ISSUE: reference to a compiler-generated field
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        Entity vehicle = this.m_PostVanSelectData.CreateVehicle(this.m_CommandBuffer, jobIndex, ref random, this.m_TransformData[entity], entity, vehiclePrefab);
        ...
        PostVanFlags flags = (PostVanFlags) 0;
        ...
        if ((postVanRequest.m_Flags & PostVanRequestFlags.Collect) != (PostVanRequestFlags) 0)
          flags |= PostVanFlags.Collecting;
        // ISSUE: reference to a compiler-generated field
        this.m_CommandBuffer.SetComponent<Game.Vehicles.PostVan>(jobIndex, vehicle, new Game.Vehicles.PostVan(flags, 1, deliveringMail));
        // ISSUE: reference to a compiler-generated field
        this.m_CommandBuffer.SetComponent<Game.Common.Target>(jobIndex, vehicle, new Game.Common.Target(postVanRequest.m_Target));
        // ISSUE: reference to a compiler-generated field
        ...
        if (this.m_ServiceRequestData.HasComponent(postFacility.m_TargetRequest))
        {
          ...
          // ISSUE: reference to a compiler-generated field
          this.m_CommandBuffer.SetComponent<HandleRequest>(jobIndex, entity2, new HandleRequest(postFacility.m_TargetRequest, Entity.Null, true));
        }
        return true;
      }
