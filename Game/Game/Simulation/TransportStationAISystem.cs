    ...
    private struct TransportStationTickJob : IJobChunk
    {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index = 0; index < nativeArray2.Length; ++index)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          TransportStationData result = this.m_PrefabTransportStationData[prefabRef.m_Prefab];
          if (bufferAccessor2.Length != 0)
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            UpgradeUtils.CombineStats<TransportStationData>(ref result, bufferAccessor2[index], ref this.m_PrefabRefData, ref this.m_PrefabTransportStationData);
          }
          float efficiency = BuildingUtils.GetEfficiency(bufferAccessor1, index);
          // ISSUE: reference to a compiler-generated method
          this.Tick(prefabRef, ref transportStation, result, efficiency);
