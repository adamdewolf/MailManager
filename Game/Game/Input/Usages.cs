...
namespace Game.Input
{
  public struct Usages : IEnumerable<int>, IEnumerable, IEquatable<Usages>
  {
    ...
    public const string kDefaultUsage = "Default";
    ...
    public static Usages defaultUsages { get; } = new Usages(true, new string[4]
    {
      "Default",
      "Overlay",
      "Tool",
      ...
      : this(0, false)
    {
      ...
      this["Default"] = (usages & BuiltInUsages.Default) != 0;
