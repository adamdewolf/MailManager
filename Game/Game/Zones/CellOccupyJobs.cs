    ...
    public struct ZoneAndOccupyCellsJob : IJobParallelForDefer
    {
        ...
        IUnsafeQuadTreeIterator<Entity, QuadTreeBoundsXZ>
      {
        ...
        public void Iterate(QuadTreeBoundsXZ bounds, Entity objectEntity)
        {
          ...
          {
            if (this.m_PrefabSignatureBuildingData.HasComponent(prefabRef.m_Prefab))
            {
              ...
              if (this.m_PrefabZoneData.HasComponent(spawnableBuildingData.m_ZonePrefab))
                this.m_OverrideZone = this.m_PrefabZoneData[spawnableBuildingData.m_ZonePrefab].m_ZoneType;
            }
          }
          else if (this.m_PrefabPlaceholderBuildingData.HasComponent(prefabRef.m_Prefab))
          {
            PlaceholderBuildingData placeholderBuildingData = this.m_PrefabPlaceholderBuildingData[prefabRef.m_Prefab];
            if (this.m_PrefabZoneData.HasComponent(placeholderBuildingData.m_ZonePrefab))
              this.m_OverrideZone = this.m_PrefabZoneData[placeholderBuildingData.m_ZonePrefab].m_ZoneType;
          }
