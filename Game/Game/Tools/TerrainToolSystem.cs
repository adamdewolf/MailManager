...
namespace Game.Tools
{
  ...
  public class TerrainToolSystem : ToolBaseSystem
  {
    ...
    private UIInputAction.State m_EraseMaterial;
    private UIInputAction.State m_EraseResource;
    private UIInputAction.State m_FastSoften;
    private UIInputAction.State m_LevelTerrain;
    private UIInputAction.State m_LowerTerrain;
    private UIInputAction.State m_PaintMaterial;
    private UIInputAction.State m_PaintResource;
    private UIInputAction.State m_RaiseTerrain;
    private UIInputAction.State m_SetLevelTarget;
    private UIInputAction.State m_SetSlopeTarget;
    private UIInputAction.State m_SlopeTerrain;
    private UIInputAction.State m_SoftenTerrain;
    ...
    private protected override void SetActions()
    {
      ...
      this.secondaryApplyAction.enabled = true;
      // ISSUE: reference to a compiler-generated method
      this.UpdateActions();
    }
    ...
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
      ...
      if ((Object) this.prefab != (Object) null && (Object) this.brushType != (Object) null && this.m_HasFocus)
      {
        ...
        if ((this.m_ToolRaycastSystem.raycastFlags & (RaycastFlags.DebugDisable | RaycastFlags.UIDisable)) == (RaycastFlags) 0)
        {
          ...
          if (this.m_State != TerrainToolSystem.State.Default)
          {
            ...
            // ISSUE: reference to a compiler-generated method
            // ISSUE: reference to a compiler-generated method
            return this.secondaryApplyAction.action.WasPressedThisFrame() || this.secondaryApplyAction.action.WasReleasedThisFrame() ? this.Cancel(inputDeps) : this.Update(inputDeps);
          }
          if (this.secondaryApplyAction.action.WasPressedThisFrame())
          {
            // ISSUE: reference to a compiler-generated method
          ...
          // ISSUE: reference to a compiler-generated method
          // ISSUE: reference to a compiler-generated method
          return this.applyAction.action.WasPressedThisFrame() ? this.Apply(inputDeps, this.applyAction.action.WasReleasedThisFrame()) : this.Update(inputDeps);
        }
      }
      else
      {
      ...
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      if (this.m_State != TerrainToolSystem.State.Default && (this.applyAction.action.WasReleasedThisFrame() || this.secondaryApplyAction.action.WasReleasedThisFrame() || !this.m_HasFocus))
      {
        // ISSUE: reference to a compiler-generated field
        this.m_StartPoint = new ControlPoint();
        // ISSUE: reference to a compiler-generated field
