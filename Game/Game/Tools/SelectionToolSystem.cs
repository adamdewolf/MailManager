...
namespace Game.Tools
{
  ...
  public class SelectionToolSystem : ToolBaseSystem
  {
    ...
    private UIInputAction.State m_SelectArea;
    private UIInputAction.State m_DeselectArea;
    ...
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
      ...
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated method
      if (this.selectionType == SelectionType.MapTiles && this.m_MapTilePurchaseSystem.GetAvailableTiles() == 0)
      {
      ...
      // ISSUE: reference to a compiler-generated field
      if (this.m_State != SelectionToolSystem.State.Default && !this.applyAction.enabled)
      {
        // ISSUE: reference to a compiler-generated field
        this.m_State = SelectionToolSystem.State.Default;
      }
      ...
      {
        // ISSUE: reference to a compiler-generated field
        if (this.m_State != SelectionToolSystem.State.Default)
        {
      ...
      // ISSUE: reference to a compiler-generated field
      if (this.m_State != SelectionToolSystem.State.Default && (this.applyAction.action.WasReleasedThisFrame() || this.secondaryApplyAction.action.WasReleasedThisFrame()))
      {
        // ISSUE: reference to a compiler-generated field
        this.m_StartPoint = new ControlPoint();
        // ISSUE: reference to a compiler-generated field
