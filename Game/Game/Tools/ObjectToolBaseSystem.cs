    ...
    private struct CreateDefinitionsJob : IJob
    {
      ...
      public void Execute()
      {
        ...
        if (this.m_ObjectPrefab != Entity.Null)
        {
          ...
          else
          {
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            if (entity2 == Entity.Null && ownerDefinition.m_Prefab == Entity.Null && this.m_PrefabPlaceholderElements.TryGetBuffer(this.m_ObjectPrefab, out bufferData4) && !this.m_PrefabCreatureSpawnData.HasComponent(this.m_ObjectPrefab))
            {
              // ISSUE: reference to a compiler-generated field
        ...
        int parentMesh)
      {
        ...
        else
        {
          ...
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          if (this.m_PrefabPlaceableObjectData.HasComponent(this.m_ObjectPrefab))
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            placeableObjectData = this.m_PrefabPlaceableObjectData[this.m_ObjectPrefab];
          }
              ...
              for (int x1 = int4_1.x; x1 <= int4_1.z; ++x1)
              {
                ...
                switch (index1)
                {
                  ...
                  default:
                    ...
                    float elevation;
                    // ISSUE: reference to a compiler-generated method
                    Game.Objects.Transform transform = this.SampleTransform(placeableObjectData, new float3()
                    {
                      xz = math.lerp(bounds2_2.min, bounds2_2.max, float4_1.yz)
                    }, float4_1.w, out elevation);
        ...
        out float elevation)
      {
        ...
        transform.m_Rotation = quaternion.RotateY(rotation);
        // ISSUE: reference to a compiler-generated field
