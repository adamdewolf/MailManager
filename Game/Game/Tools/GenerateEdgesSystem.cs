  ...
  public class GenerateEdgesSystem : GameSystemBase
  {
    ...
    private struct GenerateEdgesJob : IJobChunk
    {
        ...
        if (nativeArray1.Length != 0)
        {
          ...
          for (int index = 0; index < nativeArray1.Length; ++index)
          {
            ...
            if (!this.m_DeletedData.HasComponent(definitionData.m_Owner))
            {
              ...
              LocalCurveCache cachedCurve = new LocalCurveCache();
              if (nativeArray2.Length != 0)
                ownerData = nativeArray2[index];
              if (nativeArray5.Length != 0)
                upgraded = nativeArray5[index];
              if (nativeArray4.Length != 0)
                cachedCurve = nativeArray4[index];
              // ISSUE: reference to a compiler-generated method
              this.GenerateEdge(unfilteredChunkIndex, chunkBaseEntityIndex + index, definitionData, ownerData, course, upgraded, cachedCurve, nativeArray4.Length != 0);
            }
          }
        }
        else
      ...
      private void SplitEdge(int jobIndex, Entity edge, Entity middleNode)
      {
        ...
        {
          // ISSUE: reference to a compiler-generated method
          this.CreateTempEdge(jobIndex, edge1, curveData1, componentData3, componentData4, componentData5, componentData2, componentData6, condition1, addTramTrack, addNative, addElectricityConnection, component, road1, pseudoRandomSeed1, prefabRef, componentData1, buildOrderData1, editorContainer, connectedNode);
        }
        if (!(edge2.m_End != Entity.Null))
          return;
        // ISSUE: reference to a compiler-generated method
        this.CreateTempEdge(jobIndex, edge2, curveData2, componentData3, componentData4, componentData5, componentData2, componentData6, condition2, addTramTrack, addNative, addElectricityConnection, component, road2, pseudoRandomSeed2, prefabRef, componentData1, buildOrderData2, editorContainer, connectedNode);
      }
...
label_6:
        ...
        if (definitionData.m_Original != Entity.Null)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          if ((definitionData.m_Flags & CreationFlags.Upgrade) == (CreationFlags) 0 && this.m_UpgradedData.HasComponent(definitionData.m_Original))
          {
            // ISSUE: reference to a compiler-generated field
            upgraded = this.m_UpgradedData[definitionData.m_Original];
        ...
        // ISSUE: reference to a compiler-generated method
        bool flag3 = !isPermanent && this.TryGetOldEntity(edge, prefabRef.m_Prefab, definitionData.m_SubPrefab, definitionData.m_Original, ref ownerData, ref definitionData.m_Owner, out oldEntity);
        if (flag3)
        {
          // ISSUE: reference to a compiler-generated field
          this.m_CommandBuffer.RemoveComponent<Deleted>(jobIndex, oldEntity);
        ...
        {
          // ISSUE: reference to a compiler-generated field
          if (flag3 && this.m_ElevationData.HasComponent(oldEntity))
          {
            // ISSUE: reference to a compiler-generated field
        ...
        {
          // ISSUE: reference to a compiler-generated field
          if (flag3 && this.m_UpgradedData.HasComponent(oldEntity))
          {
            // ISSUE: reference to a compiler-generated field
        ...
        if (this.m_PrefabRoadData.HasComponent(prefabRef.m_Prefab))
        {
          ...
          {
            // ISSUE: reference to a compiler-generated field
            if (flag3 && this.m_TramTrackData.HasComponent(oldEntity))
            {
              // ISSUE: reference to a compiler-generated field
        ...
        {
          // ISSUE: reference to a compiler-generated field
          if (flag3 && this.m_NativeData.HasComponent(oldEntity))
          {
            // ISSUE: reference to a compiler-generated field
        ...
        bool isStandalone = flag4 | (netGeometryData.m_Flags & GeometryFlags.SubOwner) != 0;
        if (isStandalone)
          temp.m_Flags |= TempFlags.Essential;
        ...
        {
          // ISSUE: reference to a compiler-generated field
          if (flag3 && this.m_FixedData.HasComponent(oldEntity))
          {
            // ISSUE: reference to a compiler-generated field
        ...
        {
          // ISSUE: reference to a compiler-generated field
          bool flag5 = NetCompositionHelpers.TestEdgeFlags(this.m_PrefabElectricityConnectionData[prefabRef.m_Prefab], upgraded.m_Flags);
          if (flag5)
          {
            // ISSUE: reference to a compiler-generated field
            this.m_CommandBuffer.AddComponent<Game.Net.ElectricityConnection>(jobIndex, oldEntity, new Game.Net.ElectricityConnection());
          ...
          {
            // ISSUE: reference to a compiler-generated field
            if (flag3 && this.m_ElectricityConnectionData.HasComponent(oldEntity))
            {
              // ISSUE: reference to a compiler-generated field
          ...
          {
            // ISSUE: reference to a compiler-generated field
            bool flag6 = this.m_ElectricityConnectionData.HasComponent(definitionData.m_Original);
            if (flag5 != flag6)
            {
              temp.m_Flags &= ~TempFlags.Upgrade;
        ...
        if (definitionData.m_Original != Entity.Null && originalPrefabRef.m_Prefab != prefabRef.m_Prefab)
        {
          ...
          {
            // ISSUE: reference to a compiler-generated field
            flag7 = (this.m_PrefabRoadData[originalPrefabRef.m_Prefab].m_Flags & Game.Prefabs.RoadFlags.EnableZoning) != 0;
          }
          if (isZoneable != flag7)
          {
            temp.m_Flags &= ~TempFlags.Modify;
