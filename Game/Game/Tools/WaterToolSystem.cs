  ...
  public class WaterToolSystem : ToolBaseSystem
  {
    ...
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
      ...
      if (this.m_State != WaterToolSystem.State.Default)
      {
        ...
        // ISSUE: reference to a compiler-generated method
        // ISSUE: reference to a compiler-generated method
        return this.m_SecondaryApplyAction.WasPressedThisFrame() || this.m_SecondaryApplyAction.WasReleasedThisFrame() ? this.Cancel(inputDeps) : this.Update(inputDeps);
      }
      // ISSUE: reference to a compiler-generated field
      if (this.m_SecondaryApplyAction.WasPressedThisFrame())
      {
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated method
      ...
      // ISSUE: reference to a compiler-generated method
      // ISSUE: reference to a compiler-generated method
      return this.m_ApplyAction.WasPressedThisFrame() ? this.Apply(inputDeps, this.m_ApplyAction.WasReleasedThisFrame()) : this.Update(inputDeps);
    }
