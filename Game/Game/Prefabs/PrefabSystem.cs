...
namespace Game.Prefabs
{
  ...
  public class PrefabSystem : GameSystemBase, IDefaultSerializable, ISerializable
  {
    ...
    protected override void OnCreate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.m_UpdateMap = new Dictionary<PrefabBase, Entity>();
      // ISSUE: reference to a compiler-generated field
      this.m_Entities = new Dictionary<PrefabBase, Entity>();
      // ISSUE: reference to a compiler-generated field
      this.m_IsUnlockable = new Dictionary<PrefabBase, bool>();
      // ISSUE: reference to a compiler-generated field
      this.m_IsAvailable = new Dictionary<ContentPrefab, bool>();
      // ISSUE: reference to a compiler-generated field
      this.m_LoadedObsoleteIDs = new Dictionary<int, PrefabID>();
      // ISSUE: reference to a compiler-generated field
      this.m_PrefabIndices = new Dictionary<PrefabID, int>();
      // ISSUE: reference to a compiler-generated field
