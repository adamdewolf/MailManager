...
namespace Game.Prefabs.Effects
{
  ...
  public class LightEffect : ComponentBase
  {
    ...
    public static event LightEffect.LightUnitChangedEventHandler OnLightUnitChanged;
    ...
    public delegate void LightUnitChangedEventHandler(Game.Rendering.LightUnit oldUnit, Game.Rendering.LightUnit newUnit);
