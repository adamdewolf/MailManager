...
namespace Game.Net
{
  ...
  public class CompositionSelectSystem : GameSystemBase
  {
    ...
    private struct SelectCompositionJob : IJobChunk
    {
        ...
        ref CompositionFlags obsoleteEdgeFlags)
      {
        ...
        while (edgeIterator.GetNext(out edgeIteratorValue))
        {
          ...
          {
            bool flag8 = edgeIteratorValue.m_Edge == leftEdge;
            bool flag9 = edgeIteratorValue.m_Edge == rightEdge;
            // ISSUE: reference to a compiler-generated field
            ...
            {
              // ISSUE: reference to a compiler-generated method
              nodeFlags |= this.GetNodeStates(bufferData1, compositionFlags1, edgeFlags1, flag8, flag9);
            }
            if (bufferData2.IsCreated && bufferData2.Length != 0)
            {
              // ISSUE: reference to a compiler-generated method
              nodeFlags |= NetCompositionHelpers.InvertCompositionFlags(this.GetNodeStates(bufferData2, edgeFlags1, compositionFlags1, flag9, flag8));
            }
        ...
        bool flag10 = flag1 & num1 == 1;
        bool flag11 = flag2 & num1 >= 1;
        bool flag12 = flag5 & flag11;
        if ((nodeFlags.m_General & (CompositionFlags.General.Elevated | CompositionFlags.General.Tunnel)) != (CompositionFlags.General) 0)
        {
          ...
          bool flag13 = (nodeFlags.m_Right & (CompositionFlags.Side.LowTransition | CompositionFlags.Side.HighTransition)) > (CompositionFlags.Side) 0;
          if ((num2 & (!flag13 ? 1 : 0)) != 0)
            nodeFlags.m_Right |= CompositionFlags.Side.LowTransition;
          if (num2 == 0 & flag13)
            nodeFlags.m_Left |= CompositionFlags.Side.LowTransition;
        }
        if (num1 >= 2)
        {
          ...
          if ((nodeFlags.m_Left & nodeFlags.m_Right & CompositionFlags.Side.Sidewalk) > (CompositionFlags.Side) 0 | flag11)
        ...
        if (num1 != 0)
        {
          if (((compositionFlags1.m_Left | compositionFlags1.m_Right) & CompositionFlags.Side.Sidewalk) != (CompositionFlags.Side) 0 && (compositionFlags1.m_General & CompositionFlags.General.MiddlePlatform) != (CompositionFlags.General) 0)
            nodeFlags.m_General |= CompositionFlags.General.Crosswalk;
          if ((nodeFlags.m_General & CompositionFlags.General.Intersection) == (CompositionFlags.General) 0)
          {
            if ((nodeFlags.m_General & CompositionFlags.General.Crosswalk) != (CompositionFlags.General) 0)
            {
              if ((nodeFlags.m_General & CompositionFlags.General.Invert) != (CompositionFlags.General) 0)
              {
                if ((compositionFlags1.m_Left & CompositionFlags.Side.AddCrosswalk) > (CompositionFlags.Side) 0 | flag7)
                  obsoleteEdgeFlags.m_Left |= compositionFlags1.m_Left & (CompositionFlags.Side.AddCrosswalk | CompositionFlags.Side.RemoveCrosswalk);
                else if ((compositionFlags1.m_Left & CompositionFlags.Side.RemoveCrosswalk) > (CompositionFlags.Side) 0 | flag6)
                {
                  nodeFlags.m_General &= ~CompositionFlags.General.Crosswalk;
                  flag12 = false;
                }
              }
              else if ((compositionFlags1.m_Right & CompositionFlags.Side.AddCrosswalk) > (CompositionFlags.Side) 0 | flag7)
                obsoleteEdgeFlags.m_Right |= compositionFlags1.m_Right & (CompositionFlags.Side.AddCrosswalk | CompositionFlags.Side.RemoveCrosswalk);
              else if ((compositionFlags1.m_Right & CompositionFlags.Side.RemoveCrosswalk) > (CompositionFlags.Side) 0 | flag6)
              {
                nodeFlags.m_General &= ~CompositionFlags.General.Crosswalk;
                flag12 = false;
              }
            ...
            {
              if ((compositionFlags1.m_Left & CompositionFlags.Side.RemoveCrosswalk) > (CompositionFlags.Side) 0 | flag6)
                obsoleteEdgeFlags.m_Left |= compositionFlags1.m_Left & (CompositionFlags.Side.AddCrosswalk | CompositionFlags.Side.RemoveCrosswalk);
              else if ((compositionFlags1.m_Left & CompositionFlags.Side.AddCrosswalk) > (CompositionFlags.Side) 0 | flag7)
                nodeFlags.m_General |= CompositionFlags.General.Crosswalk;
            }
            else if ((compositionFlags1.m_Right & CompositionFlags.Side.RemoveCrosswalk) > (CompositionFlags.Side) 0 | flag6)
              obsoleteEdgeFlags.m_Right |= compositionFlags1.m_Right & (CompositionFlags.Side.AddCrosswalk | CompositionFlags.Side.RemoveCrosswalk);
        ...
        if ((nodeFlags.m_General & (CompositionFlags.General.Roundabout | CompositionFlags.General.LevelCrossing)) == (CompositionFlags.General) 0 && (nodeFlags.m_General & (CompositionFlags.General.Intersection | CompositionFlags.General.Crosswalk)) > (CompositionFlags.General) 0 | flag11 | flag4)
        {
          if (flag3 && math.all(int3 >= new int3(1, 1, 2)) && ((math.all(int3 >= new int3(2, 1, 3)) ? 1 : ((nodeFlags.m_General & CompositionFlags.General.Crosswalk) > (CompositionFlags.General) 0 ? 1 : 0)) | (flag4 ? 1 : 0) | (flag12 ? 1 : 0)) != 0)
          {
    ...
    private struct CreateCompositionJob : IJob
    {
          ...
          if (compositionCreateInfo.m_ObsoleteEdgeFlags != new CompositionFlags())
          {
            ...
            if (upgraded.m_Flags != new CompositionFlags())
            {
              ...
              if (this.m_TempData.TryGetComponent(compositionCreateInfo.m_Entity, out componentData5) && componentData5.m_Original != Entity.Null && (componentData5.m_Flags & (TempFlags.Upgrade | TempFlags.Parent)) == (TempFlags.Upgrade | TempFlags.Parent))
              {
                ...
                if (upgraded.m_Flags == componentData6.m_Flags)
                {
      ...
      public Entity GetOrCreateComposition(
        Entity prefab,
        CompositionFlags flags,
