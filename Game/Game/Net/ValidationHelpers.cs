      ...
      NativeList<ConnectedNode> tempNodes)
    {
      ...
      if ((temp.m_Flags & TempFlags.Delete) == (TempFlags) 0 && tempChunks.Length != 0)
      {
        for (int index1 = 0; index1 < tempChunks.Length; ++index1)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          if (tempChunk.Has<EdgeGeometry>(ref type.m_EdgeGeometry))
          {
            // ISSUE: reference to a compiler-generated field
            NativeArray<Entity> nativeArray1 = tempChunk.GetNativeArray(type.m_Entity);
            // ISSUE: reference to a compiler-generated field
            NativeArray<Temp> nativeArray2 = tempChunk.GetNativeArray<Temp>(ref type.m_Temp);
            // ISSUE: reference to a compiler-generated field
            NativeArray<Edge> nativeArray3 = tempChunk.GetNativeArray<Edge>(ref type.m_Edge);
            // ISSUE: reference to a compiler-generated field
            NativeArray<Owner> nativeArray4 = tempChunk.GetNativeArray<Owner>(ref type.m_Owner);
            // ISSUE: reference to a compiler-generated field
            ...
            {
              Temp temp1 = nativeArray2[index2];
              if ((temp1.m_Flags & (TempFlags.Delete | TempFlags.Select)) == (TempFlags) 0)
              {
                Entity edgeEntity2 = nativeArray1[index2];
                if (edgeEntity2.Index > entity.Index)
                {
                  Entity entity2 = edgeEntity2;
                  if (nativeArray4.Length != 0)
                  {
                    Entity owner3 = nativeArray4[index2].m_Owner;
                    Entity owner4;
                    // ISSUE: reference to a compiler-generated field
                  ...
                  if (!(entity1 == entity2))
                  {
                    Edge edgeData2 = nativeArray3[index2];
                    if (!(edge.m_Start == edgeData2.m_Start) && !(edge.m_Start == edgeData2.m_End) && !(edge.m_End == edgeData2.m_Start) && !(edge.m_End == edgeData2.m_End))
                    {
                      ...
                      Composition compositionData2_1 = nativeArray8[index2];
                      ...
                      {
                        if (!MathUtils.Intersect(bounds1.xz, bounds2.xz))
                          continue;
                      }
                      else if (!MathUtils.Intersect(bounds1, bounds2))
                        continue;
                      iterator1.CheckOverlap(entity2, edgeEntity2, bounds2, edgeData2, compositionData2_1, edgeGeometryData2, startNodeGeometryData2, endNodeGeometryData2, (temp1.m_Flags & TempFlags.Essential) > (TempFlags) 0, nativeArray4.Length != 0);
                    }
                  }
                }
              }
      ...
      if ((temp.m_Flags & TempFlags.Essential) == (TempFlags) 0)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        flag2 = !data.m_NetElevation.HasComponent(entity) || !data.m_NetElevation.HasComponent(edge.m_Start) || !data.m_NetElevation.HasComponent(edge.m_End);
      }
      if ((temp.m_Flags & TempFlags.Delete) == (TempFlags) 0)
      {
        // ISSUE: reference to a compiler-generated field
        ...
        // ISSUE: reference to a compiler-generated field
        bool flag3 = entity1 != entity && ValidationHelpers.IsInternal(entity1, edge.m_End, data.m_ConnectedEdges[edge.m_End], data);
        bool flag4 = false;
        if (num == 0 | !flag3)
          flag4 |= ValidationHelpers.CheckGeometryShape(edgeGeometry, ref errorBounds);
        if (num == 0)
          flag4 |= ValidationHelpers.CheckGeometryShape(startNodeGeometry.m_Geometry, ref errorBounds);
        if (!flag3)
          flag4 |= ValidationHelpers.CheckGeometryShape(endNodeGeometry.m_Geometry, ref errorBounds);
        if (flag4)
        ...
        if (data.m_PrefabNetGeometry.HasComponent(prefabRef.m_Prefab))
        {
          ...
          if ((netGeometryData.m_Flags & GeometryFlags.FlattenTerrain) != (GeometryFlags) 0 && (temp.m_Flags & TempFlags.Essential) != (TempFlags) 0)
            flag2 = false;
          if ((double) netGeometryData.m_MaxSlopeSteepness != 0.0 && !flag2)
          {
            float3 float3;
      ...
      // ISSUE: reference to a compiler-generated field
      if ((temp.m_Flags & (TempFlags.Create | TempFlags.Modify)) != (TempFlags) 0 && !flag2 && data.m_PlaceableNet.HasComponent(prefabRef.m_Prefab))
      {
        // ISSUE: reference to a compiler-generated field
