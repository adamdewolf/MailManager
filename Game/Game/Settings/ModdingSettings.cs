  ...
  public class ModdingSettings : Setting
  {
    ...
    public bool showEnvVars
    {
      set
      {
        ...
        GameManager.instance.userInterface.appBindings.ShowMessageDialog(new MessageDialogWithDetails((LocalizedString) "envVars", LocalizedString.Value("Values which set to variables"), LocalizedString.Value(values.Count != 0 ? string.Join("\n", (IEnumerable<string>) values) : "Nothing set"), true, LocalizedString.Id("Common.OK")), (Action<int>) null);
      }
    }
    ...
    public bool showCurrentValues
    {
      set
      {
        ...
        GameManager.instance.userInterface.appBindings.ShowMessageDialog(new MessageDialogWithDetails((LocalizedString) "envVars", LocalizedString.Value("Current values"), LocalizedString.Value(string.Join("\n", (IEnumerable<string>) list)), true, LocalizedString.Id("Common.OK")), (Action<int>) null);
      }
    }
