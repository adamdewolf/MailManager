...
namespace Game.Rendering
{
  ...
  public class CameraUpdateSystem : GameSystemBase
  {
    ...
    private ProxyActionMap m_CameraActionMap;
    private bool m_CameraActionMapWasEnabled;
    ...
    protected override void OnCreate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.m_CameraActionMap = InputManager.instance.FindActionMap("Camera");
    }
    ...
    {
      bool flag = this.activeCameraController != null;
      string str;
      ProxyAction proxyAction;
      // ISSUE: reference to a compiler-generated field
      if (flag != this.m_CameraActionMapWasEnabled)
      {
        // ISSUE: reference to a compiler-generated field
        this.m_CameraActionMapWasEnabled = flag;
        // ISSUE: reference to a compiler-generated field
        foreach (KeyValuePair<string, ProxyAction> action in (IEnumerable<KeyValuePair<string, ProxyAction>>) this.m_CameraActionMap.actions)
        {
          action.Deconstruct(ref str, ref proxyAction);
          proxyAction.enabled = flag;
        }
      }
      // ISSUE: reference to a compiler-generated field
      if (!flag || !this.m_CameraActionMap.actions.All<KeyValuePair<string, ProxyAction>>((Func<KeyValuePair<string, ProxyAction>, bool>) (a => !a.Value.IsInProgress())))
        return;
      ...
      {
        action.Deconstruct(ref str, ref proxyAction);
        proxyAction.mask = mouseOverUi ? InputManager.DeviceType.Keyboard | InputManager.DeviceType.Gamepad : InputManager.DeviceType.All;
      }
    }
