...
namespace Game.Rendering
{
  ...
  public class RouteRenderSystem : GameSystemBase
  {
    ...
    public bool visible => this.ShouldRenderRoutes();
      ...
      RenderPipelineManager.beginContextRendering += (Action<ScriptableRenderContext, List<Camera>>) ((context, cameras) =>
      {
        try
        {
          if (!this.visible)
            return;
          // ISSUE: reference to a compiler-generated field
          using (NativeArray<ArchetypeChunk> archetypeChunkArray = this.m_RouteQuery.ToArchetypeChunkArray((AllocatorManager.AllocatorHandle) Allocator.TempJob))
          {
