...
namespace Game.Serialization
{
  ...
  public class SecondaryPrefabReferencesSystem : GameSystemBase
  {
    ...
    protected override void OnCreate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.m_SpawnableBuildingQuery = this.GetEntityQuery(ComponentType.ReadOnly<SpawnableBuildingData>(), ComponentType.ReadOnly<PrefabData>());
      // ISSUE: reference to a compiler-generated field
      this.m_PlaceholderBuildingQuery = this.GetEntityQuery(ComponentType.ReadOnly<PlaceholderBuildingData>(), ComponentType.ReadOnly<PrefabData>());
      // ISSUE: reference to a compiler-generated field
      this.m_ServiceObjectQuery = this.GetEntityQuery(ComponentType.ReadOnly<ServiceObjectData>(), ComponentType.ReadOnly<PrefabData>());
      // ISSUE: reference to a compiler-generated field
      this.m_NetLaneQuery = this.GetEntityQuery(ComponentType.ReadOnly<NetLaneData>(), ComponentType.ReadOnly<PrefabData>());
    }
    ...
    protected override void OnUpdate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      EntityQuery netLaneQuery = this.m_NetLaneQuery;
      JobHandle dependsOn2 = dependsOn1;
      JobHandle job3 = jobData4.ScheduleParallel<SecondaryPrefabReferencesSystem.FixNetLaneDataJob>(netLaneQuery, dependsOn2);
      JobHandle dependencies2 = JobUtils.CombineDependencies(job0, job1, job2, job3);
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated method
