  ...
  public class SubLaneSystem : GameSystemBase
  {
    ...
    private struct SubLaneJob : IJobChunk
    {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        NativeArray<ConnectionLane> nativeArray3 = chunk.GetNativeArray<ConnectionLane>(ref this.m_ConnectionLaneType);
        ...
        for (int index = 0; index < nativeArray2.Length; ++index)
        {
          ...
          if (this.m_SubLanes.HasBuffer(owner.m_Owner))
          {
            ...
            {
              ConnectionLane connectionLane = nativeArray3[index];
            ...
            // ISSUE: reference to a compiler-generated field
            this.m_SubLanes[owner.m_Owner].Add(new SubLane(lane, pathMethods));
          }
        }
      }
