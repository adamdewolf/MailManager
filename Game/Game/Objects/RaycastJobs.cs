  ...
  public static class RaycastJobs
  {
    ...
    public struct RaycastStaticObjectsJob : IJobParallelForDefer
    {
      ...
      public void Execute(int index)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        if ((input.m_TypeMask & (TypeMask.StaticObjects | TypeMask.Net)) == TypeMask.None || this.m_OverriddenData.HasComponent(entityResult.m_Entity) || !this.IsNearCamera(entityResult.m_Entity))
          return;
        // ISSUE: reference to a compiler-generated field
