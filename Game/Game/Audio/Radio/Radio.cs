...
namespace Game.Audio.Radio
{
  public class Radio
  {
    ...
    {
      return target.contentPrerequisite == null || ((IEnumerable<string>) target.contentPrerequisite).All<string>((Func<string, bool>) (x =>
      {
        ...
        foreach (Game.Audio.Radio.Radio.Segment segment1 in program.segments)
        {
          ...
          else
          {
            ...
            if (segment.tags != null)
            {
              ...
              clips.Capacity += assets.Count<AudioAsset>();
            ...
            if (clips.Count > 0)
            {
              ...
              Game.Audio.Radio.Radio.log.WarnFormat("No clips found in a segment of program '{0}' founds in radio channel '{1}'", (object) program.name, (object) path);
          }
        }
      }
