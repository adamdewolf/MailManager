...
namespace Game.Simulation
{
  ...
  public class UpdateGroupSystem : GameSystemBase
  {
    ...
    protected override void OnCreate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.m_CreatedQuery = this.GetEntityQuery(ComponentType.ReadOnly<Created>(), ComponentType.ReadOnly<UpdateFrame>());
      // ISSUE: reference to a compiler-generated field
      ...
      // ISSUE: reference to a compiler-generated field
      this.m_DeletedQuery = this.GetEntityQuery(ComponentType.ReadOnly<Deleted>(), ComponentType.ReadOnly<UpdateFrame>());
      // ISSUE: reference to a compiler-generated field
    ...
    {
      // ISSUE: reference to a compiler-generated field
      bool flag1 = !this.m_CreatedQuery.IsEmptyIgnoreFilter;
      // ISSUE: reference to a compiler-generated field
      bool flag2 = !this.m_DeletedQuery.IsEmptyIgnoreFilter;
      if (flag1 | flag2)
      {
        NativeArray<ArchetypeChunk> nativeArray1 = new NativeArray<ArchetypeChunk>();
        NativeList<ArchetypeChunk> nativeList = new NativeList<ArchetypeChunk>();
        NativeArray<int> nativeArray2 = new NativeArray<int>();
        if (flag2)
        {
          JobHandle outJobHandle;
          // ISSUE: reference to a compiler-generated field
          nativeList = this.m_DeletedQuery.ToArchetypeChunkListAsync((AllocatorManager.AllocatorHandle) this.World.UpdateAllocator.ToAllocator, out outJobHandle);
          this.Dependency = JobHandle.CombineDependencies(this.Dependency, outJobHandle);
        }
        if (flag1)
        {
          // ISSUE: reference to a compiler-generated field
          nativeArray1 = this.m_CreatedQuery.ToArchetypeChunkArray((AllocatorManager.AllocatorHandle) this.World.UpdateAllocator.ToAllocator);
          int length = 0;
          for (int index = 0; index < nativeArray1.Length; ++index)
          {
            ArchetypeChunk archetypeChunk = nativeArray1[index];
            length += archetypeChunk.Count;
          }
          nativeArray2 = new NativeArray<int>(length, Allocator.TempJob);
          int num = 0;
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          ...
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          ComponentTypeHandle<Controller> componentTypeHandle1 = this.__TypeHandle.__Game_Vehicles_Controller_RO_ComponentTypeHandle;
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          this.__TypeHandle.__Game_Tools_Temp_RO_ComponentTypeHandle.Update(ref this.CheckedStateRef);
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          ComponentTypeHandle<Temp> componentTypeHandle2 = this.__TypeHandle.__Game_Tools_Temp_RO_ComponentTypeHandle;
          for (int index1 = 0; index1 < nativeArray1.Length; ++index1)
          {
            ArchetypeChunk archetypeChunk = nativeArray1[index1];
            NativeArray<Controller> nativeArray3 = archetypeChunk.GetNativeArray<Controller>(ref componentTypeHandle1);
            NativeArray<Temp> nativeArray4 = archetypeChunk.GetNativeArray<Temp>(ref componentTypeHandle2);
            for (int index2 = 0; index2 < nativeArray3.Length; ++index2)
            {
              ...
              if (controller.m_Controller != Entity.Null)
              {
                ...
                nativeArray2[num + index2] = entityManager.HasComponent<Created>(controller.m_Controller) || !this.EntityManager.TryGetSharedComponent<UpdateFrame>(controller.m_Controller, out component) ? -1 : (int) component.m_Index;
              }
            }
            for (int index3 = 0; index3 < nativeArray4.Length; ++index3)
            {
              Temp temp = nativeArray4[index3];
              if (temp.m_Original != Entity.Null)
              {
                UpdateFrame component;
                nativeArray2[num + index3] = !this.EntityManager.TryGetSharedComponent<UpdateFrame>(temp.m_Original, out component) ? -1 : (int) component.m_Index;
              }
            }
        ...
        {
          m_CreatedChunks = nativeArray1,
          m_DeletedChunks = nativeList,
          m_TempUpdateFrameIndex = nativeArray2,
        ...
        this.Dependency = jobData.Schedule<UpdateGroupSystem.UpdateGroupJob>(this.Dependency);
        // ISSUE: reference to a compiler-generated field
        this.m_ModificationBarrier.AddJobHandleForProducer(this.Dependency);
        if (flag1)
          nativeArray2.Dispose(this.Dependency);
      }
      // ISSUE: reference to a compiler-generated field
    ...
    private struct UpdateGroupJob : IJob
    {
      ...
      [ReadOnly]
      public NativeArray<ArchetypeChunk> m_CreatedChunks;
      [NativeDisableContainerSafetyRestriction]
      [ReadOnly]
      public NativeList<ArchetypeChunk> m_DeletedChunks;
      [NativeDisableContainerSafetyRestriction]
      [ReadOnly]
      public NativeArray<int> m_TempUpdateFrameIndex;
      [ReadOnly]
      ...
      {
        // ISSUE: reference to a compiler-generated field
        if (this.m_DeletedChunks.IsCreated)
        {
          // ISSUE: reference to a compiler-generated field
          for (int index = 0; index < this.m_DeletedChunks.Length; ++index)
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated method
            this.CheckDeleted(this.m_DeletedChunks[index]);
          }
        }
        // ISSUE: reference to a compiler-generated field
        if (!this.m_CreatedChunks.IsCreated)
          return;
        int createdIndex = 0;
        // ISSUE: reference to a compiler-generated field
        for (int index = 0; index < this.m_CreatedChunks.Length; ++index)
        {
          // ISSUE: reference to a compiler-generated field
          ArchetypeChunk createdChunk = this.m_CreatedChunks[index];
          // ISSUE: reference to a compiler-generated method
          this.CheckCreated(createdChunk, createdIndex);
          createdIndex += createdChunk.Count;
        }
      }
      ...
      private void CheckCreated(ArchetypeChunk chunk, int createdIndex)
      {
        // ISSUE: reference to a compiler-generated method
        NativeArray<int> groupSizeArray = this.GetGroupSizeArray(chunk);
        // ISSUE: reference to a compiler-generated field
        ...
        if (nativeArray2.Length != 0)
        {
          for (int index1 = 0; index1 < nativeArray1.Length; ++index1)
          {
            ...
            if (nativeArray4.Length != 0)
            {
              ...
              {
                // ISSUE: reference to a compiler-generated field
                originalIndex = this.m_TempUpdateFrameIndex[createdIndex + index1];
                if (originalIndex == -1)
                  continue;
              }
            }
            if (nativeArray2[index1].m_Original != Entity.Null)
            {
              // ISSUE: reference to a compiler-generated field
              originalIndex = this.m_TempUpdateFrameIndex[createdIndex + index1];
            }
          ...
          for (int index7 = 0; index7 < nativeArray1.Length; ++index7)
          {
            ...
            else
            {
              ...
              if (nativeArray4.Length != 0 && !flag)
              {
                ...
                {
                  // ISSUE: reference to a compiler-generated field
                  originalIndex = this.m_TempUpdateFrameIndex[createdIndex + index7];
                  if (originalIndex == -1)
                    continue;
                }
              }
