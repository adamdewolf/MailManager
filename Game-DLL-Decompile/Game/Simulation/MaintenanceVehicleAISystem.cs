    ...
    private struct MaintenanceVehicleTickJob : IJobChunk
    {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index = 0; index < nativeArray1.Length; ++index)
        {
          ...
          // ISSUE: reference to a compiler-generated method
          this.Tick(unfilteredChunkIndex, entity, owner, transform, prefabRef, pathInformation, navigationLanes, serviceDispatches, isStopped, ref maintenanceVehicle, ref car, ref currentLane, ref pathOwner, ref target);
        ...
        ref Game.Common.Target target)
      {
        ...
        {
          // ISSUE: reference to a compiler-generated method
          this.ResetPath(jobIndex, vehicleEntity, pathInformation, serviceDispatches, prefabMaintenanceVehicleData, ref maintenanceVehicle, ref car, ref currentLane);
        }
        // ISSUE: reference to a compiler-generated field
        ...
        // ISSUE: reference to a compiler-generated method
        this.FindPathIfNeeded(vehicleEntity, prefabRef, prefabMaintenanceVehicleData, isStopped, ref currentLane, ref pathOwner, ref target);
      }
