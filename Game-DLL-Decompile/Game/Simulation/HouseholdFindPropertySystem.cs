...
namespace Game.Simulation
{
  ...
  public class HouseholdFindPropertySystem : GameSystemBase
  {
    ...
    protected override void OnUpdate()
    {
      ...
      HouseholdFindPropertySystem.PreparePropertyJob jobData = new HouseholdFindPropertySystem.PreparePropertyJob()
      {
      ...
      // ISSUE: object of a compiler-generated type is created
      // ISSUE: reference to a compiler-generated field
      JobHandle jobHandle1 = new HouseholdFindPropertySystem.FindPropertyJob()
      {
      ...
      }.Schedule<HouseholdFindPropertySystem.FindPropertyJob>(JobHandle.CombineDependencies(jobData.ScheduleParallel<HouseholdFindPropertySystem.PreparePropertyJob>(this.m_FreePropertyQuery, JobUtils.CombineDependencies(this.Dependency, dependencies1, dependencies3, dependencies2, dependencies4)), outJobHandle, deps1));
      // ISSUE: reference to a compiler-generated field
      ...
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      JobHandle jobHandle2 = new PropertyUtils.RentJob()
      {
      ...
      }.Schedule<PropertyUtils.RentJob>(JobHandle.CombineDependencies(deps2, jobHandle1));
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated method
