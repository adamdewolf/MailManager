...
namespace Game.Simulation
{
  public struct GarbagePathfindSetup
  {
    ...
    private EntityQuery m_PrisonerCollectorRequestQuery;
    ...
    public GarbagePathfindSetup(PathfindSetupSystem system)
    {
      ...
      // ISSUE: reference to a compiler-generated method
      this.m_PrisonerCollectorRequestQuery = system.GetSetupQuery(ComponentType.ReadOnly<GarbageCollectionRequest>(), ComponentType.Exclude<Dispatched>(), ComponentType.Exclude<PathInformation>());
      ...
      JobHandle inputDeps)
    {
      ...
      return new GarbagePathfindSetup.GarbageCollectorRequestsJob()
      {
        ...
        m_ServiceDistricts = this.m_ServiceDistricts,
        m_SetupData = setupData
      }.ScheduleParallel<GarbagePathfindSetup.GarbageCollectorRequestsJob>(this.m_PrisonerCollectorRequestQuery, inputDeps);
    }
