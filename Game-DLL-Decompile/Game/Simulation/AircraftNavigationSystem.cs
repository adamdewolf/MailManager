  ...
  public class AircraftNavigationSystem : GameSystemBase
  {
    ...
    protected override void OnUpdate()
    {
      ...
      AircraftNavigationSystem.UpdateNavigationJob jobData1 = new AircraftNavigationSystem.UpdateNavigationJob()
      {
        ...
        m_AircraftDataFromEntity = this.__TypeHandle.__Game_Vehicles_Aircraft_RO_ComponentLookup,
    ...
    private struct UpdateNavigationJob : IJobChunk
    {
        ...
        ref AircraftLaneSpeedIterator laneIterator)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        if (laneIterator.m_Blocker != Entity.Null && this.m_MovingDataFromEntity.HasComponent(laneIterator.m_Blocker) && this.m_AircraftDataFromEntity.HasComponent(laneIterator.m_Blocker) && (this.m_AircraftDataFromEntity[laneIterator.m_Blocker].m_Flags & ~aircraft.m_Flags & AircraftFlags.Blocking) != (AircraftFlags) 0 && (double) laneIterator.m_MaxSpeed < 1.0)
          currentLane.m_LaneFlags |= AircraftLaneFlags.IgnoreBlocker;
...
label_69:
        ...
        else
        {
          ...
          AircraftLaneSpeedIterator laneIterator = new AircraftLaneSpeedIterator()
          {
            ...
            m_AircraftData = this.m_AircraftDataFromEntity,
...
label_118:
        ...
        Entity target)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        return VehicleUtils.CalculateTransformPosition(ref targetPosition, target, this.m_TransformDataFromEntity, this.m_PositionDataFromEntity, this.m_PrefabRefData, this.m_PrefabBuildingData) && (double) math.distance(comparePosition.xz, targetPosition.xz) >= (double) minDistance;
      }
