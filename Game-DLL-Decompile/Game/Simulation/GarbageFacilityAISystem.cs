    ...
    private struct GarbageFacilityTickJob : IJobChunk
    {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index = 0; index < nativeArray1.Length; ++index)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          GarbageFacilityData result = this.m_PrefabGarbageFacilityData[prefabRef.m_Prefab];
          // ISSUE: reference to a compiler-generated field
          ...
          if (bufferAccessor2.Length != 0)
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            UpgradeUtils.CombineStats<GarbageFacilityData>(ref result, bufferAccessor2[index], ref this.m_PrefabRefData, ref this.m_PrefabGarbageFacilityData);
            // ISSUE: reference to a compiler-generated method
          ...
          if (bufferAccessor5.Length != 0)
          {
            ...
            // ISSUE: reference to a compiler-generated method
            this.ProcessAreas(unfilteredChunkIndex, subAreas, ref garbageAmount, result, max, efficiency, out areaCapacity, out areaGarbage);
          }
          // ISSUE: reference to a compiler-generated method
          this.Tick(unfilteredChunkIndex, entity, building, ref garbageFacility, ref garbageAmount, result, efficiency, immediateEfficiency, areaCapacity, areaGarbage, min, max, ownedVehicles, guestVehicles, dispatches, resources, resourceProductionBuffer, outside);
          ...
          if (resources.IsCreated)
          {
            ...
            int num2 = Mathf.RoundToInt((float) ((double) num1 / (double) math.max(1, result.m_GarbageCapacity) * 100.0));
            int num3 = Mathf.RoundToInt((float) ((double) garbageAmount / (double) math.max(1, result.m_GarbageCapacity) * 100.0));
        ...
        bool outside)
      {
        ...
        for (int index1 = 0; index1 < ownedVehicles.Length; ++index1)
        {
          ...
          else
          {
            ...
            // ISSUE: reference to a compiler-generated field
            if (this.m_DeliveryTruckData.TryGetComponent(vehicle1, out componentData2))
            {
              if ((componentData2.m_State & DeliveryTruckFlags.DummyTraffic) == (DeliveryTruckFlags) 0)
              {
                ...
                if (dynamicBuffer.IsCreated && dynamicBuffer.Length != 0)
                {
                  for (int index2 = 0; index2 < dynamicBuffer.Length; ++index2)
                  {
                    ...
                    if (this.m_DeliveryTruckData.HasComponent(vehicle2))
                    {
                      ...
                      if ((deliveryTruck.m_Resource & Resource.Garbage) != Resource.NoResource && (componentData2.m_State & DeliveryTruckFlags.Buying) != (DeliveryTruckFlags) 0)
                ...
                {
                  if ((componentData2.m_Resource & Resource.Garbage) != Resource.NoResource && (componentData2.m_State & DeliveryTruckFlags.Buying) != (DeliveryTruckFlags) 0)
                    availableSpace -= componentData2.m_Amount;
                  // ISSUE: reference to a compiler-generated field
        ...
        for (int index = 0; index < dispatches.Length; ++index)
        {
          ...
          {
            // ISSUE: reference to a compiler-generated method
            this.TrySpawnGarbageTruck(jobIndex, ref random, entity, request, prefabGarbageFacilityData, ref garbageFacility, ref vehicleCapacity1, ref availableSpace);
          ...
          if ((double) garbageFacility.m_AcceptGarbagePriority > 0.0)
          {
            ...
            if (this.m_GarbageTransferRequestData.HasComponent(garbageFacility.m_GarbageDeliverRequest))
            {
              ...
              if (this.m_GarbageTransferRequestData[garbageFacility.m_GarbageDeliverRequest].m_Flags != flags)
              {
                ...
                // ISSUE: reference to a compiler-generated field
                this.m_CommandBuffer.SetComponent<HandleRequest>(jobIndex, entity1, new HandleRequest(garbageFacility.m_GarbageDeliverRequest, Entity.Null, true));
              }
              else
            ...
            if (flags != (GarbageTransferRequestFlags) 0)
            {
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              Entity entity2 = this.m_CommandBuffer.CreateEntity(jobIndex, this.m_GarbageTransferRequestArchetype);
              // ISSUE: reference to a compiler-generated field
              this.m_CommandBuffer.SetComponent<GarbageTransferRequest>(jobIndex, entity2, new GarbageTransferRequest(entity, flags, garbageFacility.m_AcceptGarbagePriority, amount));
              // ISSUE: reference to a compiler-generated field
          ...
          if ((double) garbageFacility.m_DeliverGarbagePriority > 0.0)
          {
            ...
            if (this.m_GarbageTransferRequestData.HasComponent(garbageFacility.m_GarbageReceiveRequest))
            {
              ...
              if (this.m_GarbageTransferRequestData[garbageFacility.m_GarbageReceiveRequest].m_Flags != flags)
              {
                ...
                // ISSUE: reference to a compiler-generated field
                this.m_CommandBuffer.SetComponent<HandleRequest>(jobIndex, entity3, new HandleRequest(garbageFacility.m_GarbageReceiveRequest, Entity.Null, true));
              }
              else
                flags = (GarbageTransferRequestFlags) 0;
            }
            if (flags != (GarbageTransferRequestFlags) 0)
            {
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              Entity entity4 = this.m_CommandBuffer.CreateEntity(jobIndex, this.m_GarbageTransferRequestArchetype);
              // ISSUE: reference to a compiler-generated field
              this.m_CommandBuffer.SetComponent<GarbageTransferRequest>(jobIndex, entity4, new GarbageTransferRequest(entity, flags, garbageFacility.m_DeliverGarbagePriority, amount));
              // ISSUE: reference to a compiler-generated field
        ...
        if (prefabGarbageFacilityData.m_IndustrialWasteOnly)
          ...
          garbageFacility.m_Flags &= ~GarbageFacilityFlags.IndustrialWasteOnly;
        if (vehicleCapacity1 <= 0 || availableSpace <= 0)
          return;
        // ISSUE: reference to a compiler-generated method
        this.RequestTargetIfNeeded(jobIndex, entity, ref garbageFacility, prefabGarbageFacilityData, vehicleCapacity1);
      }
      ...
      {
        // ISSUE: reference to a compiler-generated field
        if (availableVehicles <= 0 || availableSpace <= 0 || !this.m_GarbageCollectionRequestData.HasComponent(request))
          return false;
        // ISSUE: reference to a compiler-generated field
        Entity target = this.m_GarbageCollectionRequestData[request].m_Target;
        // ISSUE: reference to a compiler-generated field
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        Entity vehicle = this.m_GarbageTruckSelectData.CreateVehicle(this.m_CommandBuffer, jobIndex, ref random, this.m_TransformData[entity], entity, ref garbageCapacity);
        if (vehicle == Entity.Null)
          return false;
        --availableVehicles;
        availableSpace -= garbageCapacity.y;
        GarbageTruckFlags flags = (GarbageTruckFlags) 0;
        if (prefabGarbageFacilityData.m_IndustrialWasteOnly)
          flags |= GarbageTruckFlags.IndustrialWasteOnly;
        // ISSUE: reference to a compiler-generated field
        this.m_CommandBuffer.SetComponent<Game.Vehicles.GarbageTruck>(jobIndex, vehicle, new Game.Vehicles.GarbageTruck(flags, 1));
        // ISSUE: reference to a compiler-generated field
        this.m_CommandBuffer.SetComponent<Game.Common.Target>(jobIndex, vehicle, new Game.Common.Target(target));
        // ISSUE: reference to a compiler-generated field
        ...
        if (this.m_ServiceRequestData.HasComponent(garbageFacility.m_TargetRequest))
        {
          ...
          // ISSUE: reference to a compiler-generated field
          this.m_CommandBuffer.SetComponent<HandleRequest>(jobIndex, entity2, new HandleRequest(garbageFacility.m_TargetRequest, Entity.Null, true));
        }
        return true;
      }
