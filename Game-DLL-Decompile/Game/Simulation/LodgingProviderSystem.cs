...
namespace Game.Simulation
{
  ...
  public class LodgingProviderSystem : GameSystemBase
  {
    ...
    public static int GetRoomCount(int2 lotSize, int level) => lotSize.x * lotSize.y * level;
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index1 = 0; index1 < chunk.Count; ++index1)
        {
          ...
          if (this.m_PropertyRenters.HasComponent(entity))
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            Entity prefab1 = this.m_Prefabs[this.m_PropertyRenters[entity].m_Property].m_Prefab;
            // ISSUE: reference to a compiler-generated field
            PrefabRef prefab2 = this.m_Prefabs[entity];
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated method
            int roomCount = LodgingProviderSystem.GetRoomCount(this.m_BuildingDatas[prefab1].m_LotSize, (int) this.m_SpawnableBuildingDatas[prefab1].m_Level);
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            ...
            for (int index2 = dynamicBuffer.Length - 1; index2 >= 0; --index2)
            {
              ...
              // ISSUE: reference to a compiler-generated field
              if (!this.m_TouristHouseholds.HasComponent(renter))
              {
            ...
            // ISSUE: reference to a compiler-generated field
            EconomyUtils.AddResources(Resource.Money, num3 * num2, this.m_Resources[entity]);
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            EconomyUtils.AddResources(Resource.Lodging, -num3 * this.m_LeisureParameters.m_TouristLodgingConsumePerDay / LodgingProviderSystem.kUpdatesPerDay, this.m_Resources[entity]);
            ServiceAvailable serviceAvailable = nativeArray3[index1];
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            serviceAvailable.m_ServiceAvailable = math.max(0, serviceAvailable.m_ServiceAvailable - num3 * this.m_LeisureParameters.m_TouristServiceConsumePerDay / LodgingProviderSystem.kUpdatesPerDay);
