  ...
  public class HealthcareDispatchSystem : GameSystemBase
  {
    ...
    private struct HealthcareDispatchJob : IJobChunk
    {
      ...
      private bool ValidateReversed(Entity entity, Entity source, HealthcareRequestType type)
      {
        switch (type)
        {
          case HealthcareRequestType.Ambulance:
            ...
            // ISSUE: reference to a compiler-generated field
            if (!this.m_AmbulanceData.TryGetComponent(source, out componentData2) || (componentData2.m_State & (AmbulanceFlags.Returning | AmbulanceFlags.Dispatched | AmbulanceFlags.Transporting | AmbulanceFlags.Disabled)) != AmbulanceFlags.Returning)
              return false;
          ...
          case HealthcareRequestType.Hearse:
            ...
            // ISSUE: reference to a compiler-generated field
            if (!this.m_HearseData.TryGetComponent(source, out componentData4) || (componentData4.m_State & (HearseFlags.Returning | HearseFlags.Dispatched | HearseFlags.Transporting | HearseFlags.Disabled)) != HearseFlags.Returning)
              return false;
      ...
      private void DispatchVehicle(int jobIndex, Entity entity, PathInformation pathInformation)
      {
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        HealthcareDispatchSystem.VehicleDispatch vehicleDispatch = new HealthcareDispatchSystem.VehicleDispatch(entity, pathInformation.m_Origin);
        // ISSUE: reference to a compiler-generated field
        this.m_VehicleDispatches.Enqueue(vehicleDispatch);
        // ISSUE: reference to a compiler-generated field
