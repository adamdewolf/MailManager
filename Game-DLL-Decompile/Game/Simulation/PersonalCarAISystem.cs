    ...
    private struct PersonalCarTickJob : IJobChunk
    {
        ...
        DynamicBuffer<CarNavigationLane> navigationLanes)
      {
        ...
        for (int index = 0; index < navigationLanes.Length; ++index)
        {
          ...
          if ((navigationLane1.m_Flags & Game.Vehicles.CarLaneFlags.ParkingSpace) != (Game.Vehicles.CarLaneFlags) 0)
          {
            ...
            if (this.m_ParkingLaneData.HasComponent(navigationLane1.m_Lane))
            {
              ...
              if (VehicleUtils.FindFreeParkingSpace(ref random, navigationLane1.m_Lane, minT, y, offset, ref x, ref this.m_ParkedCarData, ref this.m_CurveData, ref this.m_UnspawnedData, ref this.m_ParkingLaneData, ref this.m_PrefabRefData, ref this.m_PrefabParkingLaneData, ref this.m_PrefabObjectGeometryData, ref this.m_LaneObjects, ref this.m_LaneOverlaps, false, true))
              {
                ...
                if ((double) x == (double) navigationLane1.m_CurvePosition.x)
                  return;
                // ISSUE: reference to a compiler-generated field
                VehicleUtils.SetParkingCurvePos(pathElement1, pathOwner, ref currentLane, navigationLanes, index, x, this.m_CurveData);
                return;
              }
              if ((navigationLane1.m_Flags & Game.Vehicles.CarLaneFlags.Validated) != (Game.Vehicles.CarLaneFlags) 0)
              {
            ...
            // ISSUE: reference to a compiler-generated field
            if (this.m_GarageLaneData.HasComponent(navigationLane1.m_Lane))
            {
              // ISSUE: reference to a compiler-generated field
              GarageLane garageLane = this.m_GarageLaneData[navigationLane1.m_Lane];
              // ISSUE: reference to a compiler-generated field
              Game.Net.ConnectionLane connectionLane = this.m_ConnectionLaneData[navigationLane1.m_Lane];
        ...
        {
          // ISSUE: reference to a compiler-generated method
          if (this.IsParkingLane(pathElement1[pathOwner.m_ElementIndex + index].m_Target))
            return;
        }
        pathOwner.m_State |= PathFlags.Obsolete;
      }
        ...
        ref PathOwner pathOwner)
      {
        ...
        if (this.IsParkingLane(currentLane.m_Lane))
        {
          ...
          // ISSUE: reference to a compiler-generated field
          for (; pathOwner.m_ElementIndex < pathElement1.Length; VehicleUtils.SetParkingCurvePos(pathElement1, pathOwner, pathOwner.m_ElementIndex++, currentLane.m_Lane, currentLane.m_CurvePosition.z, this.m_CurveData))
          {
        ...
        {
          PathElement pathElement3 = pathElement1[elementIndex];
          // ISSUE: reference to a compiler-generated method
          if (this.IsParkingLane(pathElement3.m_Target))
          {
            float curvePos = -1f;
            // ISSUE: reference to a compiler-generated field
            if (this.m_ParkingLaneData.HasComponent(pathElement3.m_Target))
            {
              float offset;
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              ...
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              if (!VehicleUtils.FindFreeParkingSpace(ref random, pathElement3.m_Target, pathElement3.m_TargetDelta.x, y, offset, ref curvePos, ref this.m_ParkedCarData, ref this.m_CurveData, ref this.m_UnspawnedData, ref this.m_ParkingLaneData, ref this.m_PrefabRefData, ref this.m_PrefabParkingLaneData, ref this.m_PrefabObjectGeometryData, ref this.m_LaneObjects, ref this.m_LaneOverlaps, false, false))
      ...
      private Entity GetParkingSource(Entity entity, ref CarCurrentLane currentLane)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        return this.m_ParkingLaneData.HasComponent(currentLane.m_Lane) || this.m_ConnectionLaneData.TryGetComponent(currentLane.m_Lane, out componentData) && (componentData.m_Flags & ConnectionLaneFlags.Parking) != (ConnectionLaneFlags) 0 ? currentLane.m_Lane : entity;
      }
        ...
        ref Target target)
      {
        ...
        if ((personalCar.m_State & PersonalCarFlags.Transporting) != (PersonalCarFlags) 0)
        {
          ...
          parameters = new PathfindParameters()
          {
            ...
            m_ParkingTarget = this.GetParkingSource(entity, ref currentLane),
