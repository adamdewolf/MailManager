  ...
  public class AmbulanceAISystem : GameSystemBase
  {
    ...
    private struct AmbulanceTickJob : IJobChunk
    {
        ...
        ref Target target)
      {
        ...
        {
          // ISSUE: reference to a compiler-generated method
          this.ResetPath(jobIndex, entity, pathInformation, passengers, serviceDispatches, ref random, ref ambulance, ref car, ref currentLane, ref pathOwner, ref target);
        }
        // ISSUE: reference to a compiler-generated field
        ...
        {
          if (VehicleUtils.PathEndReached(currentLane) || (ambulance.m_State & AmbulanceFlags.Disembarking) != (AmbulanceFlags) 0)
          {
          ...
          else if (VehicleUtils.ParkingSpaceReached(currentLane, pathOwner) || (ambulance.m_State & AmbulanceFlags.AtTarget) != (AmbulanceFlags) 0)
          {
            // ISSUE: reference to a compiler-generated method
            if (this.LoadPatients(jobIndex, entity, passengers, serviceDispatches, isStopped, ref random, ref ambulance, ref currentLane, ref target))
            {
          ...
          if (VehicleUtils.RequireNewPath(pathOwner))
          {
            ...
            {
              // ISSUE: reference to a compiler-generated method
              this.FindNewPath(entity, prefabRef, ref ambulance, ref car, ref currentLane, ref pathOwner, ref target);
            }
          }
          else
          {
            if ((pathOwner.m_State & (PathFlags.Pending | PathFlags.Failed | PathFlags.Stuck)) != (PathFlags) 0)
              return;
            // ISSUE: reference to a compiler-generated method
            this.CheckParkingSpace(entity, ref random, ref ambulance, ref currentLane, ref pathOwner, navigationLanes);
          }
        }
      }
        ...
        ref Target target)
      {
        ...
        PathfindParameters parameters = new PathfindParameters()
        {
          ...
          m_ParkingTarget = currentLane.m_Lane
        };
            ...
            if (this.m_PathElements.HasBuffer(request))
            {
              ...
              if (pathElement1.Length != 0)
              {
                ...
                if (PathUtils.TryAppendPath(ref currentLane, navigationLanes, pathElement2, pathElement1, this.m_SlaveLaneData, this.m_OwnerData, this.m_SubLanes))
                {
                  ...
                  // ISSUE: reference to a compiler-generated method
                  this.ResetParkingLaneStatus(vehicleEntity, ref currentLane, ref pathOwner);
        ...
        DynamicBuffer<CarNavigationLane> navigationLanes)
      {
        for (int index = 0; index < navigationLanes.Length; ++index)
        {
          ...
          {
            // ISSUE: reference to a compiler-generated field
            if (this.m_ParkingLaneData.HasComponent(navigationLane1.m_Lane))
            {
              float minT;
              if (index == 0)
              {
              ...
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              if (!this.m_BlockerData.TryGetComponent(entity, out componentData1) || !this.m_ParkedCarData.TryGetComponent(componentData1.m_Blocker, out componentData2) || !(componentData2.m_Lane == navigationLane1.m_Lane))
                break;
        ...
        ref Target target)
      {
        ...
        if ((ambulance.m_State & AmbulanceFlags.Dispatched) != (AmbulanceFlags) 0 && serviceDispatches.Length > 0)
        {
          ...
          car.m_Flags &= ~CarFlags.Emergency;
        ambulance.m_PathElementTime = pathInformation.m_Duration / (float) math.max(1, pathElement1.Length);
        // ISSUE: reference to a compiler-generated field
        this.m_CommandBuffer.AddComponent<EffectsUpdated>(jobIndex, vehicleEntity);
        // ISSUE: reference to a compiler-generated method
        this.ResetParkingLaneStatus(vehicleEntity, ref currentLane, ref pathOwner);
        for (int elementIndex = pathOwner.m_ElementIndex; elementIndex < pathElement1.Length; ++elementIndex)
        {
          ...
          if (this.IsParkingLane(pathElement2.m_Target))
          {
            ...
            if (this.m_ParkingLaneData.HasComponent(pathElement2.m_Target))
            {
              ...
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              float y = VehicleUtils.GetParkingSize(vehicleEntity, ref this.m_PrefabRefData, ref this.m_PrefabObjectGeometryData, out offset).y;
              BufferLookup<LaneOverlap> laneOverlapData = new BufferLookup<LaneOverlap>();
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
      ...
      private bool IsCarLane(Entity lane)
      {
        ...
        SpawnLocationData componentData2;
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
