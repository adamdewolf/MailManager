...
namespace Game.Simulation
{
  ...
  public class FindJobSystem : GameSystemBase
  {
    ...
    {
      // ISSUE: reference to a compiler-generated field
      if (!this.m_JobSeekerQuery.IsEmptyIgnoreFilter)
      {
    ...
    private struct FindJobJob : IJobChunk
    {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index1 = 0; index1 < nativeArray1.Length; ++index1)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          if (!this.m_CitizenDatas.HasComponent(owner))
          {
            // ISSUE: reference to a compiler-generated field
          ...
          else
          {
            ...
            if (entity1 != Entity.Null)
            {
              ...
              {
                // ISSUE: reference to a compiler-generated field
                this.m_CommandBuffer.RemoveComponent<HasJobSeeker>(unfilteredChunkIndex, owner);
                // ISSUE: reference to a compiler-generated field
              ...
              else
              {
                ...
                else
                {
                  ...
                  if (flag || num1 < 0 || (double) random.NextFloat(max) <= 2.0)
                  {
                    // ISSUE: reference to a compiler-generated field
            ...
            if ((nativeArray2[index2].m_State & PathFlags.Pending) == (PathFlags) 0)
            {
              ...
              if (this.m_Citizens.HasComponent(owner) && !this.m_Deleteds.HasComponent(owner))
              {
                ...
                if (this.m_Prefabs.HasComponent(destination) && this.m_EmployeeBuffers.HasBuffer(destination))
                {
                  ...
                  // ISSUE: reference to a compiler-generated field
                  // ISSUE: reference to a compiler-generated field
                  if (this.m_Workers.HasComponent(owner) && this.m_Workers[owner].m_Workplace == destination)
                  {
                    // ISSUE: reference to a compiler-generated field
                    // ISSUE: reference to a compiler-generated field
                    this.m_CommandBuffer.AddComponent<JobSeekerCooldown>(owner, new JobSeekerCooldown()
                    {
                  ...
                  {
                    // ISSUE: reference to a compiler-generated field
                    if (this.m_Prefabs.HasComponent(destination))
                    {
                      // ISSUE: reference to a compiler-generated field
              ...
              // ISSUE: reference to a compiler-generated field
              this.m_CommandBuffer.RemoveComponent<HasJobSeeker>(owner);
              // ISSUE: reference to a compiler-generated field
