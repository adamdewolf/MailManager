  ...
  public class GarbageCollectorDispatchSystem : GameSystemBase
  {
    ...
    private struct GarbageDispatchJob : IJobChunk
    {
      ...
      private bool ValidateReversed(Entity entity, Entity source)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        if (!this.m_GarbageTruckData.TryGetComponent(source, out componentData2) || (componentData2.m_State & (GarbageTruckFlags.Disabled | GarbageTruckFlags.EstimatedFull)) != (GarbageTruckFlags) 0 || componentData2.m_RequestCount > 1)
          return false;
      ...
      private void DispatchVehicle(int jobIndex, Entity entity, PathInformation pathInformation)
      {
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        GarbageCollectorDispatchSystem.VehicleDispatch vehicleDispatch = new GarbageCollectorDispatchSystem.VehicleDispatch(entity, pathInformation.m_Origin);
        // ISSUE: reference to a compiler-generated field
        this.m_VehicleDispatches.Enqueue(vehicleDispatch);
        // ISSUE: reference to a compiler-generated field
