...
namespace Game.Simulation
{
  ...
  public class TouristFindTargetSystem : GameSystemBase
  {
    ...
    protected override void OnCreate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.m_SeekerQuery = this.GetEntityQuery(ComponentType.ReadWrite<TouristHousehold>(), ComponentType.ReadWrite<LodgingSeeker>(), ComponentType.Exclude<Target>(), ComponentType.Exclude<Deleted>(), ComponentType.Exclude<Temp>());
      // ISSUE: reference to a compiler-generated field
