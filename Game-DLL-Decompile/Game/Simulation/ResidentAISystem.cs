  ...
  public class ResidentAISystem : GameSystemBase
  {
    ...
    private struct ResidentTickJob : IJobChunk
    {
        ...
        ref Divert divert)
      {
        ...
        {
          // ISSUE: reference to a compiler-generated field
          if (divert.m_Purpose == Game.Citizens.Purpose.None && !this.m_PrefabRefData.HasComponent(target.m_Target))
          {
        ...
        ref Game.Creatures.Resident resident)
      {
        ...
        for (int index = 0; index < pathElement1.Length; ++index)
        {
          ...
          {
            // ISSUE: reference to a compiler-generated field
            VehicleUtils.SetParkingCurvePos(pathElement1, pathOwner, index, currentLane.m_Lane, componentData2.m_CurvePosition, this.m_CurveData);
            length = index;
            break;
          }
          // ISSUE: reference to a compiler-generated field
          if (this.m_ParkingLaneData.HasComponent(pathElement2.m_Target))
          {
            ...
            // ISSUE: reference to a compiler-generated field
            VehicleUtils.SetParkingCurvePos(pathElement1, pathOwner, index, currentLane.m_Lane, curvePos, this.m_CurveData);
            length = index;
            break;
          }
          // ISSUE: reference to a compiler-generated field
        ...
        ref Game.Common.Target target)
      {
        ...
        else
        {
          ...
          if (pathElement.Length >= pathOwner.m_ElementIndex + 2)
          {
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            if (!RouteUtils.ShouldExitVehicle(target2, target1, controllerVehicle, this.m_OwnerData, this.m_RouteConnectedData, this.m_BoardingVehicleData, this.m_CurrentRouteData, this.m_AccessLaneLaneData, this.m_PublicTransportData, this.m_ConnectedRoutes, false, out obsolete))
              return;
        ...
        ref Game.Common.Target target)
      {
        ...
        else
        {
          ...
          if (pathElement.Length >= pathOwner.m_ElementIndex + 2)
          {
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            if (!RouteUtils.ShouldExitVehicle(target2, target1, controllerVehicle, this.m_OwnerData, this.m_RouteConnectedData, this.m_BoardingVehicleData, this.m_CurrentRouteData, this.m_AccessLaneLaneData, this.m_PublicTransportData, this.m_ConnectedRoutes, true, out bool _))
              return;
          }
        }
        // ISSUE: reference to a compiler-generated field
        ...
        if ((ignoreFlags & ~resident.m_Flags) != ResidentFlags.None)
        {
          ...
          if (this.m_SpawnLocationElements.TryGetBuffer(building, out bufferData))
          {
            for (int index = 0; index < bufferData.Length; ++index)
            {
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              Game.Prefabs.SpawnLocationData spawnLocationData = this.m_PrefabSpawnLocationData[this.m_PrefabRefData[bufferData[index].m_SpawnLocation].m_Prefab];
        ...
        ref Game.Common.Target target)
      {
        ...
        if (pathElement.Length >= pathOwner.m_ElementIndex + 2)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          if (RouteUtils.GetBoardingVehicle(currentLane.m_Lane, target1, target2, minDeparture, this.m_OwnerData, this.m_RouteConnectedData, this.m_BoardingVehicleData, this.m_CurrentRouteData, this.m_AccessLaneLaneData, this.m_PublicTransportData, this.m_TaxiData, this.m_ConnectedRoutes, out vehicle, out testing, out obsolete))
          {
            // ISSUE: reference to a compiler-generated method
...
label_17:
    ...
    private struct BoardingJob : IJob
    {
        ...
        int requiredSpace)
      {
        ...
        int3 int3 = (int3) 0;
        // ISSUE: reference to a compiler-generated field
        if (this.m_VehicleLayouts.HasBuffer(vehicle))
        {
          // ISSUE: reference to a compiler-generated field
          DynamicBuffer<LayoutElement> vehicleLayout = this.m_VehicleLayouts[vehicle];
          float num1 = float.MaxValue;
          int num2 = 0;
          for (int index = 0; index < vehicleLayout.Length; ++index)
          {
            Entity vehicle1 = vehicleLayout[index].m_Vehicle;
            // ISSUE: reference to a compiler-generated field
            Game.Objects.Transform transform = this.m_Transforms[vehicle1];
            float num3 = math.distancesq(position, transform.m_Position);
            // ISSUE: reference to a compiler-generated method
            ...
            if (freeSpace.x > num2 | freeSpace.x == num2 & (double) num3 < (double) num1)
            {
              num1 = num3;
              num2 = freeSpace.x;
              entity = vehicle1;
        ...
        CreatureVehicleFlags flags)
      {
        ...
        if ((flags & CreatureVehicleFlags.Leader) != (CreatureVehicleFlags) 0)
        {
          ...
          // ISSUE: reference to a compiler-generated method
          vehicle = this.TryFindVehicle(ref freeSpaceMap, vehicle, Entity.Null, position, true, requiredSpace);
        ...
        else
        {
          ...
          // ISSUE: reference to a compiler-generated method
          vehicle = this.TryFindVehicle(ref freeSpaceMap, vehicle, leaderVehicle, position, false, requiredSpace);
          if (vehicle == Entity.Null)
            return;
        ...
        float3 position)
      {
        if (passenger != Entity.Null)
        {
          ...
          // ISSUE: reference to a compiler-generated method
          if (this.TryFindVehicle(ref freeSpaceMap, vehicle, Entity.Null, position, true, requiredSpace) == Entity.Null)
            return;
        }
        Game.Vehicles.PublicTransport componentData;
        // ISSUE: reference to a compiler-generated field
