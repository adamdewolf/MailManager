  ...
  public class CrimeAccumulationSystem : GameSystemBase
  {
    ...
    private struct CrimeAccumulationJob : IJobChunk
    {
        ...
        ref Random random)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        if ((double) producer.m_Crime < (double) this.m_PoliceConfigurationData.m_CrimeAccumulationTolerance && (double) random.NextFloat() > (double) producer.m_Crime / ((double) this.m_PoliceConfigurationData.m_CrimeAccumulationTolerance * (double) this.m_PoliceConfigurationData.m_CrimeAccumulationTolerance) || this.m_PolicePatrolRequestData.TryGetComponent(producer.m_PatrolRequest, out componentData) && (componentData.m_Target == entity || (int) componentData.m_DispatchIndex == (int) producer.m_DispatchIndex))
          return;
