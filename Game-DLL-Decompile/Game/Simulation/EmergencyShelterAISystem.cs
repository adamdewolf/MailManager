    ...
    private struct EmergencyShelterTickJob : IJobChunk
    {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index = 0; index < nativeArray1.Length; ++index)
        {
          ...
          EmergencyShelterData result = new EmergencyShelterData();
          // ISSUE: reference to a compiler-generated field
          if (this.m_PrefabEmergencyShelterData.HasComponent(prefabRef.m_Prefab))
          {
            // ISSUE: reference to a compiler-generated field
            result = this.m_PrefabEmergencyShelterData[prefabRef.m_Prefab];
          }
          if (bufferAccessor2.Length != 0)
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            UpgradeUtils.CombineStats<EmergencyShelterData>(ref result, bufferAccessor2[index], ref this.m_PrefabRefData, ref this.m_PrefabEmergencyShelterData);
          }
          ...
          float serviceUsage;
          // ISSUE: reference to a compiler-generated method
          this.Tick(unfilteredChunkIndex, entity, transform, ref emergencyShelter, out serviceUsage, result, vehicles, dispatches, occupants, span, immediateEfficiency, resourceAvailability);
        ...
        byte resourceAvailability)
      {
        ...
        while (index1 < dispatches.Length)
        {
          ...
          {
            // ISSUE: reference to a compiler-generated method
            this.SpawnVehicle(jobIndex, ref random, entity, request, transform, ref emergencyShelter, ref vehicleCapacity1, ref availableSpace);
        ...
        if (vehicleCapacity1 > 0)
        {
          ...
          // ISSUE: reference to a compiler-generated method
          this.RequestTargetIfNeeded(jobIndex, entity, ref emergencyShelter, vehicleCapacity1);
        }
        else
          emergencyShelter.m_Flags &= ~EmergencyShelterFlags.HasAvailableVehicles;
        if (availableSpace > 0)
        ...
        ref int availableSpace)
      {
        ...
        if (!this.m_EvacuationRequestData.HasComponent(request))
          return;
        // ISSUE: reference to a compiler-generated field
        EvacuationRequest evacuationRequest = this.m_EvacuationRequestData[request];
        // ISSUE: reference to a compiler-generated field
        if (!this.m_PrefabRefData.HasComponent(evacuationRequest.m_Target) || availableVehicles <= 0 || availableSpace <= 0)
          return;
        int2 passengerCapacity = new int2(1, availableSpace);
        int2 cargoCapacity = (int2) 0;
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        Entity vehicle = this.m_TransportVehicleSelectData.CreateVehicle(this.m_CommandBuffer, jobIndex, ref random, transform, entity, Entity.Null, Entity.Null, TransportType.Bus, EnergyTypes.FuelAndElectricity, PublicTransportPurpose.Evacuation, Resource.NoResource, ref passengerCapacity, ref cargoCapacity);
        ...
        // ISSUE: reference to a compiler-generated field
        this.m_CommandBuffer.SetComponent<Target>(jobIndex, vehicle, new Target(evacuationRequest.m_Target));
        // ISSUE: reference to a compiler-generated field
        ...
        // ISSUE: reference to a compiler-generated field
        this.m_CommandBuffer.SetComponent<HandleRequest>(jobIndex, entity2, new HandleRequest(emergencyShelter.m_TargetRequest, Entity.Null, true));
      }
