...
namespace Game.Simulation
{
  ...
  public class GarbageTruckAISystem : GameSystemBase
  {
    ...
    private EntityQuery __query_647374863_0;
    private EntityQuery __query_647374863_1;
    ...
    {
      // ISSUE: reference to a compiler-generated field
      GarbageParameterData singleton = this.__query_647374863_0.GetSingleton<GarbageParameterData>();
      ...
      GarbageTruckAISystem.GarbageActionJob jobData2 = new GarbageTruckAISystem.GarbageActionJob()
      {
        ...
        m_GarbageParameters = singleton,
        m_GarbageEfficiencyPenalty = this.__query_647374863_1.GetSingleton<BuildingEfficiencyParameterData>().m_GarbagePenalty,
    ...
    {
      // ISSUE: reference to a compiler-generated field
      this.__query_647374863_0 = state.GetEntityQuery(new EntityQueryDesc()
      {
      ...
      // ISSUE: reference to a compiler-generated field
      this.__query_647374863_1 = state.GetEntityQuery(new EntityQueryDesc()
      {
        All = new ComponentType[1]
        {
    ...
    private struct GarbageTruckTickJob : IJobChunk
    {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index = 0; index < nativeArray1.Length; ++index)
        {
          ...
          // ISSUE: reference to a compiler-generated method
          this.Tick(unfilteredChunkIndex, entity, owner, prefabRef, pathInformation, navigationLanes, serviceDispatches, ref garbageTruck, ref car, ref currentLane, ref pathOwner, ref target);
        ...
        ref Game.Common.Target target)
      {
        ...
        {
          // ISSUE: reference to a compiler-generated method
          this.ResetPath(jobIndex, vehicleEntity, pathInformation, serviceDispatches, owner, ref garbageTruck, ref car, ref currentLane);
        }
        // ISSUE: reference to a compiler-generated field
        ...
        ref Game.Common.Target target)
      {
        ...
        for (; garbageTruck.m_RequestCount > 0 && serviceDispatches.Length > 0; --garbageTruck.m_RequestCount)
        {
          ...
          {
            // ISSUE: reference to a compiler-generated field
            target1 = this.m_GarbageCollectionRequestData[request].m_Target;
          }
          // ISSUE: reference to a compiler-generated field
