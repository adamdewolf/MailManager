  ...
  public class HearseAISystem : GameSystemBase
  {
    ...
    private struct HearseTickJob : IJobChunk
    {
        ...
        ref Target target)
      {
        ...
        {
          if (VehicleUtils.PathEndReached(currentLane) || (hearse.m_State & HearseFlags.Disembarking) != (HearseFlags) 0)
          {
          ...
          else if (VehicleUtils.ParkingSpaceReached(currentLane, pathOwner) || (hearse.m_State & HearseFlags.AtTarget) != (HearseFlags) 0)
          {
            // ISSUE: reference to a compiler-generated method
            if (this.LoadCorpses(jobIndex, entity, passengers, serviceDispatches, isStopped, ref hearse, ref currentLane, ref target))
            {
        ...
        ref Target target)
      {
        ...
        if ((hearse.m_State & (HearseFlags.Returning | HearseFlags.Dispatched | HearseFlags.Transporting)) == HearseFlags.Dispatched)
        {
        ...
        ref Target target)
      {
        ...
        hearse.m_PathElementTime = pathInformation.m_Duration / (float) math.max(1, pathElement1.Length);
        // ISSUE: reference to a compiler-generated method
        this.ResetParkingLaneStatus(vehicleEntity, ref currentLane, ref pathOwner);
