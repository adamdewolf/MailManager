    ...
    private struct TaxiTickJob : IJobChunk
    {
        ...
        ref Game.Common.Target target)
      {
        ...
        else if (VehicleUtils.PathEndReached(currentLane))
        {
          ...
          {
            // ISSUE: reference to a compiler-generated method
            if ((taxi.m_State & TaxiFlags.Transporting) == (TaxiFlags) 0 || !this.StartDisembarking(odometer, passengers, ref taxi))
            {
              if ((taxi.m_State & TaxiFlags.Returning) != (TaxiFlags) 0)
              {
                // ISSUE: reference to a compiler-generated field
              ...
              {
                // ISSUE: reference to a compiler-generated method
                if ((taxi.m_State & TaxiFlags.Dispatched) != (TaxiFlags) 0 || !this.SelectDispatch(jobIndex, entity, currentRoute, navigationLanes, serviceDispatches, ref taxi, ref car, ref currentLane, ref pathOwner, ref target))
                {
                  // ISSUE: reference to a compiler-generated method
        ...
        else if (VehicleUtils.ParkingSpaceReached(currentLane, pathOwner) || (taxi.m_State & (TaxiFlags.Boarding | TaxiFlags.Disembarking)) != (TaxiFlags) 0)
        {
          if ((taxi.m_State & TaxiFlags.Boarding) != (TaxiFlags) 0)
          {
            // ISSUE: reference to a compiler-generated method
          ...
          else if ((taxi.m_State & TaxiFlags.Disembarking) != (TaxiFlags) 0)
          {
            // ISSUE: reference to a compiler-generated method
            // ISSUE: reference to a compiler-generated method
            if (this.StopDisembarking(entity, passengers, ref taxi, ref pathOwner) && !this.SelectDispatch(jobIndex, entity, currentRoute, navigationLanes, serviceDispatches, ref taxi, ref car, ref currentLane, ref pathOwner, ref target))
          ...
          {
            // ISSUE: reference to a compiler-generated method
            if ((taxi.m_State & TaxiFlags.Dispatched) != (TaxiFlags) 0 && this.StartBoarding(jobIndex, entity, currentRoute, serviceDispatches, ref taxi, ref target))
            {
              flag = true;
            }
            else
            {
              // ISSUE: reference to a compiler-generated method
              // ISSUE: reference to a compiler-generated method
              if (!this.StartDisembarking(odometer, passengers, ref taxi) && !this.SelectDispatch(jobIndex, entity, currentRoute, navigationLanes, serviceDispatches, ref taxi, ref car, ref currentLane, ref pathOwner, ref target))
              {
                // ISSUE: reference to a compiler-generated method
                this.ReturnToDepot(jobIndex, entity, owner, serviceDispatches, ref taxi, ref car, ref pathOwner, ref target);
              }
      ...
      private Entity GetParkingSource(ref CarCurrentLane currentLane)
      {
        Game.Net.ConnectionLane componentData;
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        return this.m_ParkingLaneData.HasComponent(currentLane.m_Lane) || this.m_ConnectionLaneData.TryGetComponent(currentLane.m_Lane, out componentData) && (componentData.m_Flags & ConnectionLaneFlags.Parking) != (ConnectionLaneFlags) 0 ? currentLane.m_Lane : Entity.Null;
      }
        ...
        ref Game.Common.Target target)
      {
        ...
        else
        {
          ...
          parameters = new PathfindParameters()
          {
            ...
            m_ParkingTarget = this.GetParkingSource(ref currentLane),
          ...
          setupQueueTarget.m_RoadTypes = RoadTypes.Car;
          setupQueueTarget.m_Entity = target.m_Target;
          destination = setupQueueTarget with
          {
            m_Methods = (taxi.m_State & TaxiFlags.Dispatched) == (TaxiFlags) 0 ? PathMethod.Road : PathMethod.Boarding
          };
        }
        ...
        if (this.m_PathElements.HasBuffer(request))
        {
          ...
          if (pathElement1.Length != 0)
          {
            ...
            if (PathUtils.TryAppendPath(ref currentLane, navigationLanes, pathElement2, pathElement1, this.m_SlaveLaneData, this.m_OwnerData, this.m_SubLanes))
            {
              ...
              // ISSUE: reference to a compiler-generated method
              this.ResetParkingLaneStatus(entity, ref currentLane, ref pathOwner);
              return true;
            }
          }
        }
        ...
        DynamicBuffer<CarNavigationLane> navigationLanes)
      {
        for (int index = 0; index < navigationLanes.Length; ++index)
        {
          ...
          if ((navigationLane1.m_Flags & Game.Vehicles.CarLaneFlags.ParkingSpace) != (Game.Vehicles.CarLaneFlags) 0)
          {
            Game.Net.ParkingLane componentData1;
            // ISSUE: reference to a compiler-generated field
            if (this.m_ParkingLaneData.TryGetComponent(navigationLane1.m_Lane, out componentData1))
            {
              taxi.m_NextStartingFee = componentData1.m_TaxiFee;
              float minT;
              if (index == 0)
              {
              ...
              else
              {
                ...
                minT = (navigationLane2.m_Flags & Game.Vehicles.CarLaneFlags.Reserved) == (Game.Vehicles.CarLaneFlags) 0 ? navigationLane2.m_CurvePosition.x : navigationLane2.m_CurvePosition.y;
              }
              float offset;
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              ...
              BufferLookup<LaneOverlap> laneOverlapData = new BufferLookup<LaneOverlap>();
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              ...
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              if (VehicleUtils.FindFreeParkingSpace(ref random, navigationLane1.m_Lane, minT, y, offset, ref x, ref this.m_ParkedCarData, ref this.m_CurveData, ref this.m_UnspawnedData, ref this.m_ParkingLaneData, ref this.m_PrefabRefData, ref this.m_PrefabParkingLaneData, ref this.m_PrefabObjectGeometryData, ref this.m_LaneObjects, ref laneOverlapData, true, false))
              {
                if ((navigationLane1.m_Flags & Game.Vehicles.CarLaneFlags.Validated) == (Game.Vehicles.CarLaneFlags) 0)
                {
                  navigationLane1.m_Flags |= Game.Vehicles.CarLaneFlags.Validated;
                ...
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                VehicleUtils.SetParkingCurvePos(this.m_PathElements[entity], pathOwner, ref currentLane, navigationLanes, index, x, this.m_CurveData);
                break;
              }
              if ((navigationLane1.m_Flags & Game.Vehicles.CarLaneFlags.Validated) != (Game.Vehicles.CarLaneFlags) 0)
              {
              ...
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              if (!this.m_BlockerData.TryGetComponent(entity, out componentData2) || !this.m_ParkedCarData.TryGetComponent(componentData2.m_Blocker, out componentData3) || !(componentData3.m_Lane == navigationLane1.m_Lane))
                break;
              CarNavigationLane navigationLane3 = navigationLanes[index - 1];
              navigationLane3.m_Flags |= Game.Vehicles.CarLaneFlags.EndOfPath;
      ...
      private void ResetParkingLaneStatus(
        Entity entity,
        ref CarCurrentLane currentLane,
        ref PathOwner pathOwner)
      {
        ...
        // ISSUE: reference to a compiler-generated method
        if (this.IsParkingLane(currentLane.m_Lane))
        {
          currentLane.m_LaneFlags |= Game.Vehicles.CarLaneFlags.ParkingSpace;
          bool flag = false;
          while (pathOwner.m_ElementIndex < pathElement1.Length)
          {
            PathElement pathElement2 = pathElement1[pathOwner.m_ElementIndex];
            // ISSUE: reference to a compiler-generated method
            if (this.IsParkingLane(pathElement2.m_Target))
            {
              // ISSUE: reference to a compiler-generated field
              VehicleUtils.SetParkingCurvePos(pathElement1, pathOwner, pathOwner.m_ElementIndex++, currentLane.m_Lane, currentLane.m_CurvePosition.z, this.m_CurveData);
              flag = true;
            }
            else
            {
              ...
              {
                // ISSUE: reference to a compiler-generated field
                VehicleUtils.SetParkingCurvePos(pathElement1, pathOwner, pathOwner.m_ElementIndex - 1, currentLane.m_Lane, currentLane.m_CurvePosition.z, this.m_CurveData);
              }
              // ISSUE: reference to a compiler-generated method
              // ISSUE: reference to a compiler-generated field
              if (!this.IsCarLane(pathElement2.m_Target) && this.m_EntityLookup.Exists(pathElement2.m_Target))
                break;
              currentLane.m_LaneFlags &= ~Game.Vehicles.CarLaneFlags.ParkingSpace;
              break;
            }
        ...
        {
          // ISSUE: reference to a compiler-generated method
          if (!this.IsCarLane(currentLane.m_Lane))
            return;
          currentLane.m_LaneFlags &= ~Game.Vehicles.CarLaneFlags.ParkingSpace;
        }
      }
        ...
        CarData prefabCarData)
      {
        ...
        taxi.m_ExtraPathElementCount = 0;
        int num = 0;
        for (int elementIndex = pathOwner.m_ElementIndex; elementIndex < pathElement1.Length; ++elementIndex)
        {
          PathElement pathElement2 = pathElement1[elementIndex];
          // ISSUE: reference to a compiler-generated field
          if (this.m_CarLaneData.HasComponent(pathElement2.m_Target))
          {
            // ISSUE: reference to a compiler-generated field
            Game.Net.CarLane carLane = this.m_CarLaneData[pathElement2.m_Target];
            // ISSUE: reference to a compiler-generated field
          ...
          else
          {
            ...
            if (this.IsParkingLane(pathElement2.m_Target))
            {
              ...
              if (this.m_ParkingLaneData.HasComponent(pathElement2.m_Target))
              {
                ...
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                if (!VehicleUtils.FindFreeParkingSpace(ref random, pathElement2.m_Target, pathElement2.m_TargetDelta.x, y, offset, ref curvePos, ref this.m_ParkedCarData, ref this.m_CurveData, ref this.m_UnspawnedData, ref this.m_ParkingLaneData, ref this.m_PrefabRefData, ref this.m_PrefabParkingLaneData, ref this.m_PrefabObjectGeometryData, ref this.m_LaneObjects, ref laneOverlapData, true, false))
                  curvePos = random.NextFloat(0.05f, 0.95f);
              }
              else
                curvePos = random.NextFloat(0.05f, 0.95f);
              // ISSUE: reference to a compiler-generated field
              VehicleUtils.SetParkingCurvePos(pathElement1, pathOwner, elementIndex, currentLane.m_Lane, curvePos, this.m_CurveData);
              taxi.m_ExtraPathElementCount = pathElement1.Length - (elementIndex + 1);
              break;
            }
          }
        }
        if (num == 0)
          return;
        taxi.m_PathElementTime /= (float) num;
      }
      ...
      private bool IsParkingLane(Entity lane)
      {
        ...
        Game.Net.ConnectionLane componentData;
        // ISSUE: reference to a compiler-generated field
        return this.m_ConnectionLaneData.TryGetComponent(lane, out componentData) && (componentData.m_Flags & ConnectionLaneFlags.Parking) != 0;
      }
      ...
      private bool IsCarLane(Entity lane)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        if (this.m_ConnectionLaneData.TryGetComponent(lane, out componentData1))
          return (componentData1.m_Flags & ConnectionLaneFlags.Road) != 0;
        Game.Prefabs.SpawnLocationData componentData2;
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        if (!this.m_SpawnLocationData.HasComponent(lane) || !this.m_PrefabSpawnLocationData.TryGetComponent(this.m_PrefabRefData[lane].m_Prefab, out componentData2))
          return false;
