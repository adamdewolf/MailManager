  ...
  public class ServiceCompanySystem : GameSystemBase
  {
    ...
    private struct UpdateServiceJob : IJobChunk
    {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        NativeArray<CompanyNotifications> nativeArray4 = chunk.GetNativeArray<CompanyNotifications>(ref this.m_CompanyNotificationsType);
        // ISSUE: reference to a compiler-generated field
        ...
        for (int index = 0; index < chunk.Count; ++index)
        {
          ...
          if (this.m_Buildings.HasComponent(property))
          {
            ...
            if (this.m_ServiceCompanyDatas.HasComponent(prefab))
            {
              ...
              CompanyNotifications companyNotifications = nativeArray4[index];
              // ISSUE: reference to a compiler-generated field
              Resource resource = this.m_IndustrialProcessDatas[prefab].m_Output.m_Resource;
              // ISSUE: reference to a compiler-generated field
              IndustrialProcessData industrialProcessData1 = this.m_IndustrialProcessDatas[prefab];
              // ISSUE: reference to a compiler-generated field
              IndustrialProcessData industrialProcessData2 = this.m_IndustrialProcessDatas[prefab];
              ...
              if (companyNotifications.m_NoCustomersEntity == new Entity())
              {
                if (flag)
                {
                  ...
                  nativeArray4[index] = companyNotifications;
                }
              }
              else if (!flag)
              {
