    ...
    private struct AttractivenessJob : IJobChunk
    {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index = 0; index < chunk.Count; ++index)
        {
          ...
          AttractionData result = new AttractionData();
          // ISSUE: reference to a compiler-generated field
          ...
          if (bufferAccessor2.Length != 0)
          {
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            UpgradeUtils.CombineStats<AttractionData>(ref result, bufferAccessor2[index], ref this.m_PrefabRefData, ref this.m_AttractionDatas);
          }
          float attractiveness = (float) result.m_Attractiveness;
          if (!flag)
