...
namespace Game.Simulation
{
  ...
  public class WaterSystem : GameSystemBase, IDefaultSerializable, ISerializable, IGPUSystem
  {
    ...
    public unsafe void Deserialize<TReader>(TReader reader) where TReader : IReader
    {
      ...
      Colossal.Serialization.Entities.Context context = reader.context;
      if (context.version >= Game.Version.waterInterpolationFix)
      {
        // ISSUE: reference to a compiler-generated field
      ...
      if (context.version >= Game.Version.waterElectricityID)
      {
        context = reader.context;
        if (context.version < Game.Version.waterOverflowFix)
        {
          uint num;
          reader.Read(out num);
          // ISSUE: reference to a compiler-generated field
        ...
        context = reader.context;
        if (context.version < Game.Version.waterGridNotNeeded)
        {
          int num3;
        ...
        context = reader.context;
        if (context.version >= Game.Version.terrainWaterSnowCompression)
        {
    ...
    {
      // ISSUE: reference to a compiler-generated field
      if (!this.Loaded && this.m_TerrainSystem != null)
      {
        // ISSUE: reference to a compiler-generated method
        this.TryInitTexture();
        // ISSUE: reference to a compiler-generated field
    ...
    protected override void OnUpdate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      if (!this.m_Loaded && this.m_TerrainSystem != null && (UnityEngine.Object) this.m_TerrainSystem.heightmap != (UnityEngine.Object) null)
      {
        // ISSUE: reference to a compiler-generated method
        this.TryInitTexture();
        // ISSUE: reference to a compiler-generated method
