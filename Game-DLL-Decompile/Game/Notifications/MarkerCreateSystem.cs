  ...
  public class MarkerCreateSystem : GameSystemBase, IPostDeserialize
  {
    ...
    protected override void OnUpdate()
    {
      ...
      if (!this.m_InfomodeQuery.IsEmptyIgnoreFilter)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        ComponentTypeHandle<InfoviewVehicleData> componentTypeHandle3 = this.__TypeHandle.__Game_Prefabs_InfoviewVehicleData_RO_ComponentTypeHandle;
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        this.__TypeHandle.__Game_Prefabs_InfoviewMarkerData_RO_ComponentTypeHandle.Update(ref this.CheckedStateRef);
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        ComponentTypeHandle<InfoviewMarkerData> componentTypeHandle4 = this.__TypeHandle.__Game_Prefabs_InfoviewMarkerData_RO_ComponentTypeHandle;
        // ISSUE: reference to a compiler-generated field
        ...
        for (int index1 = 0; index1 < nativeArray1.Length; ++index1)
        {
          ...
          NativeArray<InfoviewVehicleData> nativeArray4 = archetypeChunk.GetNativeArray<InfoviewVehicleData>(ref componentTypeHandle3);
          NativeArray<InfoviewMarkerData> nativeArray5 = archetypeChunk.GetNativeArray<InfoviewMarkerData>(ref componentTypeHandle4);
          ...
          {
            InfoviewVehicleData infoviewVehicleData = nativeArray4[index4];
            num3 |= 1U << (int) (infoviewVehicleData.m_Type & (VehicleType) 31);
          }
          for (int index5 = 0; index5 < nativeArray5.Length; ++index5)
          {
            InfoviewMarkerData infoviewMarkerData = nativeArray5[index5];
            num4 |= 1U << (int) (infoviewMarkerData.m_Type & (MarkerType) 31);
          }
        }
      }
      // ISSUE: reference to a compiler-generated field
      ...
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      if ((int) num1 == (int) this.m_TransportTypeMask && (int) num2 == (int) this.m_BuildingTypeMask && (int) num3 == (int) this.m_VehicleTypeMask && (int) num4 == (int) this.m_MarkerTypeMask && (num1 == 0U && num2 == 0U && num3 == 0U && num4 == 0U || entityQuery.IsEmptyIgnoreFilter))
      {
      ...
      else
      {
        ...
        // ISSUE: reference to a compiler-generated field
        this.m_VehicleTypeMask = num3;
        // ISSUE: reference to a compiler-generated field
        this.m_MarkerTypeMask = num4;
