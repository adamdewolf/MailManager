...
namespace Game.Settings
{
  ...
  public class GraphicsSettings : GlobalQualitySettings
  {
    ...
    [SettingsUIPlatform(Platform.PC, false)]
    [SettingsUISection("General", "UpscalersGroup")]
    [SettingsUIDisableByCondition(typeof (GraphicsSettings), "isFSRDisabled")]
    [SettingsUIHidden]
    public GraphicsSettings.Fsr2Quality fsr2Quality { get; set; }

    public bool isFsr2Active => this.m_Fsr2Quality >= 0;
    ...
    public override void Apply()
    {
      ...
      if (this.TryGetGameplayCamera(ref GraphicsSettings.m_Camera))
      {
        ...
        this.ApplyFSR2AutoSettings(GraphicsSettings.m_Camera);
      }
    ...
    private FSR2Quality ToFSR2Quality(GraphicsSettings.Fsr2Quality fsr2Quality)
    {
      switch (fsr2Quality)
      {
        case GraphicsSettings.Fsr2Quality.Quality:
          return FSR2Quality.Quality;
        case GraphicsSettings.Fsr2Quality.Balanced:
          return FSR2Quality.Balanced;
        case GraphicsSettings.Fsr2Quality.Performance:
          return FSR2Quality.Performance;
        case GraphicsSettings.Fsr2Quality.UltraPerformance:
          return FSR2Quality.UltraPerformance;
        default:
          throw new Exception(string.Format("Unsupported upscaler quality conversion {0}", (object) fsr2Quality));
      }
    }

    private void ApplyFSR2AutoSettings(Camera camera)
    {
      this.m_Fsr2Quality = -1;
      GraphicsSettings.Fsr2Quality fsr2Quality = this.fsr2Quality;
      if (fsr2Quality != GraphicsSettings.Fsr2Quality.Off)
        this.m_Fsr2Quality = (int) this.ToFSR2Quality(fsr2Quality);
      bool flag = this.m_Fsr2Quality >= 0;
      HDAdditionalCameraData component = camera.GetComponent<HDAdditionalCameraData>();
      component.allowFidelityFX2SuperResolution = flag;
      component.fidelityFX2SuperResolutionUseCustomQualitySettings = true;
      if (!flag)
        return;
      component.fidelityFX2SuperResolutionQuality = (uint) this.m_Fsr2Quality;
    }
    ...
    public override void SetDefaults()
    {
      ...
      this.fsr2Quality = GraphicsSettings.Fsr2Quality.Off;
      base.SetDefaults();
    }
