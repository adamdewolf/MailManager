        ...
        for (int index1 = 0; index1 < archetypeChunkArray.Length; ++index1)
        {
          ...
          else
          {
              ...
              if (component.m_SubNets != null)
              {
                ...
                for (int p2 = 0; p2 < component.m_SubNets.Length; ++p2)
                {
                  ...
                  if (!((UnityEngine.Object) netPrefab == (UnityEngine.Object) null))
                  {
                    ...
                    // ISSUE: reference to a compiler-generated field
                    // ISSUE: reference to a compiler-generated method
                    elem.m_Prefab = this.m_PrefabSystem.GetEntity((PrefabBase) netPrefab);
            ...
            for (int index6 = 0; index6 < bufferAccessor7.Length; ++index6)
            {
              ...
              if (component.m_SubLanes != null)
              {
                ...
                for (int index7 = 0; index7 < component.m_SubLanes.Length; ++index7)
                {
                  ...
                  if (!((UnityEngine.Object) lanePrefab == (UnityEngine.Object) null))
                  {
                    // ISSUE: reference to a compiler-generated field
                    // ISSUE: reference to a compiler-generated method
                    dynamicBuffer.Add(new SubLane()
                    {
                      m_Prefab = this.m_PrefabSystem.GetEntity((PrefabBase) lanePrefab),
              ...
              for (int index8 = 0; index8 < bufferAccessor2.Length; ++index8)
              {
                ...
                if (component.m_SubAreas != null)
                {
                  ...
                  for (int index9 = 0; index9 < component.m_SubAreas.Length; ++index9)
                  {
                    ...
                    if (!((UnityEngine.Object) subArea.m_AreaPrefab == (UnityEngine.Object) null))
                  ...
                  for (int index10 = 0; index10 < component.m_SubAreas.Length; ++index10)
                  {
                    ...
                    if (!((UnityEngine.Object) subArea.m_AreaPrefab == (UnityEngine.Object) null))
                    {
                      ...
                      // ISSUE: reference to a compiler-generated field
                      // ISSUE: reference to a compiler-generated method
                      elem.m_Prefab = this.m_PrefabSystem.GetEntity((PrefabBase) subArea.m_AreaPrefab);
            ...
            if (nativeArray4.Length != 0)
            {
              ...
              {
                Entity entity = nativeArray13[index13];
                ...
                if (component.m_Placeholders != null)
                {
                  for (int index14 = 0; index14 < component.m_Placeholders.Length; ++index14)
                  {
                    ...
                    if (!((UnityEngine.Object) placeholder == (UnityEngine.Object) null))
                    {
                      // ISSUE: reference to a compiler-generated field
                      // ISSUE: reference to a compiler-generated method
                      this.EntityManager.GetBuffer<PlaceholderObjectElement>(this.m_PrefabSystem.GetEntity((PrefabBase) placeholder)).Add(new PlaceholderObjectElement(entity));
                    }
                  }
                }
