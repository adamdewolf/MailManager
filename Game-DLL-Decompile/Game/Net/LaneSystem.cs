            ...
            if (nativeArray13.Length != 0)
            {
              ...
              if ((double) middleRadius > 0.0)
              {
                if (nativeList5.Length != 0 || nativeList6.Length != 0)
                {
                  ...
                  while (nativeList5.Length != 0 || nativeList6.Length != 0)
                  {
                    ...
                    // ISSUE: reference to a compiler-generated method
                    this.CreateRoundaboutCarLanes(chunkIndex, ref random, entity, laneBuffer1, ref num4, -1, ref laneGroup, connectPosition2, nextPosition2, middleConnections, nativeList7, nativeList8, nativeList4, roundaboutLane1, position, middleRadius, ref roundaboutLaneCount, laneCount1, spaceForLanes, nativeArray5.Length != 0, ownerTemp);
                  ...
                  // ISSUE: reference to a compiler-generated method
                  this.CreateRoundaboutCarLanes(chunkIndex, ref random, entity, laneBuffer1, ref num4, nextLaneIndex, ref laneGroup, connectPosition2, nextPosition1, middleConnections, nativeList7, nativeList8, nativeList4, roundaboutLane1, position, middleRadius, ref roundaboutLaneCount, laneCount1, spaceForLanes, nativeArray5.Length != 0, ownerTemp);
                  nativeList7.Clear();
                  nativeList8.Clear();
                }
              }
              else
              {
                ...
                for (int index12 = 0; index12 < nativeList5.Length; ++index12)
                {
                  ...
                  // ISSUE: reference to a compiler-generated method
                  this.ProcessCarConnectPositions(chunkIndex, ref nodeLaneIndex, ref random, entity, laneBuffer1, middleConnections, createdConnections, nativeList7, nativeList8, nativeList3, nativeArray5.Length != 0, ownerTemp, yieldOffset);
                  nativeList7.Clear();
                  for (int index13 = 0; index13 < nativeList6.Length; ++index13)
                  {
                    ...
                    if (((connectPosition3.m_LaneData.m_Flags | targetPosition.m_LaneData.m_Flags) & Game.Prefabs.LaneFlags.Master) != (Game.Prefabs.LaneFlags) 0)
                    {
                      ...
                      float curviness = -1f;
                      // ISSUE: reference to a compiler-generated method
                      if (this.CreateNodeLane(chunkIndex, ref nodeLaneIndex, ref random, ref curviness, entity, laneBuffer1, middleConnections, connectPosition3, targetPosition, group, (ushort) 0, isUnsafe, isForbidden, nativeArray5.Length != 0, false, 0, ownerTemp, isTurn, right, gentle, uturn, false, false, false, false, false, false))
                      {
                        // ISSUE: object of a compiler-generated type is created
        ...
        for (int index1 = 1; index1 <= num2; ++index1)
        {
          ...
          for (int a1 = 0; a1 < num5; ++a1)
          {
            ...
            if (num6 != a1)
            {
              ...
              // ISSUE: reference to a compiler-generated method
              this.CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, owner, laneBuffer, middleConnections, sourcePosition2, targetPosition2, laneGroup, (ushort) laneIndex, false, false, isTemp, false, 0, ownerTemp, false, false, false, false, true, a2, b2, false, false, true);
            }
            else
            {
              curviness = -1f;
              // ISSUE: reference to a compiler-generated method
              this.CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, owner, laneBuffer, middleConnections, sourcePosition1, targetPosition1, laneGroup, (ushort) laneIndex, false, false, isTemp, false, 0, ownerTemp, false, false, false, false, true, a2, b2, false, false, false);
            }
          }
          if (!isTemp && c1 | c2)
          {
            ...
            curviness = -1f;
            // ISSUE: reference to a compiler-generated method
            this.CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, owner, laneBuffer, middleConnections, sourcePosition1, targetPosition1, laneGroup, (ushort) 0, false, false, isTemp, false, 0, ownerTemp, false, false, false, false, true, false, false, false, false, false);
          }
          ++laneGroup;
          float num11 = 0.0f;
          Curve curve1;
          if (flag1)
          {
            ...
            for (int a3 = 0; a3 < num5; ++a3)
            {
              ...
              // ISSUE: reference to a compiler-generated method
              this.CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, owner, laneBuffer, middleConnections, sourcePosition3, targetPosition3, laneGroup, (ushort) laneIndex, false, false, isTemp, false, 1, ownerTemp, false, false, false, false, true, a5, b3, false, false, true);
            }
            if (flag4)
            {
              ...
              curviness = -1f;
              // ISSUE: reference to a compiler-generated method
              this.CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, owner, laneBuffer, middleConnections, sourcePosition4, targetPosition4, laneGroup, (ushort) 0, false, false, isTemp, false, 1, ownerTemp, false, false, false, false, true, false, false, false, false, true);
            }
            ++laneGroup;
          }
          if (flag2)
          {
            ...
            for (int a6 = 0; a6 < targetBuffer.Length; ++a6)
            {
              ...
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated method
              this.CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, owner, laneBuffer, middleConnections, sourcePosition5, targetPosition5, laneGroup, (ushort) laneIndex, isUnsafe, false, isTemp, false, -1, ownerTemp, true, !this.m_LeftHandTraffic, true, false, true, a7, b4, isUnsafe && this.m_LeftHandTraffic, isUnsafe && !this.m_LeftHandTraffic, true);
            }
            if (flag5)
            {
              ...
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated method
              this.CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, owner, laneBuffer, middleConnections, sourcePosition6, targetPosition6, laneGroup, (ushort) 0, false, false, isTemp, false, -1, ownerTemp, true, !this.m_LeftHandTraffic, true, false, true, false, false, false, false, true);
            }
            ++laneGroup;
          }
          if (flag3)
          {
            ...
            for (int a10 = 0; a10 < targetBuffer.Length; ++a10)
            {
              ...
              if (a10 == 0)
              {
                ...
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated method
                this.CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, owner, laneBuffer, middleConnections, sourcePosition7, targetPosition7, laneGroup, (ushort) laneIndex, false, false, isTemp, false, 1, ownerTemp, true, !this.m_LeftHandTraffic, false, false, true, a12, b5, false, false, true);
              }
              bool a13 = false;
              ...
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated method
              this.CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, owner, laneBuffer, middleConnections, sourcePosition7, targetPosition8, laneGroup + 1U, (ushort) laneIndex, isUnsafe, false, isTemp, false, 0, ownerTemp, true, !this.m_LeftHandTraffic, false, false, true, a13, b6, isUnsafe && !this.m_LeftHandTraffic, isUnsafe && this.m_LeftHandTraffic, true);
            }
            if (flag6)
            {
              ...
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated method
              this.CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, owner, laneBuffer, middleConnections, sourcePosition7, targetPosition9, laneGroup, (ushort) 0, false, false, isTemp, false, 1, ownerTemp, true, !this.m_LeftHandTraffic, false, false, true, false, false, false, false, true);
            }
            if (flag7)
            {
              sourcePosition7 = connectPosition2;
              ...
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated method
              this.CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, owner, laneBuffer, middleConnections, sourcePosition7, targetPosition10, laneGroup + 1U, (ushort) 0, false, false, isTemp, false, 0, ownerTemp, true, !this.m_LeftHandTraffic, false, false, true, false, false, false, false, true);
            }
            laneGroup += 2U;
          }
          fromVector = forward1;
...
label_51:
        ...
        for (int index = 0; index < prefabCompositionLanes.Length; ++index)
        {
          ...
          if ((prefabCompositionLane.m_Flags & laneType) != (Game.Prefabs.LaneFlags) 0)
          {
            if ((laneFlags & Game.Prefabs.LaneFlags.Master) != (Game.Prefabs.LaneFlags) 0)
            {
              ...
              continue;
            if ((double) math.cmin(math.abs(new float2(offset.y, elevationOffset) - prefabCompositionLane.m_Position.yy)) < 2.0)
            {
              float num2 = math.abs(prefabCompositionLane.m_Position.x - offset.x);
              if ((double) num2 < (double) num1)
              {
                num1 = num2;
        ...
        int yield)
      {
        ...
        // ISSUE: reference to a compiler-generated method
        this.CreateNodeCarLanes(jobIndex, ref nodeLaneIndex, ref random, owner, laneBuffer, middleConnections, createdConnections, sourceBuffer, targetBuffer, allSources, isTemp, ownerTemp, yield);
      }
        ...
        for (int index1 = 0; index1 < sourceBuffer.Length; ++index1)
        {
          ...
          for (int index2 = 0; index2 < x2; ++index2)
          {
            ...
            if (!createdConnections.Contains(new LaneSystem.ConnectionKey(sourcePosition, targetPosition)))
            {
              ...
              float curviness = -1f;
              // ISSUE: reference to a compiler-generated method
              this.CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, owner, laneBuffer, middleConnections, sourcePosition, targetPosition, 0U, (ushort) 0, false, false, isTemp, true, 0, ownerTemp, isTurn, right, gentle, uturn, false, isLeftLimit, isRightLimit, false, false, false);
            }
          }
        }
      }
