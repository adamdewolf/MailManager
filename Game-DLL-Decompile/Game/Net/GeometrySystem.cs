  ...
  public class GeometrySystem : GameSystemBase
  {
    ...
    private struct CalculateNodeGeometryJob : IJobParallelForDefer
    {
      ...
      public void Execute(int index)
      {
        ...
        // ISSUE: reference to a compiler-generated method
        this.AdjustSegmentWidth(ref segment1, edgeCompositionData, netCompositionData1);
        // ISSUE: reference to a compiler-generated method
        this.AdjustSegmentWidth(ref end, edgeCompositionData, netCompositionData2);
      ...
      private float3 FindMiddleNodePos(Entity edge, Entity node)
      {
        ...
        while (edgeIterator.GetNext(out edgeIteratorValue))
        {
          ...
          {
            // ISSUE: reference to a compiler-generated field
            NetCompositionData netCompositionData = this.m_PrefabCompositionData[composition.m_EndNode];
      ...
      private void AdjustSegmentWidth(
        ...
        NetCompositionData nodeCompositionData)
      {
        if ((double) math.abs(nodeCompositionData.m_Width - edgeCompositionData.m_Width) <= 1.0 / 1000.0)
          return;
        float t = (float) ((1.0 - (double) nodeCompositionData.m_Width / (double) edgeCompositionData.m_Width) * 0.5);
        Bezier4x3 bezier4x3 = MathUtils.Lerp(segment.m_Left, segment.m_Right, t);
        segment.m_Right = MathUtils.Lerp(segment.m_Right, segment.m_Left, t);
        segment.m_Left = bezier4x3;
      }
        ...
        out bool2 middleConnect)
      {
        ...
        while (edgeIterator.GetNext(out edgeIteratorValue3))
        {
          ...
          else if (!edgeIteratorValue1.m_Middle)
          {
            ...
            // ISSUE: reference to a compiler-generated method
            this.AdjustSegmentWidth(ref segment, edgeCompositionData, nodeCompositionData);
        ...
        out float divPos)
      {
        ...
        float divPos1;
        // ISSUE: reference to a compiler-generated method
        Bezier4x3 middleCurve = this.CalculateMiddleCurve(startCurve, endCurve, out divPos1);
        Bezier4x3 output1;
        Bezier4x3 output2;
        ...
        float num1 = math.select(math.distance(middleCurve.d.xz, nodePosition.xz), 0.0f, (double) math.dot(middleCurve.d.xz - nodePosition.xz, float2_2) <= 0.0);
    ...
    private struct CalculateIntersectionGeometryJob : IJobParallelForDefer
    {
      ...
      public void Execute(int index)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        NetGeometryData netGeometryData = this.m_PrefabGeometryData[this.m_PrefabRefData[entity].m_Prefab];
        // ISSUE: reference to a compiler-generated field
        NetCompositionData netCompositionData1 = this.m_PrefabCompositionData[composition.m_StartNode];
        // ISSUE: reference to a compiler-generated field
        NetCompositionData netCompositionData2 = this.m_PrefabCompositionData[composition.m_EndNode];
        ...
        {
          // ISSUE: reference to a compiler-generated method
          float3_1 = this.FindIntersectionPos(entity, edge.m_Start);
          if (edges1)
        ...
        {
          // ISSUE: reference to a compiler-generated method
          float3_2 = this.FindIntersectionPos(entity, edge.m_End);
          if (edges2)
      ...
      private float3 FindIntersectionPos(Entity edge, Entity node)
      {
