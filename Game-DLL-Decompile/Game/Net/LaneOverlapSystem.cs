...
label_66:
        ...
        {
          // ISSUE: reference to a compiler-generated field
          NativeArray<MasterLane> nativeArray9 = chunk.GetNativeArray<MasterLane>(ref this.m_MasterLaneType);
          // ISSUE: reference to a compiler-generated field
          ...
          for (int index1 = 0; index1 < nativeArray3.Length; ++index1)
          {
            ...
            {
              MasterLane masterLane = nativeArray9[index1];
    ...
    private struct UpdateLaneOverlapsJob : IJobParallelForDefer
    {
      ...
      private void UpdateOverlaps(DynamicBuffer<SubLane> lanes, bool isEdge)
      {
        for (int index1 = 0; index1 < lanes.Length; ++index1)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          if (this.m_Overlaps.HasBuffer(subLane1) && !this.m_SecondaryLaneData.HasComponent(subLane1))
          {
            // ISSUE: reference to a compiler-generated field
            PrefabRef prefabRef1 = this.m_PrefabRefData[subLane1];
            // ISSUE: reference to a compiler-generated field
            DynamicBuffer<LaneOverlap> overlap1 = this.m_Overlaps[subLane1];
            // ISSUE: reference to a compiler-generated field
            ...
            if ((netLaneData1.m_Flags & (LaneFlags.Parking | LaneFlags.Virtual)) != (LaneFlags.Parking | LaneFlags.Virtual))
            {
              ...
              // ISSUE: reference to a compiler-generated field
              bool flag1 = this.m_NodeLaneData.HasComponent(subLane1);
              NodeLane nodeLane1 = new NodeLane();
              if (flag1)
              {
                // ISSUE: reference to a compiler-generated field
                nodeLane1 = this.m_NodeLaneData[subLane1];
              }
              overlap1.Clear();
              nodeLane1.m_SharedStartCount = (byte) 0;
              nodeLane1.m_SharedEndCount = (byte) 0;
              for (int index2 = 0; index2 < index1; ++index2)
              {
                Entity subLane2 = lanes[index2].m_SubLane;
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                if (this.m_Overlaps.HasBuffer(subLane2) && !this.m_SecondaryLaneData.HasComponent(subLane2))
                {
                  // ISSUE: reference to a compiler-generated field
                  ...
                  // ISSUE: reference to a compiler-generated field
                  DynamicBuffer<LaneOverlap> overlap2 = this.m_Overlaps[subLane2];
                  // ISSUE: reference to a compiler-generated field
                  NetLaneData netLaneData2 = this.m_PrefabLaneData[prefabRef2.m_Prefab];
                  if ((netLaneData2.m_Flags & LaneFlags.Parking) != (LaneFlags) 0)
                  {
                    if ((netLaneData1.m_Flags & LaneFlags.Road) == (LaneFlags) 0 || !flag1 || (netLaneData2.m_Flags & LaneFlags.Virtual) != (LaneFlags) 0)
                      continue;
                  }
                  ...
                  // ISSUE: reference to a compiler-generated field
                  bool flag2 = this.m_NodeLaneData.HasComponent(subLane2);
                  NodeLane nodeLane2 = new NodeLane();
                  if (flag2)
                  {
                    // ISSUE: reference to a compiler-generated field
                    nodeLane2 = this.m_NodeLaneData[subLane2];
                  }
                  else if ((netLaneData1.m_Flags & LaneFlags.Parking) != (LaneFlags) 0 || isEdge && !flag1)
                    continue;
                  Bezier4x2 xz1 = curve1.m_Bezier.xz;
                  Bezier4x2 xz2 = curve2.m_Bezier.xz;
                  float2 radius1 = (netLaneData1.m_Width + nodeLane1.m_WidthOffset) * 0.4f;
                  float2 radius2 = (netLaneData2.m_Width + nodeLane2.m_WidthOffset) * 0.4f;
                  float4 t;
                  // ISSUE: reference to a compiler-generated method
                  if (LaneOverlapSystem.UpdateLaneOverlapsJob.FindOverlapRange(xz1, xz2, radius1, radius2, out t))
                  {
                    // ISSUE: reference to a compiler-generated method
                    ...
                    if (((flags1 | flags2) & (OverlapFlags.MergeStart | OverlapFlags.MergeEnd)) == (OverlapFlags) 0)
                    {
                      ...
                      float2 float2_2 = math.max((float2) 1f, float2_1 * (t.yw - t.xz));
                      float2_1 = float2_2 * (parallelism / float2_2.yx);
                    ...
                    else
                    {
                      ...
                      if ((carLaneFlags & CarLaneFlags.Unsafe) == ~(CarLaneFlags.Unsafe | CarLaneFlags.UTurnLeft | CarLaneFlags.Invert | CarLaneFlags.SideConnection | CarLaneFlags.TurnLeft | CarLaneFlags.TurnRight | CarLaneFlags.LevelCrossing | CarLaneFlags.Twoway | CarLaneFlags.IsSecured | CarLaneFlags.Runway | CarLaneFlags.Yield | CarLaneFlags.Stop | CarLaneFlags.ForbidCombustionEngines | CarLaneFlags.ForbidTransitTraffic | CarLaneFlags.ForbidHeavyTraffic | CarLaneFlags.PublicOnly | CarLaneFlags.Highway | CarLaneFlags.UTurnRight | CarLaneFlags.GentleTurnLeft | CarLaneFlags.GentleTurnRight | CarLaneFlags.Forward | CarLaneFlags.Approach | CarLaneFlags.Roundabout | CarLaneFlags.RightLimit | CarLaneFlags.LeftLimit | CarLaneFlags.ForbidPassing | CarLaneFlags.RightOfWay | CarLaneFlags.TrafficLights | CarLaneFlags.ParkingLeft | CarLaneFlags.ParkingRight | CarLaneFlags.Forbidden | CarLaneFlags.AllowEnter) && (laneFlags & LaneFlags.Road) == (LaneFlags) 0)
                      {
                        if ((flags1 & OverlapFlags.MergeStart) != (OverlapFlags) 0)
                          nodeLane1.m_SharedStartCount = (byte) math.min((int) byte.MaxValue, (int) nodeLane1.m_SharedStartCount + 1);
                        if ((flags2 & OverlapFlags.MergeStart) != (OverlapFlags) 0)
                          nodeLane2.m_SharedStartCount = (byte) math.min((int) byte.MaxValue, (int) nodeLane2.m_SharedStartCount + 1);
                        if ((flags1 & OverlapFlags.MergeEnd) != (OverlapFlags) 0)
                          nodeLane1.m_SharedEndCount = (byte) math.min((int) byte.MaxValue, (int) nodeLane1.m_SharedEndCount + 1);
                        if ((flags2 & OverlapFlags.MergeEnd) != (OverlapFlags) 0)
                          nodeLane2.m_SharedEndCount = (byte) math.min((int) byte.MaxValue, (int) nodeLane2.m_SharedEndCount + 1);
                        if (flag2)
                        {
                          // ISSUE: reference to a compiler-generated field
                          this.m_NodeLaneData[subLane2] = nodeLane2;
                        }
                      }
                      float2 forward;
                      ...
                      bool flag3 = (double) math.dot(MathUtils.Right(forward), y1) > 0.0 == ((flags1 & OverlapFlags.MergeFlip) == (OverlapFlags) 0);
                      if ((flags1 & OverlapFlags.MergeStart) != (OverlapFlags) 0)
                      {
                        t.x = 0.0f;
                        flags1 |= flag3 ? OverlapFlags.OverlapRight : OverlapFlags.OverlapLeft;
                      }
                      if ((flags2 & OverlapFlags.MergeStart) != (OverlapFlags) 0)
                      {
                        t.z = 0.0f;
                        flags2 |= flag3 ? OverlapFlags.OverlapLeft : OverlapFlags.OverlapRight;
                      }
                      if ((flags1 & OverlapFlags.MergeEnd) != (OverlapFlags) 0)
                      {
                        t.y = 1f;
                        flags1 |= flag3 ? OverlapFlags.OverlapLeft : OverlapFlags.OverlapRight;
                      }
                      if ((flags2 & OverlapFlags.MergeEnd) != (OverlapFlags) 0)
                      {
                        t.w = 1f;
                        flags2 |= flag3 ? OverlapFlags.OverlapRight : OverlapFlags.OverlapLeft;
                      }
                    }
                    int priorityDelta = 0;
                    ...
                    else if ((flags1 & (OverlapFlags.MergeStart | OverlapFlags.MergeMiddleStart)) == (OverlapFlags) 0)
                    {
                      ...
                      {
                        float2 float2_3 = math.lerp(t.xz, t.yw, 0.5f);
                        float3 = MathUtils.Tangent(curve1.m_Bezier, float2_3.x);
                        float2 xz11 = float3.xz;
                        float3 = MathUtils.Tangent(curve2.m_Bezier, float2_3.y);
                    ...
                    if ((netLaneData2.m_Flags & LaneFlags.Parking) == (LaneFlags) 0)
                      overlap1.Add(new LaneOverlap(subLane2, t, flags1, float2_1.x, priorityDelta));
                    if ((netLaneData1.m_Flags & LaneFlags.Parking) == (LaneFlags) 0)
                      overlap2.Add(new LaneOverlap(subLane1, t.zwxy, flags2, float2_1.y, -priorityDelta));
                  }
                }
              }
              if (flag1)
              {
                // ISSUE: reference to a compiler-generated field
                this.m_NodeLaneData[subLane1] = nodeLane1;
              }
            }
          }
        }
        for (int index = 0; index < lanes.Length; ++index)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          if (this.m_Overlaps.HasBuffer(subLane) && !this.m_SecondaryLaneData.HasComponent(subLane))
          {
            // ISSUE: reference to a compiler-generated field
            this.m_Overlaps[subLane].AsNativeArray().Sort<LaneOverlap>();
          }
        }
      }
        ...
        out float4 t)
      {
        ...
        *(LaneOverlapSystem.UpdateLaneOverlapsJob.FindOverlapStackItem*) ((IntPtr) overlapStackItemPtr2 + num4) = new LaneOverlapSystem.UpdateLaneOverlapsJob.FindOverlapStackItem()
        ...
        while (num3 != 0)
        {
          ...
          float num5 = math.cmax(x2) + math.cmax(x3);
          if ((double) MathUtils.DistanceSquared(bounds2_1, bounds2_2) < (double) num5 * (double) num5)
          {
            ...
            {
              // ISSUE: reference to a compiler-generated field
              float2 float2_3 = MathUtils.Right(MathUtils.StartTangent(local.m_Curve1));
              // ISSUE: reference to a compiler-generated field
              float2 float2_4 = MathUtils.Right(MathUtils.EndTangent(local.m_Curve1));
              // ISSUE: reference to a compiler-generated field
              float2 float2_5 = MathUtils.Right(MathUtils.StartTangent(local.m_Curve2));
              // ISSUE: reference to a compiler-generated field
              float2 float2_6 = MathUtils.Right(MathUtils.EndTangent(local.m_Curve2));
              MathUtils.TryNormalize(ref float2_3);
              MathUtils.TryNormalize(ref float2_4);
              MathUtils.TryNormalize(ref float2_5);
              MathUtils.TryNormalize(ref float2_6);
              float2_3 *= x2.x;
              float2 float2_7 = float2_4 * x2.y;
              float2 float2_8 = float2_5 * x3.x;
              float2 float2_9 = float2_6 * x3.y;
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              Quad2 quad2_1 = new Quad2(local.m_Curve1.a + float2_3, local.m_Curve1.d + float2_7, local.m_Curve1.d - float2_7, local.m_Curve1.a - float2_3);
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              Quad2 quad2_2 = new Quad2(local.m_Curve2.a + float2_8, local.m_Curve2.d + float2_9, local.m_Curve2.d - float2_9, local.m_Curve2.a - float2_8);
              ...
              MathUtils.Expand(bounds2_1, (float2) math.cmax(x2));
              Bounds2 bounds2_3 = MathUtils.Expand(bounds2_2, (float2) math.cmax(x3));
              float2 t1;
