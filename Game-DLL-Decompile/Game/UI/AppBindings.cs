...
namespace Game.UI
{
  public class AppBindings : CompositeBinding, IDisposable
  {
    ...
    private Action<int, bool> m_DismissableConfirmationDialogCallback;
    ...
    public AppBindings()
    {
      ...
      this.AddBinding((IBinding) new TriggerBinding<int, bool>("app", "dismissableConfirmationDialogCallback", new Action<int, bool>(this.OnDismissableConfirmationDialogCallback)));
    ...
    public void ShowConfirmationDialog([NotNull] ConfirmationDialogWithDetails dialog, [NotNull] Action<int> callback)
    {
      this.m_ConfirmationDialogCallback = callback;
      this.m_ConfirmationDialogBinding.Trigger((ConfirmationDialogBase) dialog);
    }
    ...
    public void ShowMessageDialog([NotNull] MessageDialogWithDetails dialog, Action<int> callback)
    {
      this.m_ConfirmationDialogCallback = callback;
      this.m_ConfirmationDialogBinding.Trigger((ConfirmationDialogBase) dialog);
    }
    ...
    public void ShowConfirmationDialog(
      [NotNull] DismissableConfirmationDialog dialog,
      [NotNull] Action<int, bool> callback)
    {
      this.m_DismissableConfirmationDialogCallback = callback;
      this.m_ConfirmationDialogBinding.Trigger((ConfirmationDialogBase) dialog);
    }
    ...
    private void OnDismissableConfirmationDialogCallback(int msg, bool dontShowAgain)
    {
      if (this.m_DismissableConfirmationDialogCallback == null)
        return;
      Action<int, bool> confirmationDialogCallback = this.m_DismissableConfirmationDialogCallback;
      this.m_DismissableConfirmationDialogCallback = (Action<int, bool>) null;
      int num1 = msg;
