...
namespace Game.UI.Editor
{
  public class TerrainPanelSystem : EditorPanelSystemBase
  {
    ...
    private void DisplayHeightmapError()
    {
      ...
      }), LocalizedString.Id("Common.ERROR_DIALOG_CONTINUE")), (Action<int>) null);
    }
