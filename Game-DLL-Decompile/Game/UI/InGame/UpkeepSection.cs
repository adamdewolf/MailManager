...
namespace Game.UI.InGame
{
  ...
  public class UpkeepSection : InfoSectionBase
  {
      ...
      bool inactiveUpgrade)
    {
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated method
      PrefabBase prefab = this.m_PrefabSystem.GetPrefab<PrefabBase>(prefabEntity);
      for (int index = 0; index < serviceUpkeepDatas.Length; ++index)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated method
        this.m_PrefabUISystem.GetTitleAndDescription(prefab, out titleId, out descriptionId);
        // ISSUE: reference to a compiler-generated field
        if (!this.m_BudgetDataQuery.IsEmptyIgnoreFilter && resource == Resource.Money)
        {
          ...
          if (!this.moneyUpkeep.TryGetValue(prefab.name, out uiUpkeepItem))
            this.moneyUpkeep[prefab.name] = uiUpkeepItem;
          Dictionary<string, UpkeepSection.UIUpkeepItem> moneyUpkeep = this.moneyUpkeep;
          descriptionId = prefab.name;
