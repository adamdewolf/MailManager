...
namespace Game.UI.InGame
{
  ...
  public class PoliciesUISystem : UISystemBase
  {
    ...
    protected override void OnCreate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated method
      this.AddBinding((IBinding) new TriggerBinding<Entity, bool, float>("policies", "setPolicy", (Action<Entity, bool, float>) ((Entity policy, bool active, float adjustment = 0.0f) => this.ModifyPolicy(this.m_InfoSystem.selectedEntity, policy, active, adjustment))));
