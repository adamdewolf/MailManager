...
namespace Game.UI.InGame
{
  ...
  {
    public static int GetAvailableVehicles(Entity entity, EntityManager entityManager)
    {
      float efficiency = 1f;
      DynamicBuffer<Efficiency> buffer;
      if (entityManager.TryGetBuffer<Efficiency>(entity, true, out buffer))
      ...
      if (entityManager.TryGetComponent<PrefabRef>(entity, out component1))
      {
        ...
        if (UpgradeUtils.TryGetCombinedComponent<GarbageFacilityData>(entityManager, entity, component1.m_Prefab, out data1))
        {
        ...
        else
        {
          ...
          if (UpgradeUtils.TryGetCombinedComponent<DeathcareFacilityData>(entityManager, entity, component1.m_Prefab, out data2))
          {
          ...
          else
          {
            ...
            if (UpgradeUtils.TryGetCombinedComponent<EmergencyShelterData>(entityManager, entity, component1.m_Prefab, out data3))
            {
            ...
            else
            {
              ...
              if (UpgradeUtils.TryGetCombinedComponent<FireStationData>(entityManager, entity, component1.m_Prefab, out data4))
              {
              ...
              {
                HospitalData data5;
                if (UpgradeUtils.TryGetCombinedComponent<HospitalData>(entityManager, entity, component1.m_Prefab, out data5))
                {
                ...
                else
                {
                  ...
                  if (UpgradeUtils.TryGetCombinedComponent<MaintenanceDepotData>(entityManager, entity, component1.m_Prefab, out data6))
                  {
                  ...
                  else
                  {
                    ...
                    if (UpgradeUtils.TryGetCombinedComponent<PoliceStationData>(entityManager, entity, component1.m_Prefab, out data7))
                    {
                    ...
                    {
                      PrisonData data8;
                      if (UpgradeUtils.TryGetCombinedComponent<PrisonData>(entityManager, entity, component1.m_Prefab, out data8))
                      {
                      ...
                      else
                      {
                        ...
                        if (UpgradeUtils.TryGetCombinedComponent<TransportDepotData>(entityManager, entity, component1.m_Prefab, out data9))
                        {
                        ...
                        else
                        {
                          ...
                          if (UpgradeUtils.TryGetCombinedComponent<PostFacilityData>(entityManager, entity, component1.m_Prefab, out data10))
                          {
      ...
      EntityManager entityManager)
    {
      ...
      if ((policeCar.m_State & PoliceCarFlags.Returning) != (PoliceCarFlags) 0)
        return VehicleStateLocaleKey.Returning;
      if ((policeCar.m_State & PoliceCarFlags.AccidentTarget) == (PoliceCarFlags) 0 || policeCar.m_RequestCount <= 0 || dispatches.Length <= 0)
