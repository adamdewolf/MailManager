  ...
  public class PrefabUISystem : UISystemBase
  {
    ...
    public void BindPrefabDetails(IJsonWriter writer, Entity entity, bool uniquePlaced)
    {
      ...
      else
      {
        ...
        if (entityManager.Exists(entity) && this.EntityManager.TryGetComponent<PrefabData>(entity1, out component1) && this.EntityManager.TryGetComponent<PrefabData>(entity, out component2))
        {
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated method
          ...
          // ISSUE: reference to a compiler-generated method
          this.GetTitleAndDescription(prefab2, out titleId, out descriptionId);
