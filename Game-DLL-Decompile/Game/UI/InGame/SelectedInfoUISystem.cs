...
namespace Game.UI.InGame
{
  ...
  public class SelectedInfoUISystem : UISystemBase
  {
    ...
    {
      // ISSUE: reference to a compiler-generated field
      if (!this.EntityManager.Exists(entity) || !((UnityEngine.Object) SelectedInfoUISystem.s_CameraController != (UnityEngine.Object) null))
        return;
      // ISSUE: reference to a compiler-generated field
    ...
    private void RefreshSelection()
    {
      ...
      if (this.TryGetSelection(out entity) && this.EntityManager.TryGetComponent<PrefabRef>(entity, out component))
      {
        ...
        Bounds3 bounds;
        // ISSUE: reference to a compiler-generated method
        if (SelectedInfoUISystem.TryGetPosition(entity, this.EntityManager, out Entity _, out position, out bounds, out quaternion _, true) || this.EntityManager.HasComponent<Household>(entity))
        {
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              {
                // ISSUE: reference to a compiler-generated method
                position = SelectedInfoUISystem.GetAggregatePosition(buffer3);
                bounds = new Bounds3(position, position);
                rotation = quaternion.identity;
              }
              else
    ...
    private static float3 GetAggregatePosition(DynamicBuffer<LabelPosition> labelPositions)
    {
      ...
      {
        float3 x = MathUtils.Position(labelPositions[index].m_Curve, 0.5f);
        float num2 = math.distancesq(x, y);
        if ((double) num2 < (double) num1)
        {
          aggregatePosition = x;
          num1 = num2;
    ...
    private static void FilterPositionTarget(ref Entity entity, EntityManager entityManager)
    {
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                {
                  AircraftCurrentLane component12;
                  if (entityManager.TryGetComponent<AircraftCurrentLane>(entity, out component12))
                  {
                    // ISSUE: reference to a compiler-generated method
                    SelectedInfoUISystem.FilterPositionTarget(out entity, component12.m_Lane, entityManager);
                  }
                  else
                  {
                    WatercraftCurrentLane component13;
                    if (entityManager.TryGetComponent<WatercraftCurrentLane>(entity, out component13))
                    {
                      // ISSUE: reference to a compiler-generated method
      ...
      CurrentBuilding component14;
      if (entityManager.TryGetComponent<CurrentBuilding>(entity, out component14))
        entity = component14.m_CurrentBuilding;
      PropertyRenter component15;
      if (entityManager.TryGetComponent<PropertyRenter>(entity, out component15))
        entity = component15.m_Property;
      TouristHousehold component16;
      if (!entityManager.TryGetComponent<TouristHousehold>(entity, out component16))
        return;
      entity = component16.m_Hotel;
    }
