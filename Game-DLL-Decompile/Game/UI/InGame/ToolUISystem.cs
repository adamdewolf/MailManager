...
namespace Game.UI.InGame
{
  public class ToolUISystem : UISystemBase
  {
    ...
    {
      GameManager.instance.userInterface.appBindings.ShowConfirmationDialog(new ConfirmationDialog((LocalizedString) (string) null, (LocalizedString) "Common.DIALOG_MESSAGE[Bulldozer]", (LocalizedString) "Common.DIALOG_ACTION[Yes]", (LocalizedString) "Common.DIALOG_ACTION[No]", System.Array.Empty<LocalizedString>()), new Action<int>(this.OnConfirmBulldoze));
    }
