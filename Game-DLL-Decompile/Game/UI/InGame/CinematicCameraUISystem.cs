...
namespace Game.UI.InGame
{
  ...
  public class CinematicCameraUISystem : UISystemBase
  {
    ...
    protected override void OnCreate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.AddBinding((IBinding) new TriggerBinding<string, string>(CinematicCameraUISystem.kGroup, "save", (Action<string, string>) ((string name, string hash = null) =>
      {
        ...
        {
          Colossal.Hash128 id = new Colossal.Hash128(hash);
          CinematicCameraAsset asset = db.GetAsset<CinematicCameraAsset>(id);
      ...
      {
        Colossal.Hash128 id = new Colossal.Hash128(hash);
        CinematicCameraAsset asset = MenuHelpers.GetSanitizedCloudTarget(storage).db.GetAsset<CinematicCameraAsset>(id);
        if (!((AssetData) asset != (IAssetData) null))
          return;
        asset.Load();
      ...
      {
        Colossal.Hash128 id = new Colossal.Hash128(hash);
        MenuHelpers.GetSanitizedCloudTarget(storage).db.DeleteAsset(id);
        // ISSUE: reference to a compiler-generated field
        this.m_Assets.Update();
      })));
      // ISSUE: reference to a compiler-generated field
