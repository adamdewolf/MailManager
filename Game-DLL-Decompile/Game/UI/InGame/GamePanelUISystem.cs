...
namespace Game.UI.InGame
{
  ...
  public class GamePanelUISystem : UISystemBase, IPreDeserialize
  {
    ...
    protected override void OnCreate()
    {
      ...
      this.AddBinding((IBinding) new TriggerBinding<string>("game", "togglePanel", (Action<string>) (([CanBeNull] panelType) =>
      {
        // ISSUE: reference to a compiler-generated field
    ...
    protected override void OnUpdate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      Barrier toolBarrier = this.m_ToolBarrier;
      GamePanel activePanel = this.activePanel;
