  ...
  public class ToolbarUISystem : UISystemBase, IPreDeserialize
  {
    ...
    protected override void OnCreate()
    {
      ...
      this.AddBinding((IBinding) new TriggerBinding<List<Entity>>("toolbar", "setSelectedThemes", (Action<List<Entity>>) (themes =>
      {
        ...
        // ISSUE: reference to a compiler-generated method
        this.ActivatePrefabTool(entity13);
        // ISSUE: reference to a compiler-generated method
        this.Apply(themes, selectedAssetPacks, assetMenuEntity, entity12, entity13);
      ...
      this.AddBinding((IBinding) new TriggerBinding<List<Entity>>("toolbar", "setSelectedAssetPacks", (Action<List<Entity>>) (packs =>
      {
        ...
        // ISSUE: reference to a compiler-generated method
        this.ActivatePrefabTool(entity15);
        // ISSUE: reference to a compiler-generated method
        this.Apply(selectedThemes, packs, assetMenuEntity, entity14, entity15);
      }), (IReader<List<Entity>>) new ListReader<Entity>()));
      this.AddBinding((IBinding) new TriggerBinding<Entity>("toolbar", "selectAssetMenu", (Action<Entity>) (assetMenu =>
      {
        ...
        // ISSUE: reference to a compiler-generated method
        this.ActivatePrefabTool(entity17);
        // ISSUE: reference to a compiler-generated method
        this.Apply(selectedThemes, selectedAssetPacks, entity16, firstItem, entity17);
      })));
      this.AddBinding((IBinding) new TriggerBinding<Entity>("toolbar", "selectAssetCategory", (Action<Entity>) (assetCategory =>
      {
        ...
        // ISSUE: reference to a compiler-generated method
        this.Apply(selectedThemes, selectedAssetPacks, menu, entity, assetEntity);
      })));
      // ISSUE: reference to a compiler-generated method
      this.AddBinding((IBinding) new TriggerBinding<Entity>("toolbar", "selectAsset", (Action<Entity>) (asset => this.SelectAsset(asset, true))));
      // ISSUE: reference to a compiler-generated method
    ...
    protected override void OnUpdate()
    {
      ...
      {
        if (assetEntity != Entity.Null && entity1 != Entity.Null && (UnityEngine.Object) activePrefab == (UnityEngine.Object) null)
        {
          // ISSUE: reference to a compiler-generated method
          this.ActivatePrefabTool(assetEntity);
        }
    ...
    private void SetSelectedThemes(List<Entity> themes)
    {
      ...
      // ISSUE: reference to a compiler-generated method
      this.ActivatePrefabTool(entity2);
      // ISSUE: reference to a compiler-generated method
      this.Apply(themes, selectedAssetPacks, assetMenuEntity, entity1, entity2);
    }
    ...
    private void SetSelectedAssetPacks(List<Entity> packs)
    {
      ...
      this.ActivatePrefabTool(entity2);
      // ISSUE: reference to a compiler-generated method
      this.Apply(selectedThemes, packs, assetMenuEntity, entity1, entity2);
    }
    ...
    private void SelectAssetMenu(Entity assetMenu)
    {
      ...
      this.ActivatePrefabTool(entity2);
      // ISSUE: reference to a compiler-generated method
      this.Apply(selectedThemes, selectedAssetPacks, entity1, firstItem, entity2);
    }
    ...
    private void SelectAsset(Entity asset) => this.SelectAsset(asset, true);

    private void SelectAsset(Entity assetEntity, bool updateTool)
    {
      UIObjectData component1;
      if (!(assetEntity != Entity.Null) || !this.EntityManager.TryGetComponent<UIObjectData>(assetEntity, out component1))
        return;
      // ISSUE: reference to a compiler-generated field
      ...
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated method
      if (!this.IsMatchingAssetCategory(assetEntity, this.m_SelectedAssetCategoryBinding.value))
      {
      ...
      // ISSUE: reference to a compiler-generated method
      this.Apply(themes, packs, menu, group, assetEntity);
    }
    ...
    private void ClearAssetSelection(bool updateTool)
    {
      ...
      {
        // ISSUE: reference to a compiler-generated method
        this.ActivatePrefabTool(Entity.Null);
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated method
