...
namespace Game.Serialization
{
  ...
  public class PrimaryPrefabReferencesSystem : GameSystemBase
  {
    ...
    protected override void OnCreate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.m_PrefabRefQuery = this.GetEntityQuery(ComponentType.ReadOnly<PrefabRef>(), ComponentType.Exclude<NetCompositionData>());
      // ISSUE: reference to a compiler-generated field
      this.m_SetLevelQuery = this.GetEntityQuery(ComponentType.ReadOnly<UnderConstruction>());
      // ISSUE: reference to a compiler-generated field
      this.m_CompanyDataQuery = this.GetEntityQuery(ComponentType.ReadOnly<CompanyData>());
      // ISSUE: reference to a compiler-generated field
      this.m_PolicyQuery = this.GetEntityQuery(ComponentType.ReadOnly<Policy>());
      // ISSUE: reference to a compiler-generated field
      ...
      // ISSUE: reference to a compiler-generated field
      this.m_VehicleModelQuery = this.GetEntityQuery(ComponentType.ReadOnly<VehicleModel>());
      // ISSUE: reference to a compiler-generated field
      this.m_EditorContainerQuery = this.GetEntityQuery(ComponentType.ReadOnly<Game.Tools.EditorContainer>());
      // ISSUE: reference to a compiler-generated field
      this.m_ChirpQuery = this.GetEntityQuery(ComponentType.ReadOnly<Game.Triggers.Chirp>());
    }
    ...
    protected override void OnUpdate()
    {
      ...
      JobHandle dependencies2 = JobUtils.CombineDependencies(job0, job1, job2, job3, job4, job5, job6, job7, job8, job9);
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated method
