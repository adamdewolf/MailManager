  ...
  public class LaneObjectSystem : GameSystemBase
  {
    ...
    private struct LaneObjectJob : IJobChunk
    {
        ...
        in v128 chunkEnabledMask)
      {
        ...
        // ISSUE: reference to a compiler-generated field
        NativeArray<WatercraftCurrentLane> nativeArray7 = chunk.GetNativeArray<WatercraftCurrentLane>(ref this.m_WatercraftCurrentLaneType);
        // ISSUE: reference to a compiler-generated field
        NativeArray<AircraftCurrentLane> nativeArray8 = chunk.GetNativeArray<AircraftCurrentLane>(ref this.m_AircraftCurrentLaneType);
        // ISSUE: reference to a compiler-generated field
        NativeArray<TrainCurrentLane> nativeArray9 = chunk.GetNativeArray<TrainCurrentLane>(ref this.m_TrainCurrentLaneType);
        // ISSUE: reference to a compiler-generated field
        NativeArray<HumanCurrentLane> nativeArray10 = chunk.GetNativeArray<HumanCurrentLane>(ref this.m_HumanCurrentLaneType);
        // ISSUE: reference to a compiler-generated field
        NativeArray<AnimalCurrentLane> nativeArray11 = chunk.GetNativeArray<AnimalCurrentLane>(ref this.m_AnimalCurrentLaneType);
        // ISSUE: reference to a compiler-generated field
        ...
        {
          Entity laneObject = nativeArray1[index];
          WatercraftCurrentLane watercraftCurrentLane = nativeArray7[index];
          // ISSUE: reference to a compiler-generated field
        ...
        {
          Entity laneObject = nativeArray1[index];
          AircraftCurrentLane aircraftCurrentLane = nativeArray8[index];
          // ISSUE: reference to a compiler-generated field
        ...
        {
          Entity laneObject = nativeArray1[index];
          TrainCurrentLane currentLane = nativeArray9[index];
          float2 pos1;
          float2 pos2;
          TrainNavigationHelpers.GetCurvePositions(ref currentLane, out pos1, out pos2);
          // ISSUE: reference to a compiler-generated field
          if (this.m_LaneObjects.HasBuffer(currentLane.m_Front.m_Lane))
          {
            // ISSUE: reference to a compiler-generated field
            NetUtils.AddLaneObject(this.m_LaneObjects[currentLane.m_Front.m_Lane], laneObject, pos1);
          }
          // ISSUE: reference to a compiler-generated field
          if (currentLane.m_Rear.m_Lane != currentLane.m_Front.m_Lane && this.m_LaneObjects.HasBuffer(currentLane.m_Rear.m_Lane))
          {
            // ISSUE: reference to a compiler-generated field
            NetUtils.AddLaneObject(this.m_LaneObjects[currentLane.m_Rear.m_Lane], laneObject, pos2);
          }
        }
        for (int index = 0; index < nativeArray10.Length; ++index)
        {
          Entity laneObject = nativeArray1[index];
          HumanCurrentLane humanCurrentLane = nativeArray10[index];
          // ISSUE: reference to a compiler-generated field
        ...
        {
          Entity laneObject = nativeArray1[index];
          AnimalCurrentLane animalCurrentLane = nativeArray11[index];
          // ISSUE: reference to a compiler-generated field
