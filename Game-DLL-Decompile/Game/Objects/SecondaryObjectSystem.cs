...
label_68:
            for (int index1 = 0; index1 < compositionObject1.Length; ++index1)
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  // ISSUE: reference to a compiler-generated method
                  this.CreateSecondaryObject(jobIndex1, ref local1, owner1, num11 != 0, false, num12 != 0, num13 != 0, ownerTemp1, (float) ownerElevation2, ownerTransform, transformData, localTransformData, (SubObjectFlags) flags, trafficSignNeeds3, ref local2, prefab, 0, probability);
                }
              }
            }
          }
        ...
        if (hasStreetLights)
        {
          ...
          while (updateData.m_StreetLights.Length != 0)
          {
            ...
            for (int index12 = 0; index12 < num16; ++index12)
            {
              ...
              // ISSUE: reference to a compiler-generated method
              this.CreateSecondaryObject(jobIndex2, ref local3, owner2, num19 != 0, false, num20 != 0, num21 != 0, ownerTemp2, (float) ownerElevation3, parentTransform, objectTransform, localTransform, (SubObjectFlags) flags, trafficSignNeeds5, ref local4, prefab, 0, probability);
            }
            int index13 = 0;
            // ISSUE: reference to a compiler-generated field
        ...
        for (int index = 0; index < updateData.m_UtilityNodes.Length; ++index)
        {
          ...
          if (!utilityNode.m_Unsure && (utilityNode.m_Count != 2 || utilityNode.m_Vertical))
          {
            ...
            // ISSUE: reference to a compiler-generated method
            this.CreateSecondaryObject(jobIndex3, ref local5, owner3, num54 != 0, false, false, num55 != 0, ownerTemp3, (float) ownerElevation4, transform2, transform3, localTransformData, SubObjectFlags.AnchorCenter, trafficSignNeeds7, ref local6, prefab, 0, 100);
          }
        }
      }
        ...
        out bool alwaysLit)
      {
        ...
        for (int index1 = 0; index1 < compositionObject1.Length; ++index1)
        {
          ...
          if ((double) num1 >= (double) compositionObject2.m_MinLength)
          {
            ...
            if (num2 > 0)
            {
              ...
              {
                float length = ((float) index2 + num6) * num7 + y;
                float3 position;
                float3 x;
                float3 float3_1;
                ...
                // ISSUE: reference to a compiler-generated method
                this.CreateSecondaryObject(jobIndex, ref random, owner, isTemp, false, isLowered, isNative, ownerTemp, ownerElevation1, transform1, world, transform2, compositionObject2.m_Flags, trafficSignNeeds, ref updateData, compositionObject2.m_Prefab, 0, compositionObject2.m_Probability);
              }
            }
          }
        }
          ...
          if (!this.m_SecondaryLaneData.HasComponent(subLane2))
          {
            ...
            if (this.m_UtilityLaneData.HasComponent(subLane2) && !this.m_EdgeLaneData.HasComponent(subLane2))
            {
              ...
              if (utilityLaneData.m_NodeObjectPrefab != Entity.Null)
              {
                ...
                Temp componentData1;
                // ISSUE: reference to a compiler-generated field
                if (isTemp && this.m_TempData.TryGetComponent(subLane2, out componentData1))
                  flag5 = componentData1.m_Original == Entity.Null;
                // ISSUE: reference to a compiler-generated field
                ...
                bool flag6 = false;
                // ISSUE: reference to a compiler-generated field
                for (int index4 = 0; index4 < updateData.m_UtilityNodes.Length; ++index4)
                {
                  // ISSUE: reference to a compiler-generated field
                  // ISSUE: variable of a compiler-generated type
                  SecondaryObjectSystem.UtilityNodeData utilityNode = updateData.m_UtilityNodes[index4];
                  // ISSUE: reference to a compiler-generated field
                  // ISSUE: reference to a compiler-generated field
                  if ((utilityNode.m_UtilityTypes & utilityLaneData.m_UtilityTypes) != UtilityTypes.None && utilityNode.m_PathNode.Equals(lane.m_StartNode))
                  {
                    ...
                    // ISSUE: reference to a compiler-generated field
                    updateData.m_UtilityNodes[index4] = utilityNode;
                    flag6 = true;
                    break;
                  }
                }
                if (!flag6)
                {
                  ...
                  // ISSUE: reference to a compiler-generated field
                  if (this.m_NetElevationData.TryGetComponent(subLane2, out componentData2) && (double) componentData2.m_Elevation.x != -3.4028234663852886E+38)
                    num9 = componentData2.m_Elevation.x;
                  // ISSUE: object of a compiler-generated type is created
                  // ISSUE: variable of a compiler-generated type
                ...
                if ((trackLane.m_Flags & (TrackLaneFlags.StartingLane | TrackLaneFlags.EndingLane)) != (TrackLaneFlags) 0)
                {
                  ...
                  if (trackLaneData.m_EndObjectPrefab != Entity.Null)
                  {
                    ...
                    if ((trackLane.m_Flags & TrackLaneFlags.StartingLane) != (TrackLaneFlags) 0)
                    {
                      ...
                      // ISSUE: reference to a compiler-generated method
                      this.CreateSecondaryObject(jobIndex1, ref local1, owner1, num10 != 0, false, num11 != 0, num12 != 0, ownerTemp1, (float) ownerElevation2, ownerTransform, transformData, localTransformData, (SubObjectFlags) 0, trafficSignNeeds2, ref local2, endObjectPrefab, 0, 100);
                    }
                    if ((trackLane.m_Flags & TrackLaneFlags.EndingLane) != (TrackLaneFlags) 0)
                    {
                      ...
                      Entity endObjectPrefab = trackLaneData.m_EndObjectPrefab;
                      // ISSUE: reference to a compiler-generated method
                      this.CreateSecondaryObject(jobIndex2, ref local3, owner2, num13 != 0, false, num14 != 0, num15 != 0, ownerTemp2, (float) ownerElevation3, ownerTransform, transformData, localTransformData, (SubObjectFlags) 0, trafficSignNeeds4, ref local4, endObjectPrefab, 0, 100);
                    }
                  }
                }
              }
        ...
        if ((!updateData.m_UtilityNodes.IsCreated ? 0 : (updateData.m_UtilityNodes.Length != 0 ? 1 : 0)) == 0)
          return;
        for (int index5 = 0; index5 < subLane1.Length; ++index5)
        {
          Entity subLane3 = subLane1[index5].m_SubLane;
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          if (!this.m_SecondaryLaneData.HasComponent(subLane3) && this.m_UtilityLaneData.HasComponent(subLane3) && this.m_EdgeLaneData.HasComponent(subLane3))
          {
            ...
            if (utilityLaneData.m_NodeObjectPrefab != Entity.Null)
            {
              ...
              // ISSUE: reference to a compiler-generated field
              for (int index6 = 0; index6 < updateData.m_UtilityNodes.Length; ++index6)
              {
                // ISSUE: reference to a compiler-generated field
                // ISSUE: variable of a compiler-generated type
                SecondaryObjectSystem.UtilityNodeData utilityNode = updateData.m_UtilityNodes[index6];
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                if ((utilityNode.m_UtilityTypes & utilityLaneData.m_UtilityTypes) != UtilityTypes.None && utilityNode.m_PathNode.EqualsIgnoreCurvePos(lane.m_MiddleNode))
                {
                  ...
                  utilityNode.m_Prefab = utilityLaneData.m_NodeObjectPrefab;
                  // ISSUE: reference to a compiler-generated field
                  updateData.m_UtilityNodes[index6] = utilityNode;
                }
              }
            }
          }
        ...
        for (int index = 0; index < updateData.m_UtilityNodes.Length; ++index)
        {
          ...
          if (utilityNode.m_Count != 2 || utilityNode.m_Vertical)
          {
            ...
            Entity prefab = utilityNode.m_Prefab;
            // ISSUE: reference to a compiler-generated method
            this.CreateSecondaryObject(jobIndex3, ref local5, owner3, num16 != 0, num17 != 0, false, num18 != 0, ownerTemp3, (float) ownerElevation4, transform4, transform5, localTransformData, SubObjectFlags.AnchorCenter, trafficSignNeeds6, ref local6, prefab, 0, 100);
          }
        }
      }
        ...
        int probability)
      {
        ...
        if (!this.m_PrefabPlaceholderObjectData.TryGetComponent(prefab, out componentData1) || !this.m_PlaceholderObjects.TryGetBuffer(prefab, out bufferData))
        {
          ...
          if (random1.NextInt(100) >= probability)
            return;
          // ISSUE: reference to a compiler-generated method
          this.CreateSecondaryObject(jobIndex, ref random1, owner, isTemp, isNew, isLowered, isNative, ownerTemp, ownerElevation, Entity.Null, ownerTransform, transformData, localTransformData, flags, trafficSignNeeds, ref updateData, prefab, false, 0, groupIndex, probability);
        }
        else
        {
          ...
          // ISSUE: reference to a compiler-generated method
          this.CreateSecondaryObject(jobIndex, ref random3, owner, isTemp, isNew, isLowered, isNative, ownerTemp, ownerElevation, Entity.Null, ownerTransform, transformData, localTransformData, flags1, trafficSignNeeds, ref updateData, prefab1, false, 0, groupIndex, probability);
        }
      }
        ...
        int probability)
      {
        ...
        if (oldSecondaryObject != Entity.Null)
        {
          ...
          if (isTemp)
          {
            ...
            if (this.m_TempData.HasComponent(oldSecondaryObject))
            {
              ...
              // ISSUE: reference to a compiler-generated field
              if (component3.m_Original != Entity.Null && this.m_TreeData.HasComponent(component3.m_Original))
              {
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                this.m_CommandBuffer.SetComponent<Tree>(jobIndex, oldSecondaryObject, this.m_TreeData[component3.m_Original]);
              }
            }
            // ISSUE: reference to a compiler-generated field
          ...
          if (this.m_PrefabStreetLightData.HasComponent(prefab))
          {
            ...
            bool flag2 = false;
            StreetLight componentData2;
            // ISSUE: reference to a compiler-generated field
            if (this.m_StreetLightData.TryGetComponent(oldSecondaryObject, out componentData2))
            {
              streetLight = componentData2;
              flag2 = true;
            }
            Road componentData3;
            // ISSUE: reference to a compiler-generated field
            if (this.m_RoadData.TryGetComponent(owner, out componentData3))
            {
              // ISSUE: reference to a compiler-generated method
              StreetLightSystem.UpdateStreetLightState(ref streetLight, componentData3);
            }
            if (flag2)
            {
              // ISSUE: reference to a compiler-generated field
          ...
          if (this.m_PrefabTrafficLightData.HasComponent(prefab))
          {
            ...
            bool flag3 = false;
            TrafficLight componentData4;
            // ISSUE: reference to a compiler-generated field
            if (this.m_TrafficLightData.TryGetComponent(oldSecondaryObject, out componentData4))
            {
              trafficLight = componentData4;
              flag3 = true;
            }
            ...
            TrafficLights componentData5;
            // ISSUE: reference to a compiler-generated field
            if (this.m_TrafficLightsData.TryGetComponent(owner, out componentData5))
            {
              // ISSUE: reference to a compiler-generated method
              TrafficLightSystem.UpdateTrafficLightState(componentData5, ref trafficLight);
            }
            if (flag3)
            {
              // ISSUE: reference to a compiler-generated field
          ...
          if (cacheTransform)
          {
            ...
            component4.m_Position = localTransformData.m_Position;
            component4.m_Rotation = localTransformData.m_Rotation;
            component4.m_ParentMesh = parentMesh;
            component4.m_GroupIndex = groupIndex;
            component4.m_Probability = probability;
            component4.m_PrefabSubIndex = -1;
            // ISSUE: reference to a compiler-generated field
            if (this.m_LocalTransformCacheData.HasComponent(oldSecondaryObject))
            {
              // ISSUE: reference to a compiler-generated field
              this.m_CommandBuffer.SetComponent<LocalTransformCache>(jobIndex, oldSecondaryObject, component4);
            }
            else
            {
              // ISSUE: reference to a compiler-generated field
              this.m_CommandBuffer.AddComponent<LocalTransformCache>(jobIndex, oldSecondaryObject, component4);
            }
          }
          else
          {
        ...
        else
        {
          ...
          if (isTemp)
          {
            ...
            {
              // ISSUE: reference to a compiler-generated method
              component5.m_Original = this.FindOriginalSecondaryObject(prefab, Entity.Null, transformData, ref updateData);
            }
            // ISSUE: reference to a compiler-generated field
            if (this.m_PrefabObjectGeometryData.HasComponent(prefab))
            {
              ...
              // ISSUE: reference to a compiler-generated field
              this.m_CommandBuffer.SetComponent<Temp>(jobIndex, entity, component5);
            }
            else
            {
              // ISSUE: reference to a compiler-generated field
            ...
            // ISSUE: reference to a compiler-generated field
            if (component5.m_Original != Entity.Null && this.m_TreeData.HasComponent(component5.m_Original))
            {
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              this.m_CommandBuffer.SetComponent<Tree>(jobIndex, entity, this.m_TreeData[component5.m_Original]);
            }
          }
          // ISSUE: reference to a compiler-generated field
          if (this.m_PrefabStreetLightData.HasComponent(prefab))
          {
            ...
            // ISSUE: reference to a compiler-generated field
            if (this.m_StreetLightData.TryGetComponent(component5.m_Original, out componentData6))
              streetLight = componentData6;
            Road componentData7;
            // ISSUE: reference to a compiler-generated field
            if (this.m_RoadData.TryGetComponent(owner, out componentData7))
            {
              // ISSUE: reference to a compiler-generated method
              StreetLightSystem.UpdateStreetLightState(ref streetLight, componentData7);
            }
            // ISSUE: reference to a compiler-generated field
          ...
          {
            TrafficLight trafficLight = new TrafficLight();
            TrafficLight componentData8;
            // ISSUE: reference to a compiler-generated field
            if (this.m_TrafficLightData.TryGetComponent(component5.m_Original, out componentData8))
              trafficLight = componentData8;
            // ISSUE: reference to a compiler-generated field
            trafficLight.m_GroupMask0 = trafficSignNeeds.m_VehicleMask;
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            trafficLight.m_GroupMask1 = (ushort) ((uint) trafficSignNeeds.m_CrossingLeftMask | (uint) trafficSignNeeds.m_CrossingRightMask);
            TrafficLights componentData9;
            // ISSUE: reference to a compiler-generated field
            if (this.m_TrafficLightsData.TryGetComponent(owner, out componentData9))
            {
              // ISSUE: reference to a compiler-generated method
              TrafficLightSystem.UpdateTrafficLightState(componentData9, ref trafficLight);
            }
            // ISSUE: reference to a compiler-generated field
          ...
          if (cacheTransform)
          {
            ...
            component6.m_Probability = probability;
            component6.m_PrefabSubIndex = -1;
            // ISSUE: reference to a compiler-generated field
          ...
          {
            // ISSUE: reference to a compiler-generated field
            if (this.m_PseudoRandomSeedData.HasComponent(component5.m_Original))
            {
              // ISSUE: reference to a compiler-generated field
              component2 = this.m_PseudoRandomSeedData[component5.m_Original];
            }
            // ISSUE: reference to a compiler-generated field
