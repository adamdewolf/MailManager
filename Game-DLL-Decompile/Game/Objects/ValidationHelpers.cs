...
namespace Game.Objects
{
  public static class ValidationHelpers
  {
    ...
    public static void ValidateObject(
      ...
      bool editorMode,
      NativeArray<ArchetypeChunk> tempChunks,
      ValidationSystem.ChunkType type,
      ...
      NativeQueue<ErrorData>.ParallelWriter errorQueue)
    {
      ...
      if ((temp.m_Flags & TempFlags.Delete) == (TempFlags) 0 && tempChunks.Length != 0)
      {
        ...
        else
        {
          ...
          if (data.m_ConnectedNodes.HasBuffer(entity2))
          {
            ...
            // ISSUE: reference to a compiler-generated field
            edge = data.m_Edge[entity2];
          }
        }
        iterator2.m_TopLevelEntity = entity2;
        for (int index1 = 0; index1 < tempChunks.Length; ++index1)
        {
          ArchetypeChunk tempChunk = tempChunks[index1];
          // ISSUE: reference to a compiler-generated field
          if (tempChunk.Has<Edge>(ref type.m_Edge))
          {
            // ISSUE: reference to a compiler-generated field
            NativeArray<Entity> nativeArray1 = tempChunk.GetNativeArray(type.m_Entity);
            // ISSUE: reference to a compiler-generated field
            NativeArray<Owner> nativeArray2 = tempChunk.GetNativeArray<Owner>(ref type.m_Owner);
            // ISSUE: reference to a compiler-generated field
            NativeArray<Temp> nativeArray3 = tempChunk.GetNativeArray<Temp>(ref type.m_Temp);
            // ISSUE: reference to a compiler-generated field
            NativeArray<Edge> nativeArray4 = tempChunk.GetNativeArray<Edge>(ref type.m_Edge);
            // ISSUE: reference to a compiler-generated field
            NativeArray<EdgeGeometry> nativeArray5 = tempChunk.GetNativeArray<EdgeGeometry>(ref type.m_EdgeGeometry);
            // ISSUE: reference to a compiler-generated field
            NativeArray<StartNodeGeometry> nativeArray6 = tempChunk.GetNativeArray<StartNodeGeometry>(ref type.m_StartNodeGeometry);
            // ISSUE: reference to a compiler-generated field
            NativeArray<EndNodeGeometry> nativeArray7 = tempChunk.GetNativeArray<EndNodeGeometry>(ref type.m_EndNodeGeometry);
            // ISSUE: reference to a compiler-generated field
            NativeArray<Composition> nativeArray8 = tempChunk.GetNativeArray<Composition>(ref type.m_Composition);
label_78:
            for (int index2 = 0; index2 < nativeArray5.Length; ++index2)
            {
              Temp temp1 = nativeArray3[index2];
              if ((temp1.m_Flags & (TempFlags.Delete | TempFlags.Select | TempFlags.Duplicate)) == (TempFlags) 0)
              {
                Entity edgeEntity2 = nativeArray1[index2];
                Edge edgeData2 = nativeArray4[index2];
                Entity entity4 = edgeEntity2;
                if (nativeArray2.Length != 0)
                {
                  Entity owner3 = nativeArray2[index2].m_Owner;
                  Entity owner4;
                  // ISSUE: reference to a compiler-generated field
                ...
                if (!(entity2 == entity4) && !(edgeEntity2 == parent2) && !(edgeData2.m_Start == parent2) && !(edgeData2.m_End == parent2))
                {
                  ...
                  EdgeGeometry edgeGeometryData2 = nativeArray5[index2];
                  StartNodeGeometry startNodeGeometryData2 = nativeArray6[index2];
                  EndNodeGeometry endNodeGeometryData2 = nativeArray7[index2];
                  Composition compositionData2 = nativeArray8[index2];
                  Bounds3 bounds2 = edgeGeometryData2.m_Bounds | startNodeGeometryData2.m_Geometry.m_Bounds | endNodeGeometryData2.m_Geometry.m_Bounds;
                  if ((collisionMask & CollisionMask.OnGround) != (CollisionMask) 0)
                  {
                    if (!MathUtils.Intersect(bounds3.xz, bounds2.xz))
                      continue;
                  }
                  else if (!MathUtils.Intersect(bounds3, bounds2))
                    continue;
                  ...
                  iterator2.CheckOverlap(entity4, edgeEntity2, bounds2, edgeData2, compositionData2, edgeGeometryData2, startNodeGeometryData2, endNodeGeometryData2, transform.m_Position, checkStartNode, checkEndNode, (temp1.m_Flags & TempFlags.Essential) > (TempFlags) 0, nativeArray2.Length != 0);
                }
              }
            }
          }
          ...
          {
            // ISSUE: reference to a compiler-generated field
            if (tempChunk.Has<Object>(ref type.m_Object))
            {
              // ISSUE: reference to a compiler-generated field
              NativeArray<Entity> nativeArray9 = tempChunk.GetNativeArray(type.m_Entity);
              // ISSUE: reference to a compiler-generated field
              NativeArray<Owner> nativeArray10 = tempChunk.GetNativeArray<Owner>(ref type.m_Owner);
              // ISSUE: reference to a compiler-generated field
              NativeArray<Temp> nativeArray11 = tempChunk.GetNativeArray<Temp>(ref type.m_Temp);
              // ISSUE: reference to a compiler-generated field
              NativeArray<Transform> nativeArray12 = tempChunk.GetNativeArray<Transform>(ref type.m_Transform);
              // ISSUE: reference to a compiler-generated field
              NativeArray<Attached> nativeArray13 = tempChunk.GetNativeArray<Attached>(ref type.m_Attached);
              // ISSUE: reference to a compiler-generated field
              NativeArray<PrefabRef> nativeArray14 = tempChunk.GetNativeArray<PrefabRef>(ref type.m_PrefabRef);
label_111:
              for (int index3 = 0; index3 < nativeArray9.Length; ++index3)
              {
                Temp temp2 = nativeArray11[index3];
                if ((temp2.m_Flags & (TempFlags.Delete | TempFlags.Select | TempFlags.Duplicate)) == (TempFlags) 0)
                {
                  Entity objectEntity2 = nativeArray9[index3];
                  if (objectEntity2.Index > entity.Index && !(objectEntity2 == entity3))
                  {
                    Entity entity7 = objectEntity2;
                    // ISSUE: reference to a compiler-generated field
                    if (nativeArray10.Length != 0 && !data.m_Building.HasComponent(entity7))
                    {
                      Entity owner8 = nativeArray10[index3].m_Owner;
                      Entity owner9;
                      // ISSUE: reference to a compiler-generated field
                    ...
                    if (!(entity2 == entity7))
                    {
                      if (dynamicBuffer1.IsCreated)
                      {
                        ...
                        {
                          if (dynamicBuffer1[index4].m_Edge == entity7)
                            goto label_111;
                        }
                      }
                      else if (dynamicBuffer2.IsCreated)
                      {
                        ...
                        {
                          if (dynamicBuffer2[index5].m_Node == entity7)
                            goto label_111;
                        }
                        if (edge.m_Start == entity7 || edge.m_End == entity7)
                          continue;
                      }
                      if (!(attached.m_Parent == objectEntity2) && (nativeArray13.Length == 0 || !(nativeArray13[index3].m_Parent == entity)))
                      {
                        Transform transform1 = nativeArray12[index3];
                        PrefabRef prefabRef2 = nativeArray14[index3];
                        // ISSUE: reference to a compiler-generated field
                        if (data.m_PrefabObjectGeometry.HasComponent(prefabRef2.m_Prefab))
                        {
                          // ISSUE: reference to a compiler-generated field
                          ObjectGeometryData geometryData = data.m_PrefabObjectGeometry[prefabRef2.m_Prefab];
                          Stack componentData11;
                          StackData componentData12;
                          // ISSUE: reference to a compiler-generated field
                          // ISSUE: reference to a compiler-generated field
                          Bounds3 bounds2 = !data.m_Stack.TryGetComponent(entity, out componentData11) || !data.m_PrefabStackData.TryGetComponent(prefabRef.m_Prefab, out componentData12) ? ObjectUtils.CalculateBounds(transform1.m_Position, transform1.m_Rotation, geometryData) : ObjectUtils.CalculateBounds(transform1.m_Position, transform1.m_Rotation, componentData11, geometryData, componentData12);
                          if ((collisionMask & CollisionMask.OnGround) != (CollisionMask) 0)
                          {
                            if (!MathUtils.Intersect(bounds3.xz, bounds2.xz))
                              continue;
                            ...
                            continue;
                          iterator1.CheckOverlap(entity7, objectEntity2, bounds2, (temp2.m_Flags & TempFlags.Essential) > (TempFlags) 0, nativeArray10.Length != 0);
                        }
                      }
                    }
                  }
