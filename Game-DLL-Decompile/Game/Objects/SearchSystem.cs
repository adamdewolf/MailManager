        ...
        in v128 chunkEnabledMask)
      {
        ...
        else
        {
          ...
          else
          {
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            bool flag4 = chunk.Has<Marker>(ref this.m_MarkerType) && !chunk.Has<OutsideConnection>(ref this.m_OutsideConnectionType);
            // ISSUE: reference to a compiler-generated field
            bool flag5 = chunk.Has<Overridden>(ref this.m_OverriddenType);
            // ISSUE: reference to a compiler-generated field
            bool flag6 = chunk.Has<Tree>(ref this.m_TreeType);
            for (int index = 0; index < nativeArray1.Length; ++index)
            {
              Entity entity = nativeArray1[index];
