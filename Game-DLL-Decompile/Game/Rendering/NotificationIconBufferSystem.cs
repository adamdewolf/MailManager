            ...
            if (iconCluster.KeepCluster(distance))
            {
              ...
              for (int index3 = icons.Length - 1; index3 >= 0; --index3)
              {
                ...
                else
                {
                  ...
                  // ISSUE: reference to a compiler-generated field
                  float4 float4 = new float4(math.lerp(notificationIconDisplayData.m_MinParams, notificationIconDisplayData.m_MaxParams, s), math.select((float2) 1f, new float2(0.5f, 0.0f), ((int) notificationIconDisplayData.m_CategoryMask & (int) this.m_CategoryMask) == 0));
                  // ISSUE: reference to a compiler-generated field
                  // ISSUE: object of a compiler-generated type is created
