        ...
        in v128 chunkEnabledMask)
      {
        ...
        for (int index = 0; index < nativeArray1.Length; ++index)
        {
          ...
          if (flag1)
          {
            ...
            // ISSUE: reference to a compiler-generated field
            if (temp.m_Original != Entity.Null && (temp.m_Flags & TempFlags.Dragging) == (TempFlags) 0 && (!flag2 || (temp.m_Flags & (TempFlags.Create | TempFlags.Modify)) == (TempFlags) 0) && this.m_CullingInfoData.TryGetComponent(temp.m_Original, out componentData1))
            {
