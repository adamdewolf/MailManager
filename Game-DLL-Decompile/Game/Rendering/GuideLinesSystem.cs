  ...
  public class GuideLinesSystem : GameSystemBase
  {
              ...
              else
              {
                ...
                if (this.m_ToolSystem.activeTool == this.m_ObjectToolSystem)
                {
                  ...
                  GuideLinesSystem.ObjectToolGuideLinesJob jobData = new GuideLinesSystem.ObjectToolGuideLinesJob()
                  {
                    ...
                    m_AngleSides = this.m_AngleSides,
                    m_Tooltips = this.m_Tooltips,
                    m_OverlayBuffer = this.m_OverlayRenderSystem.GetBuffer(out dependencies10)
                  };
                  JobHandle jobHandle = jobData.Schedule<GuideLinesSystem.ObjectToolGuideLinesJob>(JobUtils.CombineDependencies(this.Dependency, outJobHandle, dependencies8, dependencies9, dependencies10));
                  // ISSUE: reference to a compiler-generated field
                  jobData.m_DefinitionChunks.Dispose(jobHandle);
                  // ISSUE: reference to a compiler-generated field
                  this.m_OverlayRenderSystem.AddBufferWriter(jobHandle);
      ...
      bool angleSide)
    {
      if (angle == 180)
      {
        ...
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        GuideLinesSystem.TooltipInfo tooltipInfo = new GuideLinesSystem.TooltipInfo(GuideLinesSystem.TooltipType.Angle, b4, angle);
      ...
      else if (angle > 90)
      {
        ...
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        GuideLinesSystem.TooltipInfo tooltipInfo = new GuideLinesSystem.TooltipInfo(GuideLinesSystem.TooltipType.Angle, b7, angle);
      ...
      else if (angle == 90)
      {
        ...
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        GuideLinesSystem.TooltipInfo tooltipInfo = new GuideLinesSystem.TooltipInfo(GuideLinesSystem.TooltipType.Angle, b11, angle);
      ...
      else
      {
        ...
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        GuideLinesSystem.TooltipInfo tooltipInfo = new GuideLinesSystem.TooltipInfo(GuideLinesSystem.TooltipType.Angle, b13, angle);
    ...
    public struct TooltipInfo
    {
      ...
      public TooltipInfo(GuideLinesSystem.TooltipType type, float3 position, int value)
      {
        // ISSUE: reference to a compiler-generated field
        this.m_Type = type;
        // ISSUE: reference to a compiler-generated field
    ...
    private struct ObjectToolGuideLinesJob : IJob
    {
      ...
      public void Execute()
      {
        ...
        for (int index1 = 0; index1 < this.m_DefinitionChunks.Length; ++index1)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          NativeArray<ObjectDefinition> nativeArray2 = definitionChunk.GetNativeArray<ObjectDefinition>(ref this.m_ObjectDefinitionType);
          // ISSUE: reference to a compiler-generated field
          NativeArray<OwnerDefinition> nativeArray3 = definitionChunk.GetNativeArray<OwnerDefinition>(ref this.m_OwnerDefinitionType);
          for (int index2 = 0; index2 < nativeArray2.Length; ++index2)
          {
            CreationDefinition creationDefinition = nativeArray1[index2];
            ObjectDefinition objectDefinition = nativeArray2[index2];
            if ((creationDefinition.m_Flags & CreationFlags.Permanent) == (CreationFlags) 0)
            {
              ...
              if (this.m_PrefabSubAreas.TryGetBuffer(creationDefinition.m_Prefab, out bufferData))
              {
                for (int index3 = 0; index3 < bufferData.Length; ++index3)
                {
                  ...
                  // ISSUE: reference to a compiler-generated field
                  if (this.m_PrefabLotData.TryGetComponent(bufferData[index3].m_Prefab, out componentData2) && (double) componentData2.m_MaxRadius > 0.0)
                  {
              ...
              // ISSUE: reference to a compiler-generated field
              // ISSUE: reference to a compiler-generated field
              if (this.m_PrefabServiceUpgradeData.TryGetComponent(creationDefinition.m_Prefab, out componentData3) && (double) componentData3.m_MaxPlacementDistance != 0.0 && CollectionUtils.TryGet<OwnerDefinition>(nativeArray3, index2, out ownerDefinition) && this.m_PrefabBuildingData.TryGetComponent(ownerDefinition.m_Prefab, out componentData4) && this.m_PrefabBuildingData.TryGetComponent(creationDefinition.m_Prefab, out componentData5))
              {
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated method
      ...
      private void DrawCourses()
      {
        ...
        for (int index1 = 0; index1 < this.m_DefinitionChunks.Length; ++index1)
        {
          ...
          for (int index2 = 0; index2 < nativeArray2.Length; ++index2)
          {
            ...
            CreationDefinition creationDefinition = nativeArray1[index2];
            // ISSUE: reference to a compiler-generated field
            if ((creationDefinition.m_Flags & CreationFlags.Permanent) == (CreationFlags) 0 && this.m_NetGeometryData.HasComponent(creationDefinition.m_Prefab))
            {
              // ISSUE: reference to a compiler-generated field
              ...
              if ((double) netCourse.m_Length < 0.0099999997764825821)
              {
                ...
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                this.m_OverlayBuffer.DrawCircle(this.m_GuideLineSettingsData.m_MediumPriorityColor, this.m_GuideLineSettingsData.m_MediumPriorityColor, 0.0f, OverlayRenderSystem.StyleFlags.Projected, new float2(0.0f, 1f), netCourse.m_StartPosition.m_Position, netGeometryData.m_DefaultWidth);
              }
              else
              {
                ...
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                this.m_OverlayBuffer.DrawCurve(this.m_GuideLineSettingsData.m_MediumPriorityColor, this.m_GuideLineSettingsData.m_MediumPriorityColor, 0.0f, OverlayRenderSystem.StyleFlags.Projected, curve1, netGeometryData.m_DefaultWidth, new float2(float2_1.x, 0.0f));
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                // ISSUE: reference to a compiler-generated field
                this.m_OverlayBuffer.DrawCurve(this.m_GuideLineSettingsData.m_MediumPriorityColor, this.m_GuideLineSettingsData.m_MediumPriorityColor, 0.0f, OverlayRenderSystem.StyleFlags.Projected, curve2, netGeometryData.m_DefaultWidth, new float2(0.0f, float2_1.y));
              }
            }
          }
        }
        ...
        if (this.m_Mode != NetToolSystem.Mode.Replace && this.m_ControlPoints.Length >= 3)
        {
          ...
          if (num5 >= 2)
          {
            ...
            for (int index = 1; index < this.m_ControlPoints.Length; ++index)
            {
              ...
              int num7 = Mathf.RoundToInt(math.distance(controlPoint7.m_Position.xz, controlPoint8.m_Position.xz));
              if (num7 > 0)
              {
                // ISSUE: reference to a compiler-generated field
