...
namespace Game.Tools
{
  ...
  public class ValidationSystem : GameSystemBase
  {
    ...
    protected override void OnUpdate()
    {
      ...
      ValidationSystem.ValidationJob jobData1 = new ValidationSystem.ValidationJob()
      {
      ...
      {
        NativeList<AreaSearchItem> nativeList = new NativeList<AreaSearchItem>((AllocatorManager.AllocatorHandle) Allocator.TempJob);
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        ...
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        ValidationSystem.CollectAreaTrianglesJob jobData2 = new ValidationSystem.CollectAreaTrianglesJob()
        {
        ...
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        ValidationSystem.ValidateAreaTrianglesJob jobData3 = new ValidationSystem.ValidateAreaTrianglesJob()
        {
          m_EditorMode = this.m_ToolSystem.actionMode.IsEditor(),
          m_AreaTriangles = nativeList.AsDeferredJobArray(),
          m_EntityData = jobData1.m_EntityData,
          m_ObjectSearchTree = jobData1.m_ObjectSearchTree,
          m_NetSearchTree = jobData1.m_NetSearchTree,
          m_AreaSearchTree = jobData1.m_AreaSearchTree,
          m_WaterSurfaceData = jobData1.m_WaterSurfaceData,
          m_TerrainHeightData = jobData1.m_TerrainHeightData,
          m_ErrorQueue = nativeQueue2.AsParallelWriter()
        };
        // ISSUE: reference to a compiler-generated field
        JobHandle job0 = jobData2.Schedule<ValidationSystem.CollectAreaTrianglesJob>(this.m_UpdatedAreaQuery, this.Dependency);
        NativeList<AreaSearchItem> list = nativeList;
        JobHandle dependsOn = JobHandle.CombineDependencies(job0, job1_1);
        jobHandle1 = jobData3.Schedule<ValidationSystem.ValidateAreaTrianglesJob, AreaSearchItem>(list, 1, dependsOn);
      ...
      // ISSUE: object of a compiler-generated type is created
      // ISSUE: variable of a compiler-generated type
      ValidationSystem.FillErrorPrefabsJob jobData4 = new ValidationSystem.FillErrorPrefabsJob()
      {
        m_EditorMode = this.m_ToolSystem.actionMode.IsEditor(),
        m_EntityType = this.__TypeHandle.__Unity_Entities_Entity_TypeHandle,
      ...
      // ISSUE: object of a compiler-generated type is created
      // ISSUE: variable of a compiler-generated type
      ValidationSystem.ProcessValidationResultsJob jobData5 = new ValidationSystem.ProcessValidationResultsJob()
      {
        m_EntityType = this.__TypeHandle.__Unity_Entities_Entity_TypeHandle,
        m_TempType = this.__TypeHandle.__Game_Tools_Temp_RO_ComponentTypeHandle,
      ...
      JobHandle jobHandle2 = JobHandle.CombineDependencies(jobData1.Schedule<ValidationSystem.ValidationJob, ArchetypeChunk>(archetypeChunkListAsync, 1, JobHandle.CombineDependencies(this.Dependency, job1_1)), jobHandle1);
      // ISSUE: reference to a compiler-generated field
      JobHandle job1_2 = jobData4.Schedule<ValidationSystem.FillErrorPrefabsJob>(this.m_ToolErrorPrefabQuery, this.Dependency);
      JobHandle dependsOn1 = JobHandle.CombineDependencies(jobHandle2, job1_2);
      JobHandle jobHandle3 = jobData5.Schedule<ValidationSystem.ProcessValidationResultsJob>(dependsOn1);
        ...
        if (chunk.Has<Game.Objects.Object>(ref this.m_ChunkType.m_Object))
        {
          ...
          for (int index1 = 0; index1 < nativeArray1.Length; ++index1)
          {
            ...
            if ((temp1.m_Flags & tempFlags) == (TempFlags) 0)
            {
              ...
              // ISSUE: reference to a compiler-generated field
              NativeArray<ArchetypeChunk> chunks = this.m_Chunks;
              // ISSUE: reference to a compiler-generated field
              // ISSUE: variable of a compiler-generated type
              ValidationSystem.ChunkType chunkType = this.m_ChunkType;
              // ISSUE: reference to a compiler-generated field
              // ISSUE: variable of a compiler-generated type
              ...
              Game.Objects.ValidationHelpers.ValidateObject(entity, temp2, owner2, transform2, prefabRef2, attached2, num1 != 0, num2 != 0, chunks, chunkType, entityData, objectSearchTree, netSearchTree, areaSearchTree, instanceCounts, waterSurfaceData, terrainHeightData, errorQueue);
            }
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
        ...
        if (chunk.Has<Game.Net.Edge>(ref this.m_ChunkType.m_Edge))
        {
          ...
          for (int index7 = 0; index7 < nativeArray16.Length; ++index7)
          {
            ...
            if ((temp3.m_Flags & tempFlags) == (TempFlags) 0)
            {
              ...
              Game.Net.ValidationHelpers.ValidateEdge(entity, temp4, owner6, _fixed, edge2, edgeGeometry2, startNodeGeometry2, endNodeGeometry2, composition2, prefabRef10, num != 0, chunks, chunkType, entityData, objectSearchTree, netSearchTree, areaSearchTree, waterSurfaceData, terrainHeightData, errorQueue, tempNodes);
            }
          }
        }
        // ISSUE: reference to a compiler-generated field
