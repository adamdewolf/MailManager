...
namespace Game.Tools
{
  ...
  public class AreaToolSystem : ToolBaseSystem
  {
    ...
    private UIInputAction.State m_AddOrModifyAreaNode;
    private UIInputAction.State m_RemoveAreaNode;
    private UIInputAction.State m_UndoAreaNode;
    ...
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
      ...
      if ((UnityEngine.Object) this.prefab != (UnityEngine.Object) null)
      {
        ...
        {
          // ISSUE: reference to a compiler-generated field
          if (this.m_State != AreaToolSystem.State.Remove && this.secondaryApplyAction.action.WasPressedThisFrame())
          {
            // ISSUE: reference to a compiler-generated method
            return this.Cancel(inputDeps, this.secondaryApplyAction.action.WasReleasedThisFrame());
          }
          // ISSUE: reference to a compiler-generated field
          if (this.m_State == AreaToolSystem.State.Remove && (forceCancel || this.secondaryApplyAction.action.WasReleasedThisFrame()))
          {
            // ISSUE: reference to a compiler-generated method
            return this.Cancel(inputDeps);
          }
          // ISSUE: reference to a compiler-generated field
          if (this.m_State != AreaToolSystem.State.Modify && this.applyAction.action.WasPressedThisFrame())
          {
            // ISSUE: reference to a compiler-generated method
          ...
          // ISSUE: reference to a compiler-generated method
          // ISSUE: reference to a compiler-generated method
          return this.m_State == AreaToolSystem.State.Modify && this.applyAction.action.WasReleasedThisFrame() ? this.Apply(inputDeps) : this.Update(inputDeps);
        }
      }
      else
      {
      ...
      // ISSUE: reference to a compiler-generated field
      if (this.m_State == AreaToolSystem.State.Modify && this.applyAction.action.WasReleasedThisFrame())
      {
        // ISSUE: reference to a compiler-generated field
        if ((this.m_ToolRaycastSystem.raycastFlags & (RaycastFlags.DebugDisable | RaycastFlags.UIDisable)) == (RaycastFlags) 0)
        {
      ...
      {
        // ISSUE: reference to a compiler-generated field
        if (this.m_State == AreaToolSystem.State.Remove && this.secondaryApplyAction.action.WasReleasedThisFrame())
        {
          // ISSUE: reference to a compiler-generated field
          if ((this.m_ToolRaycastSystem.raycastFlags & (RaycastFlags.DebugDisable | RaycastFlags.UIDisable)) == (RaycastFlags) 0)
          {
