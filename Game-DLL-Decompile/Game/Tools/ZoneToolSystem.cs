...
namespace Game.Tools
{
  ...
  public class ZoneToolSystem : ToolBaseSystem
  {
    ...
    private UIInputAction.State m_ApplyZone;
    private UIInputAction.State m_RemoveZone;
    ...
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
      ...
      if (this.m_FocusChanged)
        return inputDeps;
      // ISSUE: reference to a compiler-generated field
      if (this.m_State != ZoneToolSystem.State.Default && (!this.applyAction.enabled || !this.secondaryApplyAction.enabled))
      {
        // ISSUE: reference to a compiler-generated field
        this.m_StartPoint = new ControlPoint();
        // ISSUE: reference to a compiler-generated field
      ...
      // ISSUE: reference to a compiler-generated field
      if (this.m_State != ZoneToolSystem.State.Default && (this.applyAction.action.WasReleasedThisFrame() || this.secondaryApplyAction.action.WasReleasedThisFrame()))
      {
        // ISSUE: reference to a compiler-generated field
        this.m_StartPoint = new ControlPoint();
        // ISSUE: reference to a compiler-generated field
    ...
    public override void ToggleToolOptions(bool enabled)
    {
      ...
      this.secondaryApplyAction.enabled = !enabled;
    }
