...
namespace Game.Tools
{
  ...
  public class BulldozeToolSystem : ToolBaseSystem
  {
    ...
    private UIInputAction.State m_Bulldoze;
    private UIInputAction.State m_BulldozeCancel;
    ...
    protected override IEnumerable<UIInputAction.State> toolActions
    {
      get
      {
        ...
        yield return this.m_BulldozeCancel;
      }
    }
    ...
    protected override void OnCreate()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.m_BulldozeCancel = InputManager.instance.toolActionCollection.GetActionState("Bulldoze Cancel", nameof (BulldozeToolSystem));
    }
    ...
    protected override void OnStartRunning()
    {
      ...
      // ISSUE: reference to a compiler-generated method
      this.SetState(BulldozeToolSystem.State.Default);
    ...
    private protected override void SetActions()
    {
      ...
      // ISSUE: reference to a compiler-generated field
      this.cancelActionOverride = this.m_BulldozeCancel;
    ...
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
      ...
      // ISSUE: reference to a compiler-generated field
      if (this.m_State == BulldozeToolSystem.State.Applying && !this.applyAction.action.enabled)
      {
        // ISSUE: reference to a compiler-generated method
        this.SetState(BulldozeToolSystem.State.Default);
        // ISSUE: reference to a compiler-generated field
      ...
      switch (state)
      {
        case BulldozeToolSystem.State.Default:
          if (this.cancelAction.action.IsPressed())
          {
            this.applyMode = ApplyMode.None;
            return inputDeps;
          }
          // ISSUE: reference to a compiler-generated field
          if (this.m_ControlPoints.Length <= 0 || !this.applyAction.action.WasPressedThisFrame())
          {
            // ISSUE: reference to a compiler-generated method
            return this.Update(inputDeps, false);
          }
          // ISSUE: reference to a compiler-generated method
          this.SetState(BulldozeToolSystem.State.Applying);
          // ISSUE: reference to a compiler-generated method
        ...
        case BulldozeToolSystem.State.Applying:
          ...
          if (this.applyAction.action.IsPressed())
          {
            // ISSUE: reference to a compiler-generated method
            return this.Update(inputDeps, false);
          }
          ...
          {
            // ISSUE: reference to a compiler-generated method
            this.SetState(BulldozeToolSystem.State.Waiting);
            this.applyMode = ApplyMode.None;
            // ISSUE: reference to a compiler-generated field
    ...
    public void ConfirmAction(bool confirm)
    {
      ...
      if (this.m_State != BulldozeToolSystem.State.Waiting)
        return;
      // ISSUE: reference to a compiler-generated method
      this.SetState(confirm ? BulldozeToolSystem.State.Confirmed : BulldozeToolSystem.State.Cancelled);
    }
    ...
    private void SetState(BulldozeToolSystem.State state)
    {
      // ISSUE: reference to a compiler-generated field
      this.m_State = state;
      this.applyAction.enabled = state != BulldozeToolSystem.State.Waiting;
      this.cancelAction.enabled = state == BulldozeToolSystem.State.Applying;
    }
