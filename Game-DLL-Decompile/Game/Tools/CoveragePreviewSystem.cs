  ...
  public class CoveragePreviewSystem : GameSystemBase
  {
    ...
    public struct SetupCoverageSearchJob : IJob
    {
      ...
      public void Execute()
      {
        ...
        BackSide componentData1;
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        if (this.m_BackSideData.TryGetComponent(this.m_Entity, out componentData1))
        {
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          Transform transform = this.m_TargetSeeker.m_Transform[this.m_Entity];
          if (componentData1.m_RoadEdge != Entity.Null)
          {
            // ISSUE: reference to a compiler-generated field
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            if (!this.m_TargetSeeker.m_Owner.TryGetComponent(componentData1.m_RoadEdge, out componentData2) || componentData2.m_Owner != this.m_Entity)
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            this.m_TargetSeeker.AddEdgeTargets(ref random, this.m_Entity, 0.0f, EdgeFlags.DefaultMask, componentData1.m_RoadEdge, comparePosition, 0.0f, true, false);
          }
        }
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
